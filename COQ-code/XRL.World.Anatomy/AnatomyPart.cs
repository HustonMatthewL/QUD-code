...
namespace XRL.World.Anatomy
{
	...
	public class AnatomyPart
	{
		...
		public void ApplyTo(BodyPart parent)
		{
			...
			bool? mortal = Mortal;
			bool? @abstract = Abstract;
			bool? extrinsic = Extrinsic;
			bool? plural = Plural;
			bool? mass = Mass;
			bool? contact = Contact;
			bool? ignorePosition = IgnorePosition;
			BodyPart parent2 = parent.AddPart(type, valueOrDefault, defaultBehavior, supportsDependent, dependsOn, requiresType, null, category, requiresLaterality, mobility, null, integral, mortal, @abstract, extrinsic, null, plural, mass, contact, ignorePosition);
