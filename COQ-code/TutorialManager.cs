...
public class TutorialManager : MonoBehaviour
{
	...
	public static string OverrideOption(string ID)
	{
		if (currentStep != null && ID == "OptionDisplayMousableZoneTransitionBorder")
		{
			return "Yes";
		}
		return null;
	...
	public string hotkeyReplace(string source)
	{
		...
		for (int i = 0; i < keysByLength.Count; i++)
		{
			string text = keysByLength[i];
