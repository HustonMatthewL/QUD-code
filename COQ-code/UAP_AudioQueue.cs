...
public class UAP_AudioQueue : MonoBehaviour
{
	...
	private void QueueAudio(SAudioEntry newEntry, EInterrupt interrupts)
	{
		...
		if (newEntry.m_AudioType != 0 && (newEntry.m_AudioType == EAudioType.Pause || !(newEntry.m_Audio == null) || newEntry.m_TTS_Text.Length != 0))
		{
	...
	private void InitializeWindowsTTS()
	{
		...
		{
			GameObject obj = new GameObject("Windows TTS");
			obj.AddComponent<WindowsTTS>();
