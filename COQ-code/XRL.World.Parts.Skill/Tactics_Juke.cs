		...
		public override bool HandleEvent(CommandEvent E)
		{
			if (E.Command == COMMAND_NAME)
			{
				...
				foreach (GameObject item in cell.LoopObjectsWithPart("Physics"))
				{
					...
					{
						return ParentObject.Fail("You cannot juke into " + item.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
					}
				}
				...
				for (int count = cell.Objects.Count; i < count; i++)
				{
					...
					if (gameObject.IsCombatObject(NoBrainOnly: true) && ParentObject.PhaseAndFlightMatches(gameObject) && (!gameObject.HasPart<FungalVision>() || FungalVisionary.VisionLevel > 0))
					{
						...
						{
							return ParentObject.Fail("You cannot juke " + gameObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " out of your way.");
						}
						if (Object != null)
						{
							return ParentObject.Fail("You cannot juke both " + gameObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " and " + Object.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " out of your way.");
						}
						Object = gameObject;
					}
				}
