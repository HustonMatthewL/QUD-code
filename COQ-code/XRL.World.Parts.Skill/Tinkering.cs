...
namespace XRL.World.Parts.Skill
{
	...
	public class Tinkering : BaseSkill
	{
		...
		public static void LearnNewRecipe(GameObject Actor, int MinTier, int MaxTier)
		{
			...
			if (Actor.IsPlayer())
			{
				Popup.Show("You have a flash of insight and scribe " + gameObject2.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: false, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", null, "sfx_characterMod_tinkerSchematic_learn");
			}
		}
