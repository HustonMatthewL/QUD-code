				...
				if (cell != null)
				{
					...
					else
					{
						try
						{
							...
							attacker.UseEnergy(1000, "Skill Axe Dismember", null, null);
				...
				if (E.GetIntParameter("Penetrations") > 0)
				{
					...
					if (GameObject.Validate(ref Object))
					{
						...
						if (part != null && part.Skill == "Axe")
						{
							...
							{
								return Dismember(gameObjectParameter, gameObjectParameter2, where, null, Object, null, "sfx_ability_dismember");
							}
							int num = 3;
