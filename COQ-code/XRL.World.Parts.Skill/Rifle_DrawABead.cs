	...
	public class Rifle_DrawABead : BaseSkill
	{
		...
		public override bool HandleEvent(CommandEvent E)
		{
			if (E.Command == COMMAND_NAME)
			{
				...
				ParentObject.UseEnergy(1000, "Physical Skill", null, null);
			}
			return base.HandleEvent(E);
		}
		...
		public bool SetMark(GameObject Target)
		{
			...
			if (Visible())
			{
				DidXToY("draw", "a bead on", Target, ((Target.IsPlayer() || ParentObject.IsPlayer()) ? "" : The.Player.DescribeDirectionToward(Target)) + ". " + Target.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " marked", null, null, null, ParentObject);
			}
			return true;
		}
