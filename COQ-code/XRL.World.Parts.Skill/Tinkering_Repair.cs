...
namespace XRL.World.Parts.Skill
{
	...
	public class Tinkering_Repair : BaseSkill, IRepairSifrahHandler
	{
		...
		{
			if (ParentObject.HasSkill("Tinkering_Repair") && IsRepairableEvent.Check(E.Actor, E.Object, null, this, null))
			{
		...
		public override bool HandleEvent(InventoryActionEvent E)
		{
			if (E.Command == "Repair")
			{
				...
				if (item.CurrentCell != null)
				{
					...
					{
						actor.ShowFailure("You cannot reach " + item.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " to repair " + item.them + ".");
						return false;
					}
					if (!actor.PhaseMatches(item))
					{
						actor.ShowFailure("You are out of phase with " + item.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " and cannot repair " + item.them + ".");
						return false;
					}
				}
				...
				{
					Popup.ShowFail("You cannot repair " + item.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " until you understand " + item.them + ".");
					return false;
				}
				if (item.HasTagOrProperty("NoRepair"))
				{
					Popup.ShowFail("You cannot repair " + item.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
					return false;
				}
				if (Options.SifrahRepair && actor.IsPlayer())
				{
					if (!string.IsNullOrEmpty(item.Owner) && !item.HasPropertyOrTag("DontWarnOnRepair") && Popup.ShowYesNoCancel(item.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " not owned by you, and trying to repair " + item.them + " risks damaging " + item.them + ". Are you sure you want to do so?") != 0)
					{
						return false;
					}
					GameObject inInventory = item.InInventory;
					if (inInventory != null && inInventory != actor && !string.IsNullOrEmpty(inInventory.Owner) && inInventory.Owner != item.Owner && !inInventory.HasPropertyOrTag("DontWarnOnRepair") && Popup.ShowYesNoCancel(inInventory.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " not owned by you, and trying to repair " + item.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " inside " + inInventory.them + " risks causing damage. Are you sure you want to do so?") != 0)
					{
						return false;
					}
				...
				else
				{
					...
					if (actor.IsPlayer())
					{
						...
						{
							Popup.ShowFail("You don't have <" + bitCost.ToString() + "> to repair " + item.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ". You have:\n\n" + bitLocker.GetBitsString());
							return false;
						}
						if (Popup.ShowYesNoCancel("Do you want to spend <" + bitCost.ToString() + "> to repair " + item.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + "? You have:\n\n" + bitLocker.GetBitsString()) == DialogResult.Yes)
						{
							flag = true;
		...
		public void RepairResultSuccess(GameObject who, GameObject obj)
		{
			...
			if (who.IsPlayer())
			{
				Popup.ShowBlock("You repair " + obj.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
			}
		...
		public void RepairResultPartialSuccess(GameObject who, GameObject obj)
		{
			if (who.IsPlayer())
			{
				Popup.Show("You make some progress repairing " + obj.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
			}
		}
		...
		public void RepairResultFailure(GameObject who, GameObject obj)
		{
			if (who.IsPlayer())
			{
				Popup.Show("You can't figure out how to fix " + obj.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
			}
		}
