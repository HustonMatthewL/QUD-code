	...
	public class ShortBlades_Shank : BaseSkill
	{
		...
		public static bool Cast(GameObject ParentObject, ShortBlades_Shank skill = null, GameObject weapon = null)
		{
			...
			try
			{
				...
				{
					IComponent<GameObject>.AddPlayerMessage(ParentObject.Does("attempt", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " to take advantage of " + combatTarget.poss("misfortune") + " and shank " + combatTarget.them + ".");
				}
				if (num > 0)
				{
