		...
		public bool PerformConk()
		{
			...
			try
			{
				...
				if (conkLocation == null)
				{
					...
					{
						Popup.ShowFail(combatTarget.Does("don't", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " have anything like a head to conk.");
					}
					return false;
				}
				...
				ParentObject.UseEnergy(1000, "Skill Cudgel Conk", null, null);
