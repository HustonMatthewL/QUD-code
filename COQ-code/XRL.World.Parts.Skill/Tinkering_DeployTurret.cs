	...
	public class Tinkering_DeployTurret : BaseSkill
	{
		...
		public override bool FireEvent(Event E)
		{
			if (E.ID == "CommandDeployTurret")
			{
				...
				ParentObject.UseEnergy(2000, "Skill Tinkering DeployTurret", null, null);
			}
