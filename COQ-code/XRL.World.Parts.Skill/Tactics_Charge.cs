				...
				if (j < count)
				{
					...
					if (cellFromDirection != null)
					{
						...
						if (combatTarget != null)
						{
							...
							{
								ParentObject.UseEnergy(1000, "Charging", null, null);
							}
						...
						if (ParentObject.Move(text3, Forced: false, System: false, IgnoreGravity: false, NoStack: false, AllowDashing: true, DoConfirmations: false, null, null, NearestAvailable: false, 0, "Charge", null))
						{
