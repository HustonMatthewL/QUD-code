	...
	public class Persuasion_Proselytize : BaseSkill
	{
		...
		public bool AttemptProselytization()
		{
			...
			if (flag && !ParentObject.CanMakeTelepathicContactWith(gameObject))
			{
				...
				{
					return ParentObject.Fail("Without a tongue, you cannot proselytize " + gameObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", as you cannot make telepathic contact with " + gameObject.them + ".");
				}
				return ParentObject.Fail("Without a tongue, you cannot proselytize " + gameObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
			}
			if (!ParentObject.CheckFrozen(Telepathic: true, Telekinetic: false, Silent: true, gameObject))
			{
				return ParentObject.Fail("Frozen solid, you cannot proselytize " + gameObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
			}
			if (gameObject.HasEffect(typeof(Proselytized), OurEffect))
			{
				return ParentObject.Fail("You have already proselytized " + gameObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
			}
			...
			if (gameObject.PartyLeader == ParentObject && ParentObject.IsPlayer() && Popup.ShowYesNo(gameObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " already your follower. Do you want to proselytize " + gameObject.them + " anyway?") != 0)
			{
				return false;
			}
			...
			ParentObject.UseEnergy(1000, "Skill Proselytize", null, null);
		...
		public static bool Proselytize(MentalAttackEvent E)
		{
			...
			{
				return E.Attacker.Fail(defender.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " unconvinced by your pleas.");
			}
			return true;
		}
	}
