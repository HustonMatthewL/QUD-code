	...
	public class Persuasion_Berate : BaseSkill
	{
		...
		public static int ApplyBerate(GameObject Actor, Cell TargetCell, bool? IsMissingTongue = null, object Source = null)
		{
			...
			for (int count = TargetCell.Objects.Count; i < count; i++)
			{
				...
				{
					Actor.Fail("{{r|You cannot berate " + gameObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " without a tongue.}}");
				}
				else if (!Actor.CheckFrozen(Telepathic: true, Telekinetic: false, Silent: true, gameObject))
				{
					Actor.Fail("{{r|You cannot berate " + gameObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " while frozen.}}");
				}
				else if (Actor.DistanceTo(gameObject) > VOCAL_RANGE && !Actor.CanMakeTelepathicContactWith(gameObject))
				{
					Actor.Fail("{{r|You cannot make telepathic contact with " + gameObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".}}");
				}
				else if (gameObject.HasEffect<Shamed>())
				{
					IComponent<GameObject>.XDidYToZ(Actor, "attempt", "to shame", gameObject, "with " + Actor.its + " words, but " + gameObject.does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: true, SecondPerson: true, null) + " already shamed", null, null, null, gameObject);
				}
				else
				{
