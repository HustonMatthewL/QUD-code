		...
		public override bool FireEvent(Event E)
		{
			...
			if (E.ID == "CommandAmputateLimb")
			{
				...
				if (gameObject == null)
				{
					...
					if (gameObject != null)
					{
						parentObject.ShowFailure("You cannot reach " + gameObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " to amputate " + gameObject.its + " limb.");
						return false;
					}
				...
				if (gameObject != parentObject && !gameObject.IsLedBy(parentObject))
				{
					...
					{
						parentObject.ShowFailure(gameObject.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " won't let you do that.");
					}
					else
					{
				...
				if (body == null)
				{
					parentObject.ShowFailure(gameObject.Does("have", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " no limbs.");
					return false;
				}
				...
				if (list.Count <= 0)
				{
					parentObject.ShowFailure(gameObject.Does("have", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " no limbs that can be amputated.");
					return false;
				}
				...
				if (gameObject == parentObject)
				{
					...
					if (bodyPart2 != null && (bodyPart2 == targetPart || targetPart.IsParentPartOf(bodyPart2)))
					{
						...
						if (weapon2 == null)
						{
							parentObject.ShowFailure("You cannot amputate the " + targetPart.TypeModel().Name + " holding " + parentObject.poss(weapon, Definite: true, null) + ".");
							return false;
						}
						weapon = weapon2;
					}
				...
				{
					IComponent<GameObject>.WDidXToYWithZ(parentObject, "try", "to amputate", gameObject, ordinalName + " with", weapon, ", but " + weapon.does("pass", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: true, SecondPerson: true, null) + " through " + gameObject.them, "!", null, null, null, null, UseFullNames: false, IndefiniteSubject: false, IndefiniteDirectObject: false, IndefiniteIndirectObject: false, IndefiniteDirectObjectForOthers: false, IndefiniteIndirectObjectForOthers: false, PossessiveDirectObject: true);
					parentObject.UseEnergy(1000, "Physical Skill Physic AmputateLimb Failure PhaseFailure", null, null);
				}
				else if (gameObject.IsInStasis())
				{
					IComponent<GameObject>.WDidXToYWithZ(parentObject, "try", "to amputate", gameObject, ordinalName + " with", weapon, ", but " + weapon.does("have", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: true, SecondPerson: true, null) + " no effect", null, null, null, null, null, UseFullNames: false, IndefiniteSubject: false, IndefiniteDirectObject: false, IndefiniteIndirectObject: false, IndefiniteDirectObjectForOthers: false, IndefiniteIndirectObjectForOthers: false, PossessiveDirectObject: true);
					parentObject.UseEnergy(1000, "Physical Skill Physic AmputateLimb Failure StasisFailure", null, null);
				}
				else
				{
					ParentObject.PlayWorldOrUISound("Sounds/Abilities/sfx_ability_skill_attack_generic_activate", null);
					...
					parentObject.UseEnergy(3000, "Physical Skill Physic AmputateLimb", null, null);
				}
			}
			return base.FireEvent(E);
			IL_04e5:
			parentObject.ShowFailure(gameObject.Does("see", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " no reason for you to amputate " + gameObject.its + " " + ordinalName + ".");
			return false;
		}
