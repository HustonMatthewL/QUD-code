...
namespace XRL.World.Parts.Skill
{
	...
	public class Shield_Slam : BaseSkill
	{
		...
		public bool Slam(GameObject TargetObject, GameObject ShieldObj, Cell TargetCell = null, bool Free = false)
		{
			...
			if (!Free)
			{
				ParentObject.UseEnergy(1000, "Combat Melee Skill ShieldSlam", null, null);
			}
			...
			else if (TargetObject.MakeSave("Strength", SlamSave, ParentObject, null, "ShieldSlam Slam", IgnoreNaturals: false, IgnoreNatural1: false, IgnoreNatural20: false, IgnoreGodmode: false, ShieldObj))
			{
				...
				if (ParentObject.IsPlayer())
				{
					IComponent<GameObject>.AddPlayerMessage(TargetObject.Does("resist", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " your shield slam.", 'r');
				}
			...
			else
			{
				...
				if (TargetCell.FireEvent(event2) && !TargetObject.IsNowhere())
				{
		...
		public bool PerformShieldSlam()
		{
			...
			if (combatTarget == null)
			{
				...
				{
					return ParentObject.Fail("You cannot reach " + combatTarget2.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " to shield slam " + combatTarget2.them + ".");
				}
