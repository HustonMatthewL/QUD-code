...
namespace XRL.World.AI.GoalHandlers
{
	...
	public class Flee : IMovementGoal
	{
		...
		{
			Think("I'm trying to flee from " + (Target?.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) ?? "nothing") + "!");
		}
		...
		public override void TakeAction()
		{
			...
			{
				GoalHandler.AddPlayerMessage("You are fleeing from " + Target.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: true, null) + "!", 'r');
			}
