		...
		public bool HandleCommand(GameObject Owner, GameObject Target = null, Cell TargetCell = null, int StandoffDistance = 0)
		{
			if (Command == "MetaCommandMoveAway")
			{
				...
				if (!text.IsNullOrEmpty())
				{
					...
					if (!text.IsNullOrEmpty() && Owner.Move(text, Forced: false, System: false, IgnoreGravity: false, NoStack: false, AllowDashing: true, DoConfirmations: true, null, null, NearestAvailable: false, null, null, null))
					{
						return true;
					}
				}
