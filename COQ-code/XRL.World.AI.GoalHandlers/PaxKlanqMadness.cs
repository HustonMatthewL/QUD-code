		...
		public override void TakeAction()
		{
			...
			if (Stage == 0)
			{
				if (base.ParentObject.IsVisible())
				{
					...
					MessageQueue.AddPlayerMessage(base.ParentObject.Does("shout", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " shouts {{O|KLANQ}}!");
				}
				base.ParentObject.UseEnergy(1000);
				if (5.in100())
				{
