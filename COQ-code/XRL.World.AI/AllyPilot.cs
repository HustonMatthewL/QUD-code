...
namespace XRL.World.AI
{
	public class AllyPilot : IAllyReason
	{
		...
		public override string GetText(GameObject Actor)
		{
			...
			{
				return "I am being piloted by " + Part.Pilot.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: false, Short: true, BaseOnly: true, IndicateHidden: false, SecondPerson: false, Reflexive: false, null) + ".";
			}
