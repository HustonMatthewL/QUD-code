...
namespace XRL.World.AI
{
	...
	public abstract class IAllyReasonSourced : IAllyReason
	{
		...
		{
			Name = Source?.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: false, Short: true, BaseOnly: true, IndicateHidden: false, SecondPerson: false, Reflexive: false, null);
		}
	}
}
