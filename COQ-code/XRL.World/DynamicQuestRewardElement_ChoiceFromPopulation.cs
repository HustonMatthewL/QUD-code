		...
		public override void award()
		{
			...
			foreach (List<PopulationResult> item in list)
			{
				...
				foreach (PopulationResult item2 in item)
				{
					...
					string text = (gameObject.HasTagOrProperty("DisplayFullNameAsReward") ? gameObject.GetDisplayName(int.MaxValue, null, null, AsIfKnown: true, Single: false, NoConfusion: false, NoColor: false, Stripped: false, ColorOnly: false, Visible: true, WithoutTitles: false, ForSort: false, Short: false, BaseOnly: false, WithIndefiniteArticle: false, WithDefiniteArticle: false, null, IndicateHidden: false, Capitalize: false, SecondPerson: false, Reflexive: false, null) : gameObject.DisplayNameOnlyDirect);
