...
namespace XRL.World
{
	...
	public class PronounSet : BasePronounProvider
	{
		...
		public static PronounSet Generate(bool Generic = false, int PluralChance = 0, int UseBareIndicativeChance = 0, GameObject For = null, string Genotype = null, string Subtype = null, string Species = null, string Culture = null, string Faction = null)
		{
			...
			NameMaker.MakeName(ref pronounSet._PersonTerm, For, Genotype, Subtype, Species, Culture, Faction, null, null, null, null, "GenderPersonTerm", null, null, SpecialFaildown: false, null, null);
			NameMaker.MakeName(ref pronounSet._ImmaturePersonTerm, For, Genotype, Subtype, Species, Culture, Faction, null, null, null, null, "GenderImmaturePersonTerm", null, null, SpecialFaildown: false, null, null);
			NameMaker.MakeName(ref pronounSet._FormalAddressTerm, For, Genotype, Subtype, Species, Culture, Faction, null, null, null, null, "GenderFormalAddressTerm", null, null, SpecialFaildown: false, null, null);
			NameMaker.MakeName(ref pronounSet._OffspringTerm, For, Genotype, Subtype, Species, Culture, Faction, null, null, null, null, "GenderOffspringTerm", null, null, SpecialFaildown: false, null, null);
			NameMaker.MakeName(ref pronounSet._SiblingTerm, For, Genotype, Subtype, Species, Culture, Faction, null, null, null, null, "GenderSiblingTerm", null, null, SpecialFaildown: false, null, null);
			NameMaker.MakeName(ref pronounSet._ParentTerm, For, Genotype, Subtype, Species, Culture, Faction, null, null, null, null, "GenderParentTerm", null, null, SpecialFaildown: false, null, null);
			return pronounSet;
		}
