...
namespace XRL.World
{
	...
	public class PsychicCombatSifrah : PsionicSifrah
	{
		...
		{
			base.Description = Description ?? ("engaging in psychic combat with " + ContextObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null));
			...
			else
			{
				...
				int num18 = GetGameCount(Slots: Slots.Count, Tokens: Tokens.Count, Outcome: GameOutcome.Failure, AsMaster: null, Mastered: null);
				int num19 = GetGameCount(Slots: Slots.Count, Tokens: Tokens.Count, Outcome: GameOutcome.CriticalFailure, AsMaster: null, Mastered: null);
