	...
	public class RealityDistortionSifrah : PsionicSifrah
	{
		...
		public RealityDistortionSifrah(GameObject ContextObject, string Subtype, string Description, int Rating, int Difficulty)
		{
			...
			else
			{
				...
				int num17 = GetGameCount(Slots: Slots.Count, Tokens: Tokens.Count, Outcome: GameOutcome.Failure, AsMaster: null, Mastered: null);
				int num18 = GetGameCount(Slots: Slots.Count, Tokens: Tokens.Count, Outcome: GameOutcome.CriticalFailure, AsMaster: null, Mastered: null);
