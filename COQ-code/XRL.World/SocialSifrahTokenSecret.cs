...
namespace XRL.World
{
	...
	public class SocialSifrahTokenSecret : SifrahPrioritizableToken
	{
		...
		public override bool CheckTokenUse(SifrahGame Game, SifrahSlot Slot, GameObject ContextObject)
		{
			...
			{
				Popup.ShowFail("You do not have any " + ((timesChosen > 0) ? "more " : "") + "secrets " + ContextObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ContextObject.Is + " interested in.");
				return false;
			}
