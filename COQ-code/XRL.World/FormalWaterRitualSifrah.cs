...
namespace XRL.World
{
	...
	public class FormalWaterRitualSifrah : RitualSifrah
	{
		...
		{
			Description = "Performing the formal water ritual with " + ContextObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
			...
			{
				Popup.ShowFail("You have no usable options to employ for performing the formal water ritual with " + ContextObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", giving you no chance of doing so well. You can remedy this situation by improving your Ego or by obtaining items useful in such a ritual.");
				Finished = true;
				Abort = true;
			}
		}
