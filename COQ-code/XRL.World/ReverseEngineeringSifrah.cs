...
namespace XRL.World
{
	...
	public class ReverseEngineeringSifrah : TinkeringSifrah
	{
		...
		{
			Description = "Reverse engineering " + ContextObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: false, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
			...
			int @for = GetTinkeringBonusEvent.GetFor(The.Player, ContextObject, "ReverseEngineerTurns", MaxTurns, 0, ref SecondaryBonus, ref Interrupt, ref PsychometryApplied, Interruptable: false, ForSifrah: true);
			MaxTurns += @for;
			if (SecondaryBonus != 0)
			{
		...
		{
			return Popup.ShowYesNo("Exiting will still disassemble " + ContextObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", and will result in an attempt at reverse engineering as matters stand. Do you still want to exit?") == DialogResult.Yes;
		}
		...
		public override void Finish(GameObject ContextObject)
		{
			...
			case GameOutcome.Failure:
				Succeeded = false;
				Critical = false;
				Popup.Show("You fail to reverse engineer " + ContextObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				break;
