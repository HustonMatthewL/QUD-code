...
namespace XRL.World
{
	...
	public class BeguilingSifrah : SocialSifrah
	{
		...
		{
			Description = "Beguiling " + ContextObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: false, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
		...
		{
			Popup.Show("Your coquetry infuriates " + ContextObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
			ContextObject.AddOpinion<OpinionCoquetry>(The.Player);
		}

		public virtual void ResultFailure(GameObject ContextObject)
		{
			Popup.Show("Your coquetry does not impress " + ContextObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
		}

		public virtual void ResultPartialSuccess(GameObject ContextObject)
		{
			Popup.Show("Your coquetry does not overcome " + ContextObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", but " + ContextObject.itis + " interested in hearing more.");
		...
		public virtual void ResultSuccess(GameObject ContextObject)
		{
			...
			{
				Popup.Show(ContextObject.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ContextObject.Is + " interested, but unable to join you.");
			}
		}
