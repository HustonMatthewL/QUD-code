...
namespace XRL.World
{
	...
	public class Gender : BasePronounProvider
	{
		...
		protected override async Task<bool> CustomizeProcess(string What)
		{
			while (true)
			{
				_Name = await Popup.AskStringAsync("What name should be used for your " + What + "? (Male, female, etc.)", Name, 12, 0, "abcdefghijklmnopqrstuvwxyz ", ReturnNullForEscape: false, EscapeNonMarkupFormatting: true, null);
				_Name = _Name.Trim(' ');
		...
		public static Gender Generate(bool Generic = false, int PluralChance = 0, int UseBareIndicativeChance = 0, GameObject For = null, string Genotype = null, string Subtype = null, string Species = null, string Culture = null, string Faction = null)
		{
			...
			do
			{
				...
				text = NameMaker.MakeName(For, Genotype, Subtype, Species, Culture, Faction, null, null, null, null, "GenderName", null, null, FailureOkay: false, SpecialFaildown: false, null, null);
			}
			...
			NameMaker.MakeName(ref gender._PersonTerm, For, Genotype, Subtype, Species, Culture, Faction, null, null, null, null, "GenderPersonTerm", null, null, SpecialFaildown: false, null, null);
			NameMaker.MakeName(ref gender._ImmaturePersonTerm, For, Genotype, Subtype, Species, Culture, Faction, null, null, null, null, "GenderImmaturePersonTerm", null, null, SpecialFaildown: false, null, null);
			NameMaker.MakeName(ref gender._FormalAddressTerm, For, Genotype, Subtype, Species, Culture, Faction, null, null, null, null, "GenderFormalAddressTerm", null, null, SpecialFaildown: false, null, null);
			NameMaker.MakeName(ref gender._OffspringTerm, For, Genotype, Subtype, Species, Culture, Faction, null, null, null, null, "GenderOffspringTerm", null, null, SpecialFaildown: false, null, null);
			NameMaker.MakeName(ref gender._SiblingTerm, For, Genotype, Subtype, Species, Culture, Faction, null, null, null, null, "GenderSiblingTerm", null, null, SpecialFaildown: false, null, null);
			NameMaker.MakeName(ref gender._ParentTerm, For, Genotype, Subtype, Species, Culture, Faction, null, null, null, null, "GenderParentTerm", null, null, SpecialFaildown: false, null, null);
			return gender;
		}
