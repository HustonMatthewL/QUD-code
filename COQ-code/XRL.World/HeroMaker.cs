	...
	public class HeroMaker
	{
		...
		public static GameObject MakeHero(GameObject BaseCreature, string[] AdditionalBaseTemplates = null, string[] AdditionalSpecializationTemplates = null, int TierOverride = -1, string SpecialType = "Hero")
		{
			try
			{
				...
				{
					BaseCreature.RequirePart<HeroIconColor>().Configure(text3, text2.IsNullOrEmpty() ? text3 : text2, text4, null, null, ICON_COLOR_PRIORITY, ICON_COLOR_PRIORITY, ICON_COLOR_PRIORITY, null, null);
				}
				...
				string text10 = NameMaker.MakeHonorific(BaseCreature, null, null, null, null, null, null, null, null, null, SpecialType, null, SpecialFaildown: true, null, null);
				bool value2 = !text10.IsNullOrEmpty() || BaseCreature.HasHonorific;
				string text11 = NameMaker.MakeEpithet(BaseCreature, null, null, null, null, null, null, null, null, null, SpecialType, null, SpecialFaildown: true, value2, null);
		...
		public static string ResolveTemplateTag(GameObject BaseCreature, string Tag, string Default = null, string[] AdditionalBaseTemplates = null, string[] AdditionalSpecializationTemplates = null)
		{
			...
			if (AdditionalBaseTemplates != null)
			{
				...
				foreach (string name in array)
				{
					...
					{
						@default = blueprintIfExists.GetTag(Tag, @default);
					}
				}
			}
			...
			if (AdditionalSpecializationTemplates != null)
			{
				...
				foreach (string name2 in array)
				{
					...
					{
						@default = blueprintIfExists2.GetTag(Tag, @default);
					}
				}
			}
