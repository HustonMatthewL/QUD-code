...
namespace XRL.World
{
	...
	public static class Factions
	{
		...
		{
			DataManager.RegisterXMLRoot("factions");
		}
		...
		private static void InitAttitudes()
		{
			...
			{
				if (faction2 != faction && faction2.GetFeelingTowardsFaction(faction.Name, null) != 0)
				{
		...
		public static int GetFeelingFactionToFaction(string Faction1, string Faction2)
		{
			...
			try
			{
				return Get(Faction1).GetFeelingTowardsFaction(Faction2, null);
			}
			catch (Exception x)
			{
