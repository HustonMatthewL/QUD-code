...
namespace XRL.World.Conversations.Parts
{
	public class WaterRitualCookingRecipe : IWaterRitualPart
	{
		...
		public override bool HandleEvent(EnteredElementEvent E)
		{
			...
			if (UseReputation())
			{
				Popup.Show(The.Speaker.Does("share", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " the recipe for {{W|" + Recipe.GetDisplayName() + "}}!");
