...
namespace XRL.World.Conversations.Parts
{
	public abstract class IWaterRitualSecretPart : IWaterRitualPart
	{
		...
		{
			DelimitedStringEnumerator delimitedStringEnumerator;
			DelimitedStringEnumerator enumerator;
			if (IsBuy)
			{
				...
				delimitedStringEnumerator = value.DelimitedBy(';');
			...
			else
			{
				...
				delimitedStringEnumerator = value2.DelimitedBy(';');
				enumerator = delimitedStringEnumerator.GetEnumerator();
				while (enumerator.MoveNext())
				{
