...
namespace XRL.World.Conversations.Parts
{
	public class WaterRitualBegin : IWaterRitualPart
	{
		...
		public override bool HandleEvent(EnterElementEvent E)
		{
			...
			{
				The.Player.ShowFailure("You are too far from " + The.Speaker.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " to perform the water ritual.");
				return false;
			}
			bool flag = false;
