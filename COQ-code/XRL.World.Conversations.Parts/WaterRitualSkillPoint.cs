...
namespace XRL.World.Conversations.Parts
{
	public class WaterRitualSkillPoint : IWaterRitualPart
	{
		...
		public override bool HandleEvent(EnteredElementEvent E)
		{
			if (UseReputation())
			{
				Popup.Show("Talking to " + The.Speaker.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " rouses in you an inert truth. You once wore the frock of a child. You poured salt through the cracks of your fingers, and you watched worlds form. Can it be all so simple still?");
