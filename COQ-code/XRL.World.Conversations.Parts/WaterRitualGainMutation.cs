...
namespace XRL.World.Conversations.Parts
{
	public class WaterRitualGainMutation : IWaterRitualPart
	{
		...
		public string DisplayName => Entry?.DisplayName ?? Mutation;
		...
		public override void Awake()
		{
			...
			if (Mutation.IsNullOrEmpty())
			{
				...
				if (Entry == null)
				{
					Entry = MutationFactory.GetMutationEntry(Mutation).FirstOrDefault();
				}
		...
		public override bool HandleEvent(EnteredElementEvent E)
		{
			if (UseReputation())
			{
				Popup.Show("Despite your genetic limitations, " + The.Speaker.does("teach", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " you to improvise {{M|" + DisplayName + "}}!");
