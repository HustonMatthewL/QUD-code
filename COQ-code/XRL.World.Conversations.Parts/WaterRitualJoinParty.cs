	...
	public class WaterRitualJoinParty : IWaterRitualPart
	{
		...
		public override bool HandleEvent(EnteredElementEvent E)
		{
			if (UseReputation())
			{
				...
				Popup.Show(The.Speaker.Does("join", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " you!");
			}
