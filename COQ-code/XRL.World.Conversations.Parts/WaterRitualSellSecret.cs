...
namespace XRL.World.Conversations.Parts
{
	public class WaterRitualSellSecret : IWaterRitualSecretPart
	{
		...
		public override bool HandleEvent(EnteredElementEvent E)
		{
			...
			{
				Popup.ShowFail(The.Speaker.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " can't grant you any more reputation.");
			}
			else
			{
				Share();
