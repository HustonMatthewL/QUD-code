		...
		public override bool HandleEvent(EnterElementEvent E)
		{
			...
			foreach (GameObject @object in inventory.GetObjects(IsAwardableBook))
			{
				...
				if (num > 0)
				{
					...
					list.Add(@object.GetDisplayName(1120, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, ColorOnly: false, Visible: true, WithoutTitles: false, ForSort: false, Short: false, BaseOnly: false, WithIndefiniteArticle: false, WithDefiniteArticle: false, null, IndicateHidden: false, Capitalize: false, SecondPerson: false, Reflexive: false, null) + " [{{C|" + num + "}} XP]");
				}
			}
			if (list2.Count == 0)
			{
			...
			string text = The.Speaker.Does("provide", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: true, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: true, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null);
			string text2 = The.Speaker.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: true, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: true, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
