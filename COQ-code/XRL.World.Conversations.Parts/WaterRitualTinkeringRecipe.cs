	...
	public class WaterRitualTinkeringRecipe : IWaterRitualPart
	{
		...
		public override bool HandleEvent(EnteredElementEvent E)
		{
			if (UseReputation())
			{
				...
				The.Listener.PlayWorldOrUISound("sfx_characterMod_tinkerSchematic_learn", null);
				if (Data.Type == "Mod")
				{
					Popup.Show(The.Speaker.Does("teach", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " you to craft the item modification {{W|" + Data.DisplayName + "}}.");
				}
				else
				{
					GameObject gameObject = GameObject.CreateSample(Data.Blueprint);
					gameObject.MakeUnderstood();
					Popup.Show(The.Speaker.Does("teach", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " you to craft " + (gameObject.IsPlural ? Data.DisplayName : Grammar.Pluralize(gameObject.DisplayNameOnlyDirectAndStripped)) + ".");
					gameObject.Obliterate();
				}
			}
			return base.HandleEvent(E);
