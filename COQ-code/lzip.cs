...
public class lzip
{
	...
	[DllImport("libzipw", CharSet = CharSet.Auto)]
	internal static extern bool zipValidateFile([MarshalAs(UnmanagedType.LPWStr)] string zipArchive, IntPtr FileBuffer, int fileBufferLength);

	[DllImport("libzipw", CharSet = CharSet.Auto)]
	internal static extern int zipGetTotalFiles([MarshalAs(UnmanagedType.LPWStr)] string zipArchive, IntPtr FileBuffer, int fileBufferLength);

	[DllImport("libzipw", CharSet = CharSet.Auto)]
	internal static extern int zipGetTotalEntries([MarshalAs(UnmanagedType.LPWStr)] string zipArchive, IntPtr FileBuffer, int fileBufferLength);

	[DllImport("libzipw", CharSet = CharSet.Auto)]
	internal static extern int zipGetInfoA([MarshalAs(UnmanagedType.LPWStr)] string zipArchive, IntPtr total, IntPtr FileBuffer, int fileBufferLength);

	[DllImport("libzipw", CharSet = CharSet.Auto)]
	internal static extern IntPtr zipGetInfo([MarshalAs(UnmanagedType.LPWStr)] string zipArchive, int size, IntPtr unc, IntPtr comp, IntPtr offs, IntPtr FileBuffer, int fileBufferLength);

	[DllImport("libzipw")]
	internal static extern void releaseBuffer(IntPtr buffer);

	[DllImport("libzipw", CharSet = CharSet.Auto)]
	internal static extern ulong zipGetEntrySize([MarshalAs(UnmanagedType.LPWStr)] string zipArchive, [MarshalAs(UnmanagedType.LPWStr)] string entry, IntPtr FileBuffer, int fileBufferLength);

	[DllImport("libzipw", CharSet = CharSet.Auto)]
	internal static extern bool zipEntryExists([MarshalAs(UnmanagedType.LPWStr)] string zipArchive, [MarshalAs(UnmanagedType.LPWStr)] string entry, IntPtr FileBuffer, int fileBufferLength);

	[DllImport("libzipw", CharSet = CharSet.Auto)]
	internal static extern int zipCD(int levelOfCompression, [MarshalAs(UnmanagedType.LPWStr)] string zipArchive, [MarshalAs(UnmanagedType.LPWStr)] string inFilePath, [MarshalAs(UnmanagedType.LPWStr)] string fileName, [MarshalAs(UnmanagedType.LPWStr)] string comment, [MarshalAs(UnmanagedType.LPStr)] string password, bool useBz2, int diskSize, IntPtr bprog);

	[DllImport("libzipw", CharSet = CharSet.Auto)]
	internal static extern int zipCDList(int levelOfCompression, [MarshalAs(UnmanagedType.LPWStr)] string zipArchive, IntPtr filename, int arrayLength, IntPtr prog, IntPtr filenameForced, [MarshalAs(UnmanagedType.LPStr)] string password, bool useBz2, int diskSize, IntPtr bprog);

	[DllImport("libzipw", CharSet = CharSet.Auto)]
	internal static extern bool zipBuf2File(int levelOfCompression, [MarshalAs(UnmanagedType.LPWStr)] string zipArchive, [MarshalAs(UnmanagedType.LPWStr)] string arc_filename, IntPtr buffer, int bufferSize, [MarshalAs(UnmanagedType.LPWStr)] string comment, [MarshalAs(UnmanagedType.LPStr)] string password, bool useBz2);

	[DllImport("libzipw", CharSet = CharSet.Auto)]
	internal static extern int zipDeleteFile([MarshalAs(UnmanagedType.LPWStr)] string zipArchive, [MarshalAs(UnmanagedType.LPWStr)] string arc_filename, [MarshalAs(UnmanagedType.LPWStr)] string tempArchive);

	[DllImport("libzipw", CharSet = CharSet.Auto)]
	internal static extern int zipEntry2Buffer([MarshalAs(UnmanagedType.LPWStr)] string zipArchive, [MarshalAs(UnmanagedType.LPWStr)] string entry, IntPtr buffer, int bufferSize, IntPtr FileBuffer, int fileBufferLength, [MarshalAs(UnmanagedType.LPStr)] string password);
	...
	[DllImport("libzipw", CharSet = CharSet.Auto)]
	internal static extern int zipEX([MarshalAs(UnmanagedType.LPWStr)] string zipArchive, [MarshalAs(UnmanagedType.LPWStr)] string outPath, IntPtr progress, IntPtr FileBuffer, int fileBufferLength, IntPtr proc, [MarshalAs(UnmanagedType.LPStr)] string password);

	[DllImport("libzipw", CharSet = CharSet.Auto)]
	internal static extern int zipEntry([MarshalAs(UnmanagedType.LPWStr)] string zipArchive, [MarshalAs(UnmanagedType.LPWStr)] string arc_filename, [MarshalAs(UnmanagedType.LPWStr)] string outpath, IntPtr FileBuffer, int fileBufferLength, IntPtr proc, [MarshalAs(UnmanagedType.LPStr)] string password);

	[DllImport("libzipw", CharSet = CharSet.Auto)]
	internal static extern uint getEntryDateTime([MarshalAs(UnmanagedType.LPWStr)] string zipArchive, [MarshalAs(UnmanagedType.LPWStr)] string arc_filename, IntPtr FileBuffer, int fileBufferLength);

	[DllImport("libzipw")]
	internal static extern int freeMemStruct(IntPtr buffer);

	[DllImport("libzipw", CharSet = CharSet.Auto)]
	internal static extern IntPtr zipCDMem(IntPtr info, IntPtr pnt, int levelOfCompression, IntPtr source, int sourceLen, [MarshalAs(UnmanagedType.LPWStr)] string fileName, [MarshalAs(UnmanagedType.LPWStr)] string comment, [MarshalAs(UnmanagedType.LPStr)] string password, bool useBz2);
	...
	[DllImport("libzipw", CharSet = CharSet.Auto)]
	internal static extern int zipCDMemAdd(IntPtr zf, int levelOfCompression, IntPtr source, int sourceLen, [MarshalAs(UnmanagedType.LPWStr)] string fileName, [MarshalAs(UnmanagedType.LPWStr)] string comment, [MarshalAs(UnmanagedType.LPStr)] string password, bool useBz2);
	...
	[DllImport("libzipw")]
	internal static extern int gzip_File([MarshalAs(UnmanagedType.LPWStr)] string inFile, [MarshalAs(UnmanagedType.LPWStr)] string outFile, int level, IntPtr progress, bool addHeader);

	[DllImport("libzipw")]
	internal static extern int ungzip_File([MarshalAs(UnmanagedType.LPWStr)] string inFile, [MarshalAs(UnmanagedType.LPWStr)] string outFile, IntPtr progress);

	[DllImport("libzipw")]
	public static extern void setCancel();

	[DllImport("libzipw", CharSet = CharSet.Ansi)]
	internal static extern int readTarA([MarshalAs(UnmanagedType.LPWStr)] string zipArchive, IntPtr total);

	[DllImport("libzipw", CharSet = CharSet.Ansi)]
	internal static extern IntPtr readTar([MarshalAs(UnmanagedType.LPWStr)] string zipArchive, int size, IntPtr unc);

	[DllImport("libzipw", CharSet = CharSet.Ansi)]
	internal static extern int createTar([MarshalAs(UnmanagedType.LPWStr)] string outFile, IntPtr filePath, IntPtr filename, int arrayLength, IntPtr prog, IntPtr bprog);

	[DllImport("libzipw", CharSet = CharSet.Ansi)]
	internal static extern int extractTar([MarshalAs(UnmanagedType.LPWStr)] string inFile, [MarshalAs(UnmanagedType.LPWStr)] string outDir, [MarshalAs(UnmanagedType.LPWStr)] string entry, IntPtr prog, IntPtr bprog, bool fullPaths);

	[DllImport("libzipw", CharSet = CharSet.Auto)]
	internal static extern int bz2(bool decompress, int level, [MarshalAs(UnmanagedType.LPWStr)] string inFile, [MarshalAs(UnmanagedType.LPWStr)] string outFile, IntPtr byteProgress);
	...
	public static int gzip(byte[] source, byte[] outBuffer, int level, bool addHeader = true, bool addFooter = true, bool overrideDateTimeWithLength = false)
	{
		...
		if (addHeader && overrideDateTimeWithLength)
		{
			...
			outBuffer[5] = (byte)(((uint)num3 >> 8) & 0xFF);
			outBuffer[6] = (byte)(((uint)num3 >> 16) & 0xFF);
			outBuffer[7] = (byte)(((uint)num3 >> 24) & 0xFF);
			outBuffer[9] = 254;
		}
		return num3;
	}
