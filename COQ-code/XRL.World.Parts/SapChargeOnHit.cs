...
namespace XRL.World.Parts
{
	...
	public class SapChargeOnHit : IActivePart
	{
		...
		public GameObject SapCharge(GameObject obj, ref int ChargeStored, int useChanceEach)
		{
			...
			obj.SplitFromStack();
			if (!obj.UseCharge(num2, LiveChargeOnly, 0L, IncludeTransient: true, IncludeBiological: true, null))
			{
				return null;
			}
		...
		public bool CheckApply(Event E)
		{
			...
			int @for = GetSpecialEffectChanceEvent.GetFor(gameObjectParameter, parentObject2, "SapChargeOnHitActivationEach", ChanceEach, projectile, subject);
			...
			for (int count = list.Count; i < count; i++)
			{
				...
				PerformSapCharge(gameObject, ref ChargeStored, @for, list2, Single);
			...
			if (flag && list2.Count > 0)
			{
				...
				if (text != null && (text.Contains("%o") || text.Contains("%O")))
				{
					...
					if (flag2 || list3.Count > 0)
					{
						...
						if (flag2)
						{
							stringBuilder2.Append(gameObjectParameter2.IsPlayer() ? "you" : gameObjectParameter2.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null));
							if (list3.Count > 0)
							{
						...
						{
							stringBuilder2.Append(Grammar.MakeAndList(list3)).Append(" on ").Append(gameObjectParameter2.IsPlayer() ? "your person" : gameObjectParameter2.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null));
						}
						if (text.Contains("%o"))
						{
				...
				if (text != null)
				{
					if (text.Contains("%a"))
					{
						text = text.Replace("%a", gameObjectParameter.IsPlayer() ? "you" : gameObjectParameter.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null));
					}
					if (text.Contains("%A"))
					{
						text = text.Replace("%A", gameObjectParameter.IsPlayer() ? "You" : gameObjectParameter.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null));
					...
					if (text.Contains("%d"))
					{
						text = text.Replace("%d", gameObjectParameter2.IsPlayer() ? "you" : gameObjectParameter2.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null));
					}
					if (text.Contains("%D"))
					{
						text = text.Replace("%D", gameObjectParameter2.IsPlayer() ? "You" : gameObjectParameter2.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null));
					...
					if (text.Contains("%w") || text.Contains("%W"))
					{
						...
						else
						{
							...
							string text2 = ((equipped == null || ParentObject.HasProperName) ? ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) : equipped.poss(ParentObject, Definite: true, null));
							if (text.Contains("%w"))
							{
