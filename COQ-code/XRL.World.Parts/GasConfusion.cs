...
namespace XRL.World.Parts
{
	...
	public class GasConfusion : IGasBehavior
	{
		...
		public void ApplyConfusion(GameObject GO)
		{
			...
			{
				int @for = GetRespiratoryAgentPerformanceEvent.GetFor(GO, ParentObject, part, null, 0, 0, WillAllowSave: true);
				if (@for > 0 && !GO.MakeSave("Toughness", 5 + part.Level + @for / 10, null, null, "Confusion Inhaled Gas", IgnoreNaturals: false, IgnoreNatural1: false, IgnoreNatural20: false, IgnoreGodmode: false, ParentObject))
				{
