...
namespace XRL.World.Parts
{
	...
	public class AddsRep : IActivePart
	{
		...
		{
			DelimitedStringEnumerator enumerator = Faction.DelimitedBy(',').GetEnumerator();
		...
		public void CheckApplyBonus(GameObject Subject = null, bool UseCharge = false, int MultipleCharge = 1)
		{
			...
			if (AppliedBonus)
			{
				if (IsDisabled(UseCharge, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, MultipleCharge, null, UseChargeIfUnpowered: false, 0L, null) || !Subject.IsPlayer())
				{
					UnapplyBonus();
				}
			}
			else if (IsReady(UseCharge, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, MultipleCharge, null, UseChargeIfUnpowered: false, 0L, null))
			{
				ApplyBonus(Subject);
			}
		}
