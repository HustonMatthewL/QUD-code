...
namespace XRL.World.Parts
{
	...
	public class BootSequence : IPoweredPart
	{
		...
		public void Reboot()
		{
			...
			PartWasReady = IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null);
			if (PartWasReady)
			{
				InitBoot();
			}
		...
		{
			if (PartWasReady && !IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, (BootTimeLeft > 0) ? ChargeUse : 0, UseChargeIfUnpowered: false, 0L, null))
			{
				AbortBoot();
				PartWasReady = false;
			}
		...
		public override bool FireEvent(Event E)
		{
			...
			{
				if (IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, 0, UseChargeIfUnpowered: false, 0L, null))
				{
					BootTimeLeft = 0;
			...
			else if (E.ID == "LiquidFueledPowerPlantFueled" && !PartWasReady && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				InitBoot();
				PartWasReady = true;
			}
