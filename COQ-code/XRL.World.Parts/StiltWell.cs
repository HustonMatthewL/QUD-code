...
namespace XRL.World.Parts
{
	...
	public class StiltWell : IPart
	{
		...
		public static int GetArtifactReputationValue(GameObject obj)
		{
			...
			int result = 0;
			if (part != null && part.Complexity > 0 && Scanning.GetScanTypeFor(obj) != 0)
			{
		...
		public static bool GiveArtifacts(GameObject Object, GameObject Well)
		{
			...
			foreach (GameObject @object in inventory.Objects)
			{
				...
				if (artifactReputationValue > 0)
				{
					...
					list2.Add(@object.GetDisplayName(1120, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, ColorOnly: false, Visible: true, WithoutTitles: false, ForSort: false, Short: false, BaseOnly: false, WithIndefiniteArticle: false, WithDefiniteArticle: false, null, IndicateHidden: false, Capitalize: false, SecondPerson: false, Reflexive: false, null) + " [{{C|+" + artifactReputationValue + "}} reputation]");
				}
			}
			if (list2.Count <= 0)
			{
			...
			if (!list7.IsNullOrEmpty())
			{
				...
				string text = Grammar.MakeAndList(list7.Select((GameObject x) => x.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null)).ToList());
