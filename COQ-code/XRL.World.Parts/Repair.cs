...
namespace XRL.World.Parts
{
	...
	public class Repair : IPart, IRepairSifrahHandler
	{
		...
		public override bool HandleEvent(InventoryActionEvent E)
		{
			if (E.Command == "Repair")
			{
				...
				if (ParentObject.CurrentCell != null)
				{
					...
					{
						E.Actor.ShowFailure("You cannot reach " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " to repair " + ParentObject.them + ".");
						return false;
					}
					if (!E.Actor.PhaseMatches(ParentObject))
					{
						E.Actor.ShowFailure("You are out of phase with " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " and cannot repair " + ParentObject.them + ".");
						return false;
					}
				}
				...
				E.Actor.UseEnergy(1000, "Item Repair", null, null);
				E.RequestInterfaceExit();
			}
			return base.HandleEvent(E);
		}
		...
		public void RepairResultFailure(GameObject who, GameObject obj)
		{
			if (who.IsPlayer())
			{
				Popup.Show("You can't figure out how to fix " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
			}
		}
