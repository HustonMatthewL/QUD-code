		...
		public override bool HandleEvent(BeforeApplyDamageEvent E)
		{
			if (!Disabled && E.Object == ParentObject && E.Damage.HasAttribute("Mental"))
			{
				if (!E.Indirect && E.Actor != null && E.Actor.IsPlayer())
				{
					...
					{
						IComponent<GameObject>.AddPlayerMessage("Your mental attack does not affect " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
					}
				}
