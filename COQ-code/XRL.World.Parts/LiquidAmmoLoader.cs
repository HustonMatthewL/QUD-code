...
namespace XRL.World.Parts
{
	...
	public class LiquidAmmoLoader : IActivePart
	{
		...
		{
			if (!IsFuelGood() || IsDisabled(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, E.ActivePartsIgnoreSubject, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				if (E.Message == null)
				{
		...
		public override bool HandleEvent(LoadAmmoEvent E)
		{
			...
			ActivePartStatus activePartStatus = GetActivePartStatus(UseCharge: true, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, E.ActivePartsIgnoreSubject, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null);
		...
		{
			if (!IsFuelGood() || IsDisabled(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				E.Message = GetStatusMessage();
			}
			return base.HandleEvent(E);
			...
			if ((E.Weapon == null || E.Weapon == ParentObject) && !E.CheckedForReload.Contains(this))
			{
				...
				if ((part == null || part.FiresManually) && E.MinimumCharge <= 0 && (E.Weapon == ParentObject || ParentObject.IsEquippedProperly()))
				{
					...
					if (liquidVolume.IsPureLiquid(Liquid) && liquidVolume.Volume >= liquidVolume.MaxVolume)
					{
						if (E.Actor.IsPlayer())
						{
							IComponent<GameObject>.AddPlayerMessage(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " already full of " + liquidVolume.GetLiquidName() + ".");
						}
						return true;
					}
					...
					if (freeDrams <= 0)
					{
						if (E.Actor.IsPlayer())
						{
							...
							IComponent<GameObject>.AddPlayerMessage("You have no " + Liquid + " for " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", 'r');
						}
						return true;
					}
					E.TriedToReload.Add(this);
					string text = ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
					if (liquidVolume.Volume > 0 && !liquidVolume.IsPureLiquid(Liquid))
					{
						...
						text = ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
					}
					int val = liquidVolume.MaxVolume - liquidVolume.Volume;
					int num = Math.Min(freeDrams, val);
					E.Actor.UseDrams(num, Liquid, ParentObject);
					liquidVolume.MixWith(new LiquidVolume(Liquid, num), null, null, null);
					E.Reloaded.Add(this);
					...
					if (E.Actor.IsPlayer())
					{
						IComponent<GameObject>.AddPlayerMessage("You " + ((liquidVolume.Volume < liquidVolume.MaxVolume) ? "partially " : "") + "fill " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " with " + liquidVolume.GetLiquidName() + ".");
					}
				}
			}
			return base.HandleEvent(E);
		...
		public override bool HandleEvent(GetDisplayNameEvent E)
		{
			...
			{
				E.AddMissileWeaponDamageTag(GetMissileWeaponPerformanceEvent.GetFor(ParentObject.Equipped, ParentObject, null, null, null, null, null, null, null, null, null));
			}
			return base.HandleEvent(E);
		}
		...
		public string GetStatusMessage(ActivePartStatus Status)
		{
			...
			{
				ActivePartStatus.ProcessInputMissing => ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " empty.", 
				ActivePartStatus.ProcessInputInvalid => ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " not loaded with the correct liquid.", 
				_ => ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " " + GetStatusPhrase() + ".", 
			};
		}
		...
		public string GetStatusMessage()
		{
			...
			return GetStatusMessage(GetActivePartStatus(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null));
		}
				...
				if (gameObjectParameter2 != null && gameObject != null)
				{
					...
					if (gameObject.IsPlayer())
					{
						if (num > 0)
						{
							...
							num.ToString();
							int? num2 = Popup.AskNumber("Supply " + gameObjectParameter2.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " with how many drams of your " + Liquid + "? (max=" + num + ")", "Sounds/UI/ui_notification", "", num, 0, num);
							int num3 = 0;
							try
							{
						...
						{
							Popup.Show("You have no " + Liquid + " to supply " + gameObjectParameter2.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " with.");
						}
						else if (storableDrams <= 0)
						{
							Popup.Show(gameObjectParameter2.Does("have", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " no room for more " + Liquid + ".");
						}
					}
					if (num > 0)
					{
						...
						gameObject.UseEnergy(1000, "Ammo Liquid Transfer", null, null);
					}
				}
			}
