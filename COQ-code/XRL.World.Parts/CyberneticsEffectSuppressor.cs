...
namespace XRL.World.Parts
{
	...
	public class CyberneticsEffectSuppressor : IActivePart
	{
		...
		{
			if (Chance >= 100 && Effects.CachedCommaExpansion().Contains(E.Name) && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				return false;
			}
			return base.HandleEvent(E);
