		...
		public override bool FireEvent(Event E)
		{
			if (E.ID == "ClimbUp")
			{
				...
				if (gameObjectParameter != null && gameObjectParameter.HasEffect<Flying>() && gameObjectParameter.IsPlayer())
				{
					...
					gameObjectParameter.Move("U", Forced: false, System: false, IgnoreGravity: false, NoStack: false, AllowDashing: false, DoConfirmations: true, null, null, NearestAvailable: false, null, null, null);
					return false;
				}
				return true;
			}
