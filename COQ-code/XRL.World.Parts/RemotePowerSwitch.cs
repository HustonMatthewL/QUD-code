...
namespace XRL.World.Parts
{
	...
	public class RemotePowerSwitch : IPoweredPart
	{
		...
		public override bool HandleEvent(GetInventoryActionsEvent E)
		{
			...
			if (powerSwitch != null && ParentObject.Understood() && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
		...
		public override bool HandleEvent(InventoryActionEvent E)
		{
			if (E.Command == "RemotePowerSwitchOn")
			{
				...
				if (powerSwitch != null && E.Actor.CheckFrozen(Telepathic: false, Telekinetic: true))
				{
					...
					E.Actor.UseEnergy(1000, "Item Activate", null, null);
			...
			else if (E.Command == "RemotePowerSwitchOff")
			{
				...
				if (powerSwitch2 != null && E.Actor.CheckFrozen(Telepathic: false, Telekinetic: true))
				{
					...
					E.Actor.UseEnergy(1000, "Item Deactivate", null, null);
					E.RequestInterfaceExit();
				}
			}
			return base.HandleEvent(E);
