	...
	public class Ubernostrum_Tonic_Applicator : IPart
	{
		...
		public override bool HandleEvent(GetUtilityScoreEvent E)
		{
			if (E.Damage == null)
			{
				...
				if (body != null && body.FindRegenerablePart(null, null, null, null) != null)
				{
					E.ApplyScore(80);
				}
				else
		...
		public override bool FireEvent(Event E)
		{
			if (E.ID == "ApplyTonic")
			{
				...
				int @for = GetTonicDurationEvent.GetFor(ParentObject, gameObjectParameter, gameObjectParameter2, "Ubernostrum", 10 * intParameter, intParameter, Healing: true);
				gameObjectParameter2.FireEvent("ApplyingUbernostrum");
				Ubernostrum_Tonic e = new Ubernostrum_Tonic(@for);
