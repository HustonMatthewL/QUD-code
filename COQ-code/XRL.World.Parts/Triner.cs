...
namespace XRL.World.Parts
{
	...
	public class Triner : Twinner
	{
		...
		{
			if ((Twin?.CurrentCell != null && Triplet?.CurrentCell != null) || !CheckMyRealityDistortionAdvisability(null, null, null, null, null, null))
			{
				return;
			}
			...
			if (Twin?.CurrentCell == null)
			{
				...
				if (randomElement != null)
				{
					...
					if (ParentObject.FireEvent(@event) && randomElement.FireEvent(@event))
					{
			...
			@event.SetParameter("Cell", randomElement2);
			if (ParentObject.FireEvent(@event) && randomElement2.FireEvent(@event))
			{
		...
		public override void EnteredCell()
		{
			...
			if (Twin != null)
			{
				...
				if (cell != null)
				{
					...
					Twin.SystemLongDistanceMoveTo(cell, null);
					Twin.UseEnergy(1000, "Move Join Leader", null, null);
				}
			}
			if (Triplet != null)
			{
				...
				if (cell != null)
				{
					...
					Triplet.SystemLongDistanceMoveTo(cell, null);
					Triplet.UseEnergy(1000, "Move Join Leader", null, null);
				}
			}
		}
