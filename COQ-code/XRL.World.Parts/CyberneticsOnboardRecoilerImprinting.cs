...
namespace XRL.World.Parts
{
	...
	public class CyberneticsOnboardRecoilerImprinting : IProgrammableRecoiler
	{
		...
		public override bool HandleEvent(CommandEvent E)
		{
			...
			{
				E.Actor.UseEnergy(1000, "Cybernetics Recoiler Imprint", null, null);
		...
		public void UpdateName()
		{
			...
			if (part != null)
			{
				...
				{
					ParentObject.Implantee.GetActivatedAbility(part.ActivatedAbilityID).DisplayName = "Recoil to " + name;
				}
			}
