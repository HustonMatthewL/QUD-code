...
namespace XRL.World.Parts
{
	...
	public class Stopsvaalinn : IPoweredPart
	{
		...
		{
			if (!IsActive() && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) && ForceFieldAdvisable() && E.Actor == ParentObject.Equipped && E.Actor.IsActivatedAbilityAIUsable(ActivatedAbilityID))
			{
		...
		public override bool HandleEvent(CommandEvent E)
		{
			if (E.Command == "ActivateStopsvalinn" && E.Actor == ParentObject.Equipped && ActivateStopsvalinn(E))
			{
				...
				E.Actor?.UseEnergy(1000, "Item Stopsvalinn", null, null);
			}
			return base.HandleEvent(E);
		}
