	...
	public class Teleprojector : IPart, IHackingSifrahHandler
	{
		...
		public override bool HandleEvent(BootSequenceDoneEvent E)
		{
			if (ParentObject.Equipped != null)
			{
				...
				{
					Popup.Show(ParentObject.Does("attune", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " to your physiology.");
				}
		...
		public override bool FireEvent(Event E)
		{
			...
			{
				if (GameObject.Validate(ref Target) && MaintainChargeUse > 0 && !ParentObject.UseCharge(MaintainChargeUse * MyPowerLoadLevel() / 100, LiveOnly: false, 0L, IncludeTransient: true, IncludeBiological: true, null))
				{
					InterruptDomination();
				}
			}
		...
		private bool ActivateTeleprojector()
		{
			...
			{
				return actor.Fail(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " still cooling down.");
			}
			...
			foreach (GameObject item in cell.GetObjectsWithPart("Robot"))
			{
				...
				if (item.Brain == null)
				{
					return actor.Fail("There seems to be no digital mind in " + item.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " to dominate.");
				}
				...
				{
					return actor.Fail(item.Does("do", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " not have a digital mind you can make electronic contact with.");
				}
				...
				return actor.Fail(ParentObject.Does("don't", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " have enough charge to function.");
			}
			if (!flag)
			{
				Popup.ShowFail("There is nothing there that " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " can uplink with.");
			}
			return false;
		}
		...
		public bool RoboDom(MentalAttackEvent E)
		{
			...
			if (E.Penetrations > 0)
			{
				...
				if (defender.ApplyEffect(e))
				{
					...
					Popup.Show("You take control of " + defender.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + "!");
