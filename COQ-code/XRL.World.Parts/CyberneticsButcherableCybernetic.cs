		...
		public bool AttemptButcher(GameObject who, bool Automatic = false, bool SkipSkill = false, bool IntoInventory = false, int ChanceMod = 0, Cell FromCell = null, List<GameObject> Tracking = null)
		{
			...
			foreach (GameObject cybernetic in Cybernetics)
			{
				...
				if (chance.in100() && !ParentObject.IsTemporary && !cybernetic.IsTemporary)
				{
					...
					if (who.IsPlayer())
					{
						IComponent<GameObject>.EmitMessage(who, "{{g|You butcher " + cybernetic.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " from " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ((text == null) ? "" : (" " + text)) + ".}}", ' ', !Automatic);
					}
					else if (IComponent<GameObject>.Visible(who))
					{
						IComponent<GameObject>.EmitMessage(who, who.Does("butcher", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " " + cybernetic.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " from " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ((text == null) ? "" : (" " + text)) + ".", ' ', !Automatic);
					}
					if (flag2)
					{
				...
				{
					IComponent<GameObject>.EmitMessage(who, "{{r|You rip " + cybernetic.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " out of " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ((text == null) ? "" : (" " + text)) + ", but destroy " + cybernetic.them + " in the process.}}", ' ', !Automatic);
				}
				else if (IComponent<GameObject>.Visible(who))
				{
					IComponent<GameObject>.EmitMessage(who, who.Does("rip", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " " + cybernetic.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " out of " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ((text == null) ? "" : (" " + text)) + ", but " + who.GetVerb("destroy", PrependSpace: false) + " " + cybernetic.them + " in the process.", ' ', !Automatic);
				}
			}
			Cybernetics.Clear();
			ParentObject.Bloodsplatter(SelfSplatter: false);
			ParentObject.Destroy();
			who.UseEnergy(1000, "Skill", null, null);
			return true;
		}
