...
namespace XRL.World.Parts
{
	...
	public class CherubimSpawner : IPart
	{
		...
		public override bool HandleEvent(BeforeObjectCreatedEvent E)
		{
			...
			string AFaction = The.Game.RequireGameState(AStateName, delegate
			{
				...
				else
				{
					...
					else
					{
						...
						{
							text2 = enumerable.GetRandomElement();
						}
					}
				}
				if (text2 == null)
				{
					text2 = Factions.GetRandomElement();
				}
				return text2;
			});
			string BStateName = "cherubim:" + Period + "Bfaction";
			string text4 = The.Game.RequireGameState(BStateName, delegate
			{
				string text3 = null;
				if (sultan == null)
				{
				...
				else
				{
					...
					{
						IEnumerable<string> enumerable2 = list2.Where((string f) => Factions.Contains(f) && f != AFaction);
						if (enumerable2 == null)
						{
						...
						{
							text3 = enumerable2.GetRandomElement();
						}
					}
				}
				if (text3 == null)
			...
			string text5 = The.Game.RequireGameState("cherubim:" + Period + "Belement", () => sultan?.GetList("elements")?.Where((string e) => e != AElement)?.GetRandomElement() ?? AElement);
			string text6 = ((Group == "A") ? AFaction : text4);
			string element = ((Group == "A") ? AElement : text5);
			GameObject gameObject = GameObject.Create(text + text6 + " Cherub");
