		...
		public override bool HandleEvent(EnteredCellEvent E)
		{
			if (!Moving && E.Direction != null && ParentObject.IsPlayer() && Array.IndexOf(Directions.DirectionList, E.Direction) != -1)
			{
				...
				try
				{
					...
					{
						if (!ParentObject.Move(text, Forced: false, System: false, IgnoreGravity: false, NoStack: false, AllowDashing: true, DoConfirmations: false, null, null, NearestAvailable: false, null, null, null))
						{
							text = null;
						}
						else
