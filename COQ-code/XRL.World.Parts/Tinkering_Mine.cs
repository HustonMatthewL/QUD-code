	...
	public class Tinkering_Mine : IPart, IDisarmingSifrahHandler
	{
		...
		public override bool HandleEvent(InventoryActionEvent E)
		{
			...
			else if (E.Command == "Detonate")
			{
				...
				E.Actor.UseEnergy(1000, "Item Tinkering " + ((Timer > 0) ? "Bomb" : "Mine") + " Detonate", null, null);
				E.RequestInterfaceExit();
			}
			return base.HandleEvent(E);
		}
		...
		public bool AttemptArm(GameObject Actor)
		{
			...
			Actor.UseEnergy(1000, "Skill Tinkering " + ((Timer > 0) ? "Bomb" : "Mine") + " Arm", null, null);
		...
		public bool AttemptLay(GameObject Actor)
		{
			...
			Actor.UseEnergy(1000, "Skill Tinkering " + ((Timer > 0) ? "Mine Lay" : "Bomb Set"), null, null);
		...
		public bool AttemptDisarm(GameObject Actor, IEvent FromEvent = null, bool Auto = false)
		{
			...
			else
			{
				...
				if (Actor.IsPlayer())
				{
					...
					stringBuilder.Append("Failing to disarm ").Append(ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null)).Append(" will detonate ")
			...
			Actor.UseEnergy(1000, "Skill Tinkering Mine Disarm", null, null);
			return true;
		}
		...
		public void DisarmingResultSuccess(GameObject Actor, GameObject Object, bool Auto)
		{
			if (Actor.IsPlayer())
			{
				IComponent<GameObject>.EmitMessage(Actor, "You disarm " + Object.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", ' ', FromDialog: false, !Auto);
			}
			Disarm();
		}
		...
		public void DisarmingResultPartialSuccess(GameObject Actor, GameObject Object, bool Auto)
		{
			if (Actor.IsPlayer())
			{
				IComponent<GameObject>.EmitMessage(Actor, "You make some progress disarming " + Object.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", ' ', FromDialog: false, !Auto);
			}
		}
		...
		private bool CheckInteraction(GameObject Actor)
		{
			if (ParentObject.InInventory != Actor && ParentObject.Equipped != Actor)
			{
				...
				{
					return Actor.Fail("Your " + (Actor.GetFirstBodyPart("Hands")?.GetOrdinalName() ?? "appendages") + " pass through " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				}
			}
			return true;
		}
