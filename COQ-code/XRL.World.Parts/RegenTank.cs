...
namespace XRL.World.Parts
{
	...
	public class RegenTank : IPoweredPart
	{
		...
		public override bool HandleEvent(GenericNotifyEvent E)
		{
			...
			{
				if (E.Subject != null && GetRejuvenationStatus(E.Subject) == 1 && IsReady(UseCharge: true, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) && (RejuvenationQuery.IsNullOrEmpty() || GenericQueryEvent.Check(E.Subject, RejuvenationQuery, null, ParentObject, RejuvenationRegeneraLevel)))
				{
			...
			else if (E.Notify == LimbRegenerationTriggerNotify && E.Subject != null && GetLimbRegenerationStatus(E.Subject) == 1 && IsReady(UseCharge: true, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) && (LimbRegenerationQuery.IsNullOrEmpty() || GenericQueryEvent.Check(E.Subject, LimbRegenerationQuery, null, ParentObject, LimbRegenerationRegeneraLevel)))
			{
