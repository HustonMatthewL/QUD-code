	...
	public class ForceProjector : IPoweredPart
	{
		...
		public override bool HandleEvent(EndTurnEvent E)
		{
			...
			else
			{
				...
				if (IsDisabled(UseCharge: true, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) && num > 0)
				{
					ShutDownProjections();
				}
			}
		...
		private bool ForceFieldAdvisable()
		{
			...
			return IComponent<GameObject>.CheckRealityDistortionAdvisability(activePartFirstSubject, null, activePartFirstSubject, ParentObject, null, null);
		}
		...
		public bool ForceProjectorActivate(GameObject Actor, IEvent E = null)
		{
			...
			if (!IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) || CC == null)
			{
				Actor.ShowFailure(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " unresponsive.");
				return false;
			}
			...
			try
			{
				...
				if (!IsRealityDistortionBased || ParentObject.FireEvent(Event.New("InitiateRealityDistortionLocal", "Object", ParentObject, "Device", ParentObject, "Operator", Actor), E))
				{
					...
					if (TargetCells != null)
					{
						Actor.UseEnergy(1000, "Equipment", null, null);
						dictionary = null;
		...
		public bool ForceProjectorDeactivate(GameObject Actor, IEvent E = null)
		{
			...
			if (!IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) || cell == null)
			{
				Actor.ShowFailure(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " unresponsive.");
				return false;
			}
