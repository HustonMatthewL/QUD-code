			...
			if (E.Launcher == WeaponSystem && WeaponSystem != null)
			{
				if (E.Cell == TargetCell)
				{
					try
					{
						...
						{
							IComponent<GameObject>.XDidYToZ(WeaponSystem, "intercept", TargetProjectile, ", but " + E.Projectile.does("pass", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " through " + TargetProjectile.them, "!", null, null, ActiveActor, null, UseFullNames: false, IndefiniteSubject: false, IndefiniteObject: false, IndefiniteObjectForOthers: false, PossessiveObject: false, null, null, null, DescribeSubjectDirection: false, DescribeSubjectDirectionLate: false, IComponent<GameObject>.Visible(ActiveActor) || IComponent<GameObject>.Visible(WeaponSystem));
						}
						else if (!PointDefenseInterceptEvent.Check(TargetProjectile, E.Projectile, WeaponSystem))
						{
							IComponent<GameObject>.XDidYToZ(WeaponSystem, "intercept", TargetProjectile, ", but " + E.Projectile.does("fail", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " to affect " + TargetProjectile.them, "!", null, null, ActiveActor, null, UseFullNames: false, IndefiniteSubject: false, IndefiniteObject: false, IndefiniteObjectForOthers: false, PossessiveObject: false, null, null, null, DescribeSubjectDirection: false, DescribeSubjectDirectionLate: false, IComponent<GameObject>.Visible(ActiveActor) || IComponent<GameObject>.Visible(WeaponSystem));
						}
						else
						{
