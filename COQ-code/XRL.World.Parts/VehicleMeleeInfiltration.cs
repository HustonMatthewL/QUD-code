...
namespace XRL.World.Parts
{
	...
	public class VehicleMeleeInfiltration : IPart
	{
		...
		public bool TryInfiltrate(GameObject Actor, Interior Interior)
		{
			...
			if (LastAttempt != Hash)
			{
				if (Popup.ShowYesNo(Event.FinalizeString(Event.NewStringBuilder(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null)).Append(" occupied.\n\n").Append("Attempting to enter is a hostile action and will function as an attack with ")
					.Append(ChancePerPenetration)
					.Append("% infiltration chance per penetration.\n\n")
					.Append("Are you sure you want to proceed?")), "Sounds/UI/ui_notification", AllowEscape: true, DialogResult.No) != 0)
				{
					return false;
				}
				LastAttempt = Hash;
			...
			if (E.Object == ParentObject && !E.Status.HasBit(30) && !Vehicle.PilotID.IsNullOrEmpty())
			{
				...
				else
				{
					if (TryInfiltrate(E.Actor, E.Interior))
					{
						...
						if (E.ShowMessage)
						{
							IComponent<GameObject>.EmitMessage(E.Actor, E.Actor.Does("infiltrate", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " " + E.Object.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + "!", ' ', FromDialog: false, UsePopup: false, AlwaysVisible: false, E.Actor);
						}
					}
					else
					{
