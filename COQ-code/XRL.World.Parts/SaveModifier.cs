...
namespace XRL.World.Parts
{
	...
	public class SaveModifier : IActivePart
	{
		...
		{
			if (IsObjectActivePartSubject(E.Defender) && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) && SavingThrows.Applicable(Vs, E))
			{
				E.Roll += Amount;
			}
			return base.HandleEvent(E);
