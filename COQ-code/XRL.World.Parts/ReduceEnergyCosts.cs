...
namespace XRL.World.Parts
{
	...
	public class ReduceEnergyCosts : IPoweredPart
	{
		...
		{
			if (Applicable(E.Type) && IsObjectActivePartSubject(E.Actor) && IsReady(UsesChargePerEffect, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
