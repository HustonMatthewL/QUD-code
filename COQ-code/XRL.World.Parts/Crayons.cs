	...
	public class Crayons : IPart
	{
		...
		public override bool HandleEvent(InventoryActionEvent E)
		{
			if (E.Command == "DrawWithCrayons")
			{
				...
				string text = Popup.AskString("What do you want to draw?", "", "Sounds/UI/ui_notification", null, null, 64, 0, ReturnNullForEscape: false, EscapeNonMarkupFormatting: true, null);
				...
				if (ParentObject.GetLongProperty("Nanocrayons", 0L) == 1)
				{
					...
					else
					{
						...
						E.Actor.UseEnergy(1000, "Item Crayons", null, null);
