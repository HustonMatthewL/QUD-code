...
namespace XRL.World.Parts
{
	...
	public class GameUnique : IPart
	{
		...
		public void OnCreated(string Context = null)
		{
			...
			if (Context == "Wish" && stringGameState != null && Popup.ShowYesNo(ParentObject.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " (" + ParentObject.Blueprint + ") is considered unique, are you sure you want to create another?", "Sounds/UI/ui_notification", AllowEscape: true, DialogResult.No) == DialogResult.Yes)
			{
