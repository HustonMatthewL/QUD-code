...
namespace XRL.World.Parts
{
	...
	public class SoupSludge : IPart
	{
		...
		public void EvolveSludge()
		{
			if (LiquidID != null)
			{
				string oldName = ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
		...
		public void CatalyzeMessage(string ID, string OldName)
		{
			...
			{
				EmitMessage("The " + LiquidVolume.GetLiquid(ID).GetName() + " catalyzes " + OldName + " into " + ParentObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
			}
		}
		...
		public BodyPart RequireEmptyHand()
		{
			...
			if (bodyPart == null)
			{
				...
				body.AddPartAt(bodyPart, "Pseudopod", 1, null, null, null, null, ManagerID, null, null, null, null, null, null, null, null, null, null, null, null, null);
			}
			return bodyPart;
		}
