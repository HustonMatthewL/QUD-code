...
namespace XRL.World.Parts
{
	...
	public class ActiveLightSource : IActivePart, ILightSource
	{
		...
		public override void TurnTick(long TimeTick, int Amount)
		{
			if (!base.OnWorldMap)
			{
				ConsumeChargeIfOperational(IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, IgnoreWorldMap: false, Amount, null, UseChargeIfUnpowered: false, 0, NeedStatusUpdate: true, null);
			}
		}
		...
		public bool RadiateLight()
		{
			...
			else
			{
				...
				if (IsNight() && cell.ParentZone.IsOutside())
				{
					GameObject equipped2 = ParentObject.Equipped;
					if (equipped2 != null && equipped2.IsPlayer())
					{
