...
namespace XRL.World.Parts
{
	...
	public class WaterRitualRecord : IPart
	{
		...
		public override bool HandleEvent(BeginConversationEvent E)
		{
			...
			{
				Popup.Show("You bothered " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " again.");
