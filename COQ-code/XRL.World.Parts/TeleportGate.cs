...
namespace XRL.World.Parts
{
	...
	public class TeleportGate : IPoweredPart
	{
		...
		public int CheckPossibleSubjects()
		{
			...
			if (cell != null && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				int i = 0;
		...
		{
			if (Object != ParentObject && Object.IsReal && !Object.IsScenery && (Object.IsCreature || Object.IsTakeable()) && Object.PhaseAndFlightMatches(ParentObject) && (ReadyKnown || IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null)))
			{
				GlobalLocation target = GetTarget();
				if (target != null)
				{
					if (target.ResolveCell() != null && IsReady(UseCharge: true, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
					{
