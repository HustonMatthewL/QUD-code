...
namespace XRL.World.Parts
{
	...
	public class ReshephProjectionWidget : IPart
	{
		...
		public void CheckTakeover()
		{
			...
			{
				if (projector.IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: true, 1, null, UseChargeIfUnpowered: false, 0L, null))
				{
					num++;
				}
