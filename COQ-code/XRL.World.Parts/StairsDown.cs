...
namespace XRL.World.Parts
{
	...
	public class StairsDown : IPart
	{
		...
		{
			if (PullDown && !E.Forced && !E.System && IsValidForPullDown(E.Object) && E.Object.IsPlayer() && !E.Object.IsConfused && !((IsLongFall() ? JumpPrompt : null) ?? E.Cell.ParentZone.GetZoneProperty("PullDownPrompt")).IsNullOrEmpty() && Popup.WarnYesNoCancel(JumpPrompt) != 0)
			{
				return false;
			}
			return base.HandleEvent(E);
		...
		public override bool HandleEvent(CommandSmartUseEvent E)
		{
			if (E.Actor.CurrentCell == ParentObject.CurrentCell)
			{
				...
				else
				{
					...
					{
						E.Actor.Move("D", Forced: false, Levels > 1, IgnoreGravity: false, NoStack: false, AllowDashing: false, DoConfirmations: true, null, null, NearestAvailable: false, null, null, null);
					}
				}
			}
			return false;
			...
			if (ParentObject.HasTagOrProperty("IdleStairs") && E.Actor.HasPart<Brain>() && Stat.Random(1, 2000) == 2000)
			{
				...
				who.Brain.PushGoal(new DelegateGoal(delegate(GoalHandler h)
				{
					if (who.CurrentCell == ParentObject.CurrentCell)
					{
						for (int i = 0; i < Levels; i++)
						{
							who.Move("D", Forced: false, Levels > 1, IgnoreGravity: false, NoStack: false, AllowDashing: false, DoConfirmations: true, null, null, NearestAvailable: false, null, null, null);
						}
					}
					h.FailToParent();
				}));
		...
		public override bool FireEvent(Event E)
		{
			if (E.ID == "ClimbDown")
			{
				...
				if (!PullDown || gameObjectParameter.IsFlying)
				{
					...
					for (int i = 0; i < Levels; i++)
					{
						flag |= gameObjectParameter.Move("D", Forced: false, Levels > 1, IgnoreGravity: false, NoStack: false, AllowDashing: false, DoConfirmations: true, null, null, NearestAvailable: false, null, null, null);
					}
					if (flag)
					{
		...
		public bool CheckPullDown(GameObject Object)
		{
			try
			{
				...
				{
					Popup.Show("Your companion, " + Object.GetDisplayName(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, ColorOnly: false, Visible: true, WithoutTitles: false, ForSort: false, Short: true, BaseOnly: false, WithIndefiniteArticle: true, WithDefiniteArticle: false, null, IndicateHidden: false, Capitalize: false, SecondPerson: false, Reflexive: false, null) + "," + Object.GetVerb("have") + " fallen " + text + " " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " " + The.Player.DescribeDirectionToward(ParentObject) + "!");
				}
				else
				{
				...
				if (list != null)
				{
					...
					for (int count2 = list.Count; j < count2; j++)
					{
						list[j].TakeDamage(Stat.Random(1, 4), Owner: Object, Message: "from " + Object.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " falling on " + list[j].them + ".", Attributes: "Crushing", DeathReason: Object.An(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " fell on " + list[j].them + ".", ThirdPersonDeathReason: Object.An(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " fell on " + list[j].them + ".", Attacker: null, Source: null, Perspective: null, DescribeAsFrom: null, Accidental: true);
				...
				if (Distance > 1)
				{
					InflictFallDamage(Object, Distance, GenericFall ? null : ("You fell down " + ParentObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + "."), GenericFall ? null : (Object.It + " @@fell down " + ParentObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + "."));
				}
				...
				if (Object?.CurrentCell?.IsSolid() == true)
				{
					...
					if (cell2 != null)
					{
						Object.SystemMoveTo(cell2, null);
					}
				}
			}
			catch (Exception x)
