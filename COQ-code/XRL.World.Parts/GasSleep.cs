...
namespace XRL.World.Parts
{
	...
	public class GasSleep : IGasBehavior
	{
		...
		public bool ApplySleep(GameObject Object)
		{
			...
			int @for = GetRespiratoryAgentPerformanceEvent.GetFor(Object, ParentObject, part, null, 0, 0, WillAllowSave: true);
			if (@for > 0 && !Object.MakeSave("Toughness", 5 + part.Level + @for / 10, null, null, "Sleep Inhaled Gas", IgnoreNaturals: false, IgnoreNatural1: false, IgnoreNatural20: false, IgnoreGodmode: false, ParentObject))
			{
