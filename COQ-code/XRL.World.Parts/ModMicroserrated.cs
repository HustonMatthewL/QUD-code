...
namespace XRL.World.Parts
{
	...
	public class ModMicroserrated : IModification
	{
		...
		{
			int @for = GetSpecialEffectChanceEvent.GetFor(ParentObject.Equipped ?? ParentObject.Implantee, ParentObject, "Modification ModMicroserrated Dismember", Chance);
			return "Microserrated: This weapon has " + Grammar.A(@for) + "% chance to dismember opponents.";
		}
	}
}
