...
namespace XRL.World.Parts
{
	...
	public class PowerSwitch : IPoweredPart, IHackingSifrahHandler
	{
		...
		{
			if (Flippable && (FlippableWithoutUnderstanding || ParentObject.Understood()) && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				if (Active)
				{
		...
		public override bool FireEvent(Event E)
		{
			...
			{
				if ((!CanActivate || !IsReady(UseCharge: true, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null)) && !E.HasFlag("Forced"))
				{
			...
			{
				if ((!CanDeactivate || !IsReady(UseCharge: true, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null)) && !E.HasFlag("Forced"))
				{
		...
		public void HackingResultPartialSuccess(GameObject Actor, GameObject obj, HackingSifrah game)
		{
			...
			{
				Popup.Show("You feel like you're making progress on hacking " + obj.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
			}
		}
		...
		public void SyncActivatedAbilityNameAndIcon(GameObject Actor = null)
		{
			if (!(ActivatedAbilityID == Guid.Empty))
			{
				...
				RenderEvent source = ParentObject.RenderForUI(AsIfKnown: true);
		...
		public void TryPowerSwitchOn(GameObject Actor, IEvent FromEvent = null)
		{
			...
			ParentObject.PlayWorldOrUISound("Sounds/Interact/sfx_interact_powerSwitch_on", null);
			...
			if (EnergyCost > 0)
			{
				Actor.UseEnergy(1000, "Item Activate", null, null);
				SyncActivatedAbilityNameAndIcon();
				FromEvent?.RequestInterfaceExit();
			}
		}
		...
		public void TryPowerSwitchOff(GameObject Actor, IEvent FromEvent = null)
		{
			...
			ParentObject.PlayWorldOrUISound("Sounds/Interact/sfx_interact_powerSwitch_off", null);
			...
			if (EnergyCost > 0)
			{
				Actor.UseEnergy(1000, "Item Deactivate", null, null);
				SyncActivatedAbilityNameAndIcon();
				FromEvent?.RequestInterfaceExit();
			}
		}
