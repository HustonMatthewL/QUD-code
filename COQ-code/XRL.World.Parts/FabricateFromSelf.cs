...
namespace XRL.World.Parts
{
	...
	public class FabricateFromSelf : IPoweredPart
	{
		...
		{
			if (Continuous && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
		...
		{
			if (AIUsePassively && IsMyActivatedAbilityAIUsable(ActivatedAbilityID) && (AIHitpointsThreshold <= 0 || E.Actor.Stat("Hitpoints") >= AIHitpointsThreshold) && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
		...
		{
			if (AIUseDefensively && IsMyActivatedAbilityAIUsable(ActivatedAbilityID) && (AIHitpointsThreshold <= 0 || E.Actor.Stat("Hitpoints") >= AIHitpointsThreshold) && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				E.Add("ActivateFabricateFromSelf");
			}
			return base.HandleEvent(E);
		...
		{
			if ((AIUseOffensively || AIUseForAmmo || AIUseForThrowing) && IsMyActivatedAbilityAIUsable(ActivatedAbilityID) && (AIHitpointsThreshold <= 0 || E.Actor.Stat("Hitpoints") >= AIHitpointsThreshold) && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				bool flag = false;
		...
		private bool Activate(bool Automatic = false)
		{
			...
			if (Visible())
			{
				IComponent<GameObject>.AddPlayerMessage(ParentObject.Does(FabricateVerb, int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " " + ((num == 1) ? gameObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) : (Grammar.Cardinal(num) + " " + Sample.GetPluralName())) + " from " + (FabricateAlternateSource.IsNullOrEmpty() ? ("the substance of " + ParentObject.its + " body") : FabricateAlternateSource) + ".");
			}
			...
			if (EnergyCost > 0)
			{
				ParentObject.UseEnergy(EnergyCost, "Physical Ability Fabricate", null, null);
			}
