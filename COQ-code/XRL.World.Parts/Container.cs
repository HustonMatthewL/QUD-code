	...
	public class Container : IPart
	{
		...
		public void AttemptOpen(GameObject Actor, IEvent ParentEvent = null)
		{
			...
			if (ParentObject.IsCreature)
			{
				...
				{
					Popup.ShowFail("You cannot trade with " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				}
				return;
			}
			...
			else
			{
				...
				string title = "{{W|" + ((Preposition == "in") ? "Opening" : "Examining") + " " + ParentObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + "}}";
