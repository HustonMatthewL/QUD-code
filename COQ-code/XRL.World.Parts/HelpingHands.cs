...
namespace XRL.World.Parts
{
	...
	public class HelpingHands : IPart
	{
		...
		public void AddArms(GameObject Subject = null)
		{
			...
			if (Subject != null)
			{
				...
				if (body != null)
				{
					...
					bodyPart.AddPart("Robo-Hand", 2, null, "Robo-Hands", null, null, Extrinsic: true, Manager: ManagerID, Category: null, RequiresLaterality: null, Mobility: null, Appendage: null, Integral: null, Mortal: null, Abstract: null, Dynamic: null, Plural: null, Mass: null, Contact: null, IgnorePosition: null);
					body2.AddPartAt(bodyPart, "Robo-Arm", 1, null, null, null, null, Extrinsic: true, Manager: ManagerID, Category: null, RequiresLaterality: null, Mobility: null, Appendage: null, Integral: null, Mortal: null, Abstract: null, Dynamic: null, Plural: null, Mass: null, Contact: null, IgnorePosition: null).AddPart("Robo-Hand", 1, null, "Robo-Hands", null, null, Extrinsic: true, Manager: ManagerID, Category: null, RequiresLaterality: null, Mobility: null, Appendage: null, Integral: null, Mortal: null, Abstract: null, Dynamic: null, Plural: null, Mass: null, Contact: null, IgnorePosition: null);
					extrinsic = true;
		...
		private bool ExamineFailure(IExamineEvent E, int Chance)
		{
			...
			{
				EmitMessage("Two tubular sections of " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " flail around and batter " + (E.Actor.IsPlayer() ? "you" : E.Actor.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null)) + "!", ' ', FromDialog: false, E.Actor.IsPlayer());
