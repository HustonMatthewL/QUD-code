	...
	public class ArmsOnEquip : IPart
	{
		...
		public void AddArms(GameObject Subject = null)
		{
			...
			for (int i = 0; i < Pairs; i++)
			{
				...
				BodyPart bodyPart2 = bodyPart.AddPartAt(@base, laterality, null, null, null, null, managerID, category, null, null, null, null, null, null, extrinsic, null, null, null, null, null, "Arm", orInsertBefore);
				BodyPartType base2 = HandType;
				int laterality2 = 2 | num;
				extrinsic = Extrinsic;
				string managerID2 = ManagerID;
				string supportsDependent = text;
				bodyPart2.AddPart(base2, laterality2, DefaultHandBehavior, supportsDependent, null, null, managerID2, category, null, null, null, null, null, null, extrinsic, null, null, null, null, null);
				BodyPartType bodyPartType = ArmType;
				BodyPart obj = bodyPart.AddPartAt(bodyPart2, bodyPartType, 1 | num, null, null, null, null, Extrinsic: Extrinsic, Manager: ManagerID, Category: category, RequiresLaterality: null, Mobility: null, Appendage: null, Integral: null, Mortal: null, Abstract: null, Dynamic: null, Plural: null, Mass: null, Contact: null, IgnorePosition: null);
				BodyPartType base4 = HandType;
				int laterality4 = 1 | num;
				extrinsic = Extrinsic;
				supportsDependent = ManagerID;
				managerID2 = text;
				obj.AddPart(base4, laterality4, DefaultHandBehavior, managerID2, null, null, supportsDependent, category, null, null, null, null, null, null, extrinsic, null, null, null, null, null);
				BodyPartType base5 = HandsType;
				extrinsic = Extrinsic;
				string managerID3 = ManagerID;
				orInsertBefore = new string[3] { "Feet", "Roots", "Thrown Weapon" };
				bodyPart.AddPartAt(base5, 0, null, null, text, null, managerID3, category, null, null, null, null, null, null, extrinsic, null, null, null, null, null, "Hands", orInsertBefore);
				if (num != 0)
				{
					num <<= 1;
				}
