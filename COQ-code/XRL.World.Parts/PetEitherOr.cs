	...
	public class PetEitherOr : IPart
	{
		...
		public void explode()
		{
			...
			if (type == 3 && testChirality())
			{
				...
				IComponent<GameObject>.AddPlayerMessage(ParentObject.Does("crumble", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " into beetles.");
				boom();
			}
			...
			if (type == 5 && testChirality())
			{
				...
				if (connectedSpawnLocation != null)
				{
					...
					aCreature.SetActive();
					IComponent<GameObject>.AddPlayerMessage(ParentObject.Does("atomize", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " and" + ParentObject.GetVerb("recombine") + " into " + aCreature.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				}
				boom();
			}
