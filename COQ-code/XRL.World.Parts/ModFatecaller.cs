...
namespace XRL.World.Parts
{
	...
	public class ModFatecaller : IModification
	{
		...
		public override bool HandleEvent(GetShortDescriptionEvent E)
		{
			...
			{
				int @for = GetSpecialEffectChanceEvent.GetFor(ParentObject.Equipped ?? ParentObject.Implantee, ParentObject, "Modification ModFatecaller Activation", Chance);
				E.Postfix.AppendRules(@for + "% of the time, the Fates have their way.");
			}
