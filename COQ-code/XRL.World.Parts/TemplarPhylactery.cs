...
namespace XRL.World.Parts
{
	...
	public class TemplarPhylactery : IPoweredPart, IHackingSifrahHandler
	{
		...
		{
			if (wraith == null && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) && WantsToUse(E.Actor) && GameObject.Validate(E.Target) && E.Target.Brain != null && !E.Target.HasPart<MentalShield>())
			{
		...
		{
			if (wraith != null && IsHacked() && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) && wraith.IsHostileTowards(E.Actor) && E.Actor.Stat("Intelligence") >= 7)
			{
		...
		{
			if (E.Object == wraith && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) && wraith.InSameZone(E.Object))
			{
				return false;
			}
			return base.HandleEvent(E);
		...
		public override bool HandleEvent(GetShortDescriptionEvent E)
		{
			if (IsHacked())
			{
				E.Infix.Compound(ParentObject.Does("have", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: true, SecondPerson: true, null) + " been hacked.");
			}
			return base.HandleEvent(E);
		}
		...
		public override bool HandleEvent(InventoryActionEvent E)
		{
			if (E.Command == ACTIVATE_COMMAND_NAME)
			{
				...
				{
					return E.Actor.Fail(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " unresponsive.");
				}
				Spawn();
			...
			{
				if (!IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: true, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
				{
					return E.Actor.Fail(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " " + GetStatusPhrase() + ".");
				}
				...
				E.Actor.UseEnergy(1000, "Sifrah Hack TemplarPhylactery", null, null);
		...
		public void Spawn()
		{
			...
			if (cell != null)
			{
				...
				wraith.MakeActive();
				equipped.PlayWorldOrUISound("Sounds/Interact/sfx_interact_phylactery_on", null);
		...
		public void HackingResultSuccess(GameObject who, GameObject obj, HackingSifrah game)
		{
			...
			if (ParentObject.GetIntProperty("SifrahTemplarPhylacteryHack", 1) > 0)
			{
				...
				if (who.IsPlayer())
				{
					Popup.Show("You hack " + obj.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				}
			}
			else if (who.IsPlayer())
			{
				Popup.Show("You feel like you're making progress on hacking " + obj.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
			}
		}
		...
		public void HackingResultExceptionalSuccess(GameObject who, GameObject obj, HackingSifrah game)
		{
			if (obj == ParentObject)
			{
				...
				if (who.IsPlayer())
				{
					Popup.Show("You hack " + obj.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", and find a way to reduce " + obj.its + " power consumption in the process!");
				}
			}
		}
		...
		public void HackingResultFailure(GameObject who, GameObject obj, HackingSifrah game)
		{
			if (obj == ParentObject)
			{
				...
				if (who.IsPlayer())
				{
					Popup.Show("You cannot seem to work out how to hack " + obj.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				}
			}
		}
		...
		public void HackingResultCriticalFailure(GameObject who, GameObject obj, HackingSifrah game)
		{
			...
			if (who.IsPlayer())
			{
				Popup.Show("Your attempt to hack " + obj.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " has gone very wrong.");
			}
			List<Cell> localAdjacentCells = ParentObject.CurrentCell.GetLocalAdjacentCells();
			Cell cell = who.CurrentCell;
			ParentObject.UseCharge(Stat.Random(5000, 15000), LiveOnly: false, 0L, IncludeTransient: true, IncludeBiological: true, null);
