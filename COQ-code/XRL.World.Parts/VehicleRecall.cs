	...
	public class VehicleRecall : IPoweredPart
	{
		...
		public override bool HandleEvent(InventoryActionEvent E)
		{
			if (E.Command == "RecallVehicle")
			{
				...
				if (!cell.IsPassable())
				{
					return E.Actor.ShowFailure(activePartFirstSubject.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " is obstructed.");
				}
				...
				if (ConsumeCharge(null, null) && gameObject.TeleportTo(cell, 0, ignoreCombat: true, ignoreGravity: false, forced: false, UsePopups: false, "disappear", null))
				{
