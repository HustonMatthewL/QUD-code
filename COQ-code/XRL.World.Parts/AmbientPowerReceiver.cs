...
namespace XRL.World.Parts
{
	...
	public class AmbientPowerReceiver : IPoweredPart
	{
		...
		{
			if (!E.Cell.ParentZone.IsWorldMap() && IsReady(UseCharge: false, IgnoreCharge: true, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				...
				else if (this.ChargeRate > 0)
				{
					...
					{
						if (Popup.ShowYesNo("You are leaving the ambient broadcast power grid and transitioning to backup power. Are you sure?", "Sounds/UI/ui_notification", AllowEscape: true, DialogResult.No) != 0)
						{
							return false;
						}
					}
		...
		public void ReceiveCharge(int Turns = 1)
		{
			...
			if (ChargeRate > 0 && IsReady(UseCharge: true, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, Turns, null, UseChargeIfUnpowered: false, 0L, null))
			{
