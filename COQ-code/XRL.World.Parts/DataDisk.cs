	...
	public class DataDisk : IPart
	{
		...
		public override bool HandleEvent(InventoryActionEvent E)
		{
			if (E.Command == "LearnFromDataDisk")
			{
				...
				{
					E.Actor.PlayWorldOrUISound("Sounds/Interact/sfx_interact_dataDisk_learn", null);
					if (Data.Type == "Mod")
					{
				...
				if (!(Data.Type != "Build"))
				{
					...
					else
					{
						...
						else
						{
							...
							{
								@object = GameObject.Create(Data.Blueprint);
								TinkeringHelpers.ProcessTinkeredItem(@object, E.Actor);
							...
							{
								DidXToY("tinker", "up", @object, null, "!", null, null, null, null, UseFullNames: false, IndefiniteSubject: false, IndefiniteObject: true, IndefiniteObjectForOthers: false, PossessiveObject: false, null, null, null, DescribeSubjectDirection: false, DescribeSubjectDirectionLate: false, AlwaysVisible: false, FromDialog: true);
							}
							E.Actor.UseEnergy(1000, "Skill Tinkering Data Disk Build", null, null);
							if (flag)
							{
