			...
			if (((!ParentObject.IsTemporary && OnSuccessAmount.RollCached() != 0) ? 1 : 0) > (false ? 1 : 0))
			{
				...
				else
				{
					...
					else if (who.IsPlayer())
					{
						if (num <= 1)
						{
							IComponent<GameObject>.EmitMessage(who, "You harvest " + gameObject2.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ((text == null) ? "" : (" from " + text)) + ".", ' ', !Automatic);
						}
						else if (gameObject2.IsPlural)
						{
					...
					else if (who.IsVisible())
					{
						if (num <= 1)
						{
							IComponent<GameObject>.EmitMessage(who, who.Does("harvest", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " " + gameObject2.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ((text == null) ? "" : (" from " + text)) + ".", ' ', !Automatic);
						}
						else if (gameObject2.IsPlural)
						{
							IComponent<GameObject>.EmitMessage(who, who.Does("harvest", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " " + Grammar.Cardinal(num) + " " + gameObject2.ShortDisplayName + ((text == null) ? "" : (" from " + text)) + ".", ' ', !Automatic);
						}
						else
						{
							IComponent<GameObject>.EmitMessage(who, who.Does("harvest", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " " + Grammar.Cardinal(num) + " " + Grammar.Pluralize(gameObject2.ShortDisplayName) + ((text == null) ? "" : (" from " + text)) + ".", ' ', !Automatic);
						}
					}
					for (int i = 0; i < num; i++)
					{
