...
namespace XRL.World.Parts
{
	...
	public class GasDisease : IGasBehavior
	{
		...
		public void ApplyDisease(GameObject GO)
		{
			...
			if (@for > 0 && !GO.MakeSave("Toughness", 5 + part.Level + @for / 10, null, null, "Disease Inhaled Gas", IgnoreNaturals: false, IgnoreNatural1: false, IgnoreNatural20: false, IgnoreGodmode: false, ParentObject))
			{
				bool flag = false;
