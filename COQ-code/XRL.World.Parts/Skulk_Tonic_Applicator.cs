	...
	public class Skulk_Tonic_Applicator : IPart
	{
		...
		public override bool FireEvent(Event E)
		{
			if (E.ID == "ApplyTonic")
			{
				...
				int @for = GetTonicDurationEvent.GetFor(ParentObject, gameObjectParameter, gameObjectParameter2, "Skulk", 1000 * intParameter + Stat.Random(intParameter, 200 * intParameter), intParameter);
				gameObjectParameter2.ApplyEffect(new Skulk_Tonic(@for));
			}
