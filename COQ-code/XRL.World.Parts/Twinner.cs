...
namespace XRL.World.Parts
{
	...
	public class Twinner : IPart
	{
		...
		{
			if (Twin?.CurrentCell != null || !CheckMyRealityDistortionAdvisability(null, null, null, null, null, null))
			{
				return;
			}
		...
		public virtual bool IsRealityStabilized(Cell Cell)
		{
			...
			return !IComponent<GameObject>.CheckRealityDistortionAdvisability(null, Cell, parentObject, null, this, null);
		}
		...
		public virtual void EnteredCell()
		{
			if (Twin?.CurrentCell != null && ParentObject.CurrentCell.ParentZone != Twin.CurrentCell.ParentZone)
			{
				...
				Twin.SystemLongDistanceMoveTo(targetCell, null);
