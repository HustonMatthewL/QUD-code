...
namespace XRL.World.Parts
{
	...
	public class HiddenRender : IPart
	{
		...
		public new void Reveal()
		{
			...
			IComponent<GameObject>.AddPlayerMessage(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: true, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " revealed " + The.Player.DescribeDirectionToward(ParentObject) + "!");
