...
namespace XRL.World.Parts
{
	...
	public class FreePower : IPoweredPart
	{
		...
		{
			if (E.Pass == 1 && (!E.LiveOnly || ConsiderLive) && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				int num = ChargeUse * E.Multiple;
				int num2 = Math.Min(E.Amount, ChargeFulfilled - num);
				if (num2 > 0)
