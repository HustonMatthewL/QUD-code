	...
	public class EaterUrn : IPart
	{
		...
		public void GenerateUrn()
		{
			...
			if (MemorializedName.IsNullOrEmpty())
			{
				...
				{
					MemorializedName = NameMaker.MakeName(null, null, null, null, null, Faction, null, null, null, null, null, null, null, FailureOkay: false, SpecialFaildown: false, null, null);
				}
				else
				{
