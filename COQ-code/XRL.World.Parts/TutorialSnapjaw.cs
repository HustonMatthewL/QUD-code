...
namespace XRL.World.Parts
{
	...
	public class TutorialSnapjaw : IPart
	{
		...
		public override bool HandleEvent(BeforeAITakingActionEvent E)
		{
			...
			{
				ParentObject.Move("S", Forced: false, System: false, IgnoreGravity: false, NoStack: false, AllowDashing: true, DoConfirmations: true, null, null, NearestAvailable: false, null, null, null);
