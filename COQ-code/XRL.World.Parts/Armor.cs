		...
		public override bool HandleEvent(GetDisplayNameEvent E)
		{
			if (E.Understood() && (!ParentObject.HasPropertyOrTag("DisplayArmorStatsOnlyWhenEquipped") || ParentObject.Equipped != null))
			{
				...
				else
				{
					...
					int @for = GetDisplayStatBonusEvent.GetFor(ParentObject, this, "AV", AV);
					...
					int for2 = GetDisplayStatBonusEvent.GetFor(ParentObject, this, "DV", DV);
					stringBuilder.Append(for2);
					if (DVAveraged)
					{
						stringBuilder.Append("}}");
					}
