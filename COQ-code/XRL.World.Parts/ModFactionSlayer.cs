...
namespace XRL.World.Parts
{
	...
	public class ModFactionSlayer : IModification
	{
		...
		{
			int @for = GetSpecialEffectChanceEvent.GetFor(ParentObject.Equipped ?? ParentObject.Implantee, ParentObject, "Modification ModFactionSlayer Decapitate", Tier);
			E.Postfix.AppendRules(@for + "% chance to behead " + XRL.World.Faction.GetFormattedName(Faction) + " on hit.");
