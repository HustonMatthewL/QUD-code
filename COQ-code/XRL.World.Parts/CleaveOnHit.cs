	...
	public class CleaveOnHit : IPart
	{
		...
		public override bool FireEvent(Event E)
		{
			if (E.ID == "WeaponHit")
			{
				...
				Axe_Cleave.PerformCleave(E.GetGameObjectParameter("Attacker"), E.GetGameObjectParameter("Defender"), ParentObject, null, Chance: (!CriticalOnly && flag) ? 100 : Chance, Properties: E.GetStringParameter("Properties"), AdjustAVPenalty: 0, MaxAVPenalty: null);
			}
			return base.FireEvent(E);
		}
	}
