...
namespace XRL.World.Parts
{
	...
	public class Enclosing : IPoweredPart
	{
		...
		public bool AnyEnterDamage()
		{
			...
			if (NoDamageWhenDisabled && IsDisabled(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				return false;
			}
			return true;
		...
		public bool EnterEnclosure(GameObject who, IEvent E = null)
		{
			...
			{
				who.ShowFailure("You are too large to enter " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				return false;
			}
			if (ParentObject.HasTagOrProperty("Sealed"))
			{
				who.ShowFailure(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " sealed.");
				return false;
			}
			if (who.HasEffect((Enclosed FX) => FX.EnclosedBy == ParentObject))
			{
				if (who.IsPlayer())
				{
					Popup.ShowFail("You are already in " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				}
				return false;
			}
			...
			if (EnterSaveTarget > 0 && !who.MakeSave(EnterSaveStat, EnterSaveTarget, null, null, "Enclosure Entry Access", IgnoreNaturals: false, IgnoreNatural1: false, IgnoreNatural20: false, IgnoreGodmode: false, ParentObject))
			{
				if (who.IsPlayer())
				{
					Popup.Show("You fail to get " + who.itself + " into " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				}
				else if (IComponent<GameObject>.Visible(who))
				{
					IComponent<GameObject>.AddPlayerMessage(who.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + who.GetVerb("try") + " to get " + ParentObject.itself + " into " + ParentObject.the + ParentObject.DisplayNameOnly + ", but" + who.GetVerb("fail") + ".");
				}
				CheckEnterDamage(who, Failed: true);
				who.UseEnergy(1000, "Position", null, null);
				E?.RequestInterfaceExit();
				return false;
			}
		...
		public bool ExitEnclosure(GameObject who, IEvent E = null, Enclosed enc = null)
		{
			...
			if (enc.EnclosedBy != ParentObject)
			{
				if (who.IsPlayer())
				{
					Popup.Show("It is not " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " that you are enclosed by.");
				}
				return false;
			}
			if (ExitSaveTarget > 0)
			{
				...
				if ((@event == null || !@event.HasParameter("Teleporting")) && !who.MakeSave(ExitSaveStat, ExitSaveTarget, null, null, "Enclosure Exit Restraint", IgnoreNaturals: false, IgnoreNatural1: false, IgnoreNatural20: false, IgnoreGodmode: false, ParentObject))
				{
					...
					{
						IComponent<GameObject>.AddPlayerMessage(who.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + who.GetVerb("try") + " to extricate " + ParentObject.itself + " from " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", but" + who.GetVerb("fail") + "!");
					}
			...
			if (who.IsPlayer())
			{
				Popup.Show("You extricate " + who.itself + " from " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
			}
			else if (IComponent<GameObject>.Visible(who))
			{
				IComponent<GameObject>.AddPlayerMessage(who.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + who.GetVerb("extricate") + " " + ParentObject.itself + " from " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
			}
		...
		public bool EnclosureExitImpeded(GameObject who, bool ShowMessage = false, Enclosed Effect = null)
		{
			if (ExitSaveTarget > 0 || AnyExitDamage())
			{
				...
				{
					Popup.ShowFail("You cannot do that while enclosed by " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				}
				return true;
			}
			return false;
		...
		{
			bool flag = IsDisabled(UseCharge: true, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null);
