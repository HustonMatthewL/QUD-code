...
namespace XRL.World.Parts
{
	...
	public class MechanimistLibrarian : IPart
	{
		...
		public override bool HandleEvent(EnteredCellEvent E)
		{
			try
			{
				ParentObject.GiveProperName("Sheba Hagadias", Force: true, null, SpecialFaildown: false, null, null);
				...
				ForceEmitter part = ParentObject.GetPart<ForceEmitter>();
				if (part != null)
				{
					part.StartActive = false;
				}
