...
namespace XRL.World.Parts
{
	...
	public class TattooGun : IPoweredPart
	{
		...
		public override bool HandleEvent(InventoryActionEvent E)
		{
			...
			{
				E.Actor.UseEnergy(10000, "Item TattooGun", null, null);
		...
		public bool AttemptTattoo(GameObject Actor)
		{
			...
			if (activePartStatus != 0)
			{
				...
				case ActivePartStatus.ProcessInputMissing:
					Actor.Fail(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " out of {{|" + LiquidVolume.GetLiquid(ConsumesLiquid).GetName() + "}}.");
					break;
				case ActivePartStatus.ProcessInputInvalid:
					Actor.Fail(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " filled with contaminated {{|" + LiquidVolume.GetLiquid(ConsumesLiquid).GetName() + "}}!");
					break;
				case ActivePartStatus.Unpowered:
					Actor.Fail(ParentObject.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " merely" + ParentObject.GetVerb("click") + ".");
					break;
				default:
					Actor.Fail(ParentObject.Does("aren't", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " working!");
					break;
				}
				return false;
			}
			...
			if (body == null)
			{
				Actor.Fail("You cannot tattoo " + ((firstObjectWithPart == Actor) ? Actor.itself : firstObjectWithPart.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null)) + ".");
				return false;
			}
			...
			if (applyResult != 0)
			{
				...
				case Tattoos.ApplyResult.TooManyTattoos:
					Actor.Fail("There are too many tattoos on " + ((firstObjectWithPart == Actor) ? "your" : Grammar.MakePossessive(firstObjectWithPart.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null))) + " " + bodyPart.GetOrdinalName() + " to add more.");
					break;
				case Tattoos.ApplyResult.AbstractBodyPart:
				case Tattoos.ApplyResult.NonContactBodyPart:
					Actor.Fail("You can't tattoo " + ((firstObjectWithPart == Actor) ? "your" : Grammar.MakePossessive(firstObjectWithPart.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null))) + " " + bodyPart.GetOrdinalName() + ".");
					break;
				case Tattoos.ApplyResult.InappropriateBodyPart:
					Actor.Fail(((firstObjectWithPart == Actor) ? "Your" : Grammar.MakePossessive(firstObjectWithPart.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null))) + " " + bodyPart.GetOrdinalName() + " can't be tattooed because " + (bodyPart.Plural ? "they don't" : "it doesn't") + " have flesh.");
					break;
				default:
					Actor.Fail("You can't tattoo " + ((firstObjectWithPart == Actor) ? "your" : Grammar.MakePossessive(firstObjectWithPart.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null))) + " " + bodyPart.GetOrdinalName() + ".");
					break;
			...
			string text = Popup.AskString("Describe your tattoo. For example: \"a tiny snail\".", "", "Sounds/UI/ui_notification", "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 -+/#()!@$%*<>", null, 30, 0, ReturnNullForEscape: false, EscapeNonMarkupFormatting: true, null);
			...
			Actor.PlayWorldOrUISound("Sounds/Interact/sfx_interact_tattoo", null);
