...
namespace XRL.World.Parts
{
	...
	public class Corpse : IPart
	{
		...
		private void ProcessCorpseDrop(BeforeDeathRemovalEvent E)
		{
			...
			{
				string text = NameMaker.MakeName(ParentObject, null, null, null, null, null, null, null, null, null, null, null, null, FailureOkay: true, SpecialFaildown: false, null, null);
				if (text != null)
				{
