	...
	public class Examiner : IPart
	{
		...
		public override bool HandleEvent(InventoryActionEvent E)
		{
			if (E.Command == "Examine")
			{
				...
				E.Actor.UseEnergy(1000, "Examine", null, null);
			}
			return base.HandleEvent(E);
		}
		...
		public bool MakeUnderstood(bool ShowMessage = false)
		{
			...
			string priorDesc = (ShowMessage ? ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) : null);
			ParentObject.Seen();
		...
		public bool MakeUnderstood(out string Message)
		{
			...
			string priorDesc = ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
			ParentObject.Seen();
			Understanding = Complexity;
			CheckEpistemicStatus();
		...
		{
			string text = ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
			if (text == PriorDesc)
			{
				return "You commit the distinguishing characteristics of " + text + " to memory.";
			}
			return "You identify " + PriorDesc + " as " + ParentObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".";
		}
		...
		public void ResultSuccess(GameObject Actor)
		{
			...
			if (Actor.IsPlayer())
			{
				Popup.Show("You now understand " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: false, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", null, "sfx_artifact_examination_success_total");
			}
		...
		public void ResultPartialSuccess(GameObject Actor, int newLevel = -1)
		{
			...
			bool flag = false;
			string text = ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
			string text2 = ParentObject.Does("seem", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: true, SecondPerson: true, null);
			if (newLevel < Complexity && newLevel >= blueprintComplexity && Understanding < blueprintComplexity)
			{
				...
				if (gameObject.TryGetPart<Examiner>(out var Part) && Part.Complexity > 0 && newLevel >= Part.Complexity && !gameObject.DisplayNameOnlyDirect.StartsWith("[") && !gameObject.HasTag("BaseObject"))
				{
					...
					if (Actor.IsPlayer())
					{
						string text3 = ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
						string displayName = gameObject.GetDisplayName(int.MaxValue, null, null, AsIfKnown: true, Single: false, NoConfusion: false, NoColor: false, Stripped: false, ColorOnly: false, Visible: true, WithoutTitles: false, ForSort: false, Short: false, BaseOnly: true, WithIndefiniteArticle: false, WithDefiniteArticle: false, null, IndicateHidden: false, Capitalize: false, SecondPerson: false, Reflexive: false, null);
						string text4 = gameObject.GetxTag("Grammar", "adjunctNoun");
						if (text4.IsNullOrEmpty())
						{
							text4 = (gameObject.IsPlural ? "set" : "one");
						}
						string message = ((!(text3 != text)) ? ("You make some progress understanding " + text + ". You think " + ParentObject.itis + " probably a variety of " + displayName + ", and you believe you would be able to recognize an ordinary " + text4 + " of " + ((gameObject.a == "some ") ? "that" : "those") + " now.") : ("You make some progress understanding " + text + ". " + text2 + " to be " + ParentObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", and you think " + ParentObject.itis + " probably a variety of " + displayName + "; you believe you would be able to recognize an ordinary " + text4 + " of " + ((gameObject.a == "some ") ? "that" : "those") + " now."));
			...
			if (!flag)
			{
				...
				if (Actor.IsPlayer())
				{
					string text5 = ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
					string message2 = ((Understanding >= Complexity && text != text5) ? GetIdentifyMessage(text) : ((!(text != text5)) ? ("You make some progress understanding " + text5 + ".") : ("You make some progress understanding " + text + ". " + text2 + " to be " + ParentObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".")));
		...
		public void ResultFailure(GameObject Actor)
		{
			if (ExamineFailureEvent.Check(Actor, ParentObject))
			{
				if (Actor.IsPlayer())
				{
					Popup.Show("You are puzzled by " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: false, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", null, "sfx_artifact_examination_noProgress");
				}
		...
		public void ResultCriticalFailure(GameObject Actor)
		{
			...
			{
				Popup.Show("You are puzzled by " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: false, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", null, "sfx_artifact_examination_fail");
			}
