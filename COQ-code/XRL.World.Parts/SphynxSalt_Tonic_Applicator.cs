	...
	public class SphynxSalt_Tonic_Applicator : IPart
	{
		...
		public override bool FireEvent(Event E)
		{
			if (E.ID == "ApplyTonic")
			{
				...
				int @for = GetTonicDurationEvent.GetFor(ParentObject, gameObjectParameter, gameObjectParameter2, "SphynxSalt", Stat.Random(18 * intParameter, 22 * intParameter), intParameter);
