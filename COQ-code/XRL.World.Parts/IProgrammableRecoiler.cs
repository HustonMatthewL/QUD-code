	...
	public abstract class IProgrammableRecoiler : IPoweredPart
	{
		...
		public bool ProgramRecoiler(GameObject Actor, IEvent FromEvent = null)
		{
			...
			if (activePartStatus != 0)
			{
				...
				{
					Actor.Fail(ParentObject.Does("do", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " not have enough charge to be imprinted with the current location.");
				}
				else
				{
					Actor.Fail(ParentObject.Does("click", int.MaxValue, null, null, "merely", AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + ".");
				}
				return false;
			}
