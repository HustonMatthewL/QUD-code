...
namespace XRL.World.Parts
{
	...
	public class LootOnStep : IPart
	{
		...
		{
			ParentObject.Die(By, null, "You were stepped on.", ParentObject.Does("were", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: true, SecondPerson: true, null) + " @@stepped on.", Accidental, null, null, Force: false, AlwaysUsePopups: false, "");
		}
