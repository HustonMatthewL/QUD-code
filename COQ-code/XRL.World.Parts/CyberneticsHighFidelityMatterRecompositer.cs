...
namespace XRL.World.Parts
{
	...
	public class CyberneticsHighFidelityMatterRecompositer : IPart
	{
		...
		{
			if (!commandId.IsNullOrEmpty() && GameObject.Validate(E.Actor) && E.TargetCell != null && E.Actor == ParentObject.Implantee && E.Actor.IsActivatedAbilityAIUsable(ActivatedAbilityID) && IComponent<GameObject>.CheckRealityDistortionAdvisability(E.Actor, null, E.Actor, ParentObject, null, null))
			{
				if (E.StandoffDistance > 0)
				{
					...
					{
						if (!item.IsEmptyOfSolidFor(E.Actor) || !IComponent<GameObject>.CheckRealityDistortionAdvisability(null, item, E.Actor, ParentObject, null, null))
						{
							continue;
						}
				...
				{
					Cell randomLocalAdjacentCell = E.TargetCell.GetRandomLocalAdjacentCell((Cell c) => c.IsEmptyOfSolidFor(E.Actor) && IComponent<GameObject>.CheckRealityDistortionAdvisability(null, c, E.Actor, ParentObject, null, null) && c.GetNavigationWeightFor(E.Actor) < 10);
				...
				else if (Stat.Random(1, 40) < E.Distance && IComponent<GameObject>.CheckRealityDistortionAdvisability(null, E.TargetCell, E.Actor, ParentObject, null, null))
				{
					E.Add(commandId);
				}
			}
		...
		{
			if (!commandId.IsNullOrEmpty() && GameObject.Validate(E.Actor) && E.Actor == ParentObject.Implantee && E.Actor.IsActivatedAbilityAIUsable(ActivatedAbilityID) && IComponent<GameObject>.CheckRealityDistortionAdvisability(E.Actor, null, E.Actor, ParentObject, null, null))
			{
				if (E.TargetCell == null)
				{
					...
					if (avoidCell != null)
					{
						...
						{
							if (c.IsEmptyOfSolidFor(E.Actor) && IComponent<GameObject>.CheckRealityDistortionAdvisability(null, c, E.Actor, ParentObject, null, null))
							{
					...
					else
					{
						...
						if (cell2 != null && Stat.Random(1, 20) < E.Actor.DistanceTo(cell2) && IComponent<GameObject>.CheckRealityDistortionAdvisability(null, cell2, E.Actor, ParentObject, null, null) && cell2.GetNavigationWeightFor(E.Actor) < 10)
						{
				...
				{
					Cell randomLocalAdjacentCellAtRadius = E.TargetCell.GetRandomLocalAdjacentCellAtRadius(E.StandoffDistance, (Cell c) => c.IsEmptyOfSolidFor(E.Actor) && IComponent<GameObject>.CheckRealityDistortionAdvisability(null, c, E.Actor, ParentObject, null, null) && c.GetNavigationWeightFor(E.Actor) < 10);
				...
				else if (Stat.Random(1, 20) < E.Distance && IComponent<GameObject>.CheckRealityDistortionAdvisability(null, E.TargetCell, E.Actor, ParentObject, null, null))
				{
					E.Add(commandId);
				}
			}
		...
		{
			if (!commandId.IsNullOrEmpty() && GameObject.Validate(E.Target) && GameObject.Validate(E.Actor) && E.Actor == ParentObject.Implantee && E.Actor.IsActivatedAbilityAIUsable(ActivatedAbilityID) && IComponent<GameObject>.CheckRealityDistortionAdvisability(E.Actor, null, E.Actor, ParentObject, null, null))
			{
				Cell cell = E.Target.CurrentCell?.GetRandomLocalAdjacentCell((Cell c) => c.IsEmptyOfSolidFor(E.Actor) && IComponent<GameObject>.CheckRealityDistortionAdvisability(null, c, E.Actor, ParentObject, null, null) && c.GetNavigationWeightFor(E.Actor) < 20);
