...
namespace XRL.World.Parts
{
	...
	public class Cloneling : IPart
	{
		...
		public override bool HandleEvent(InventoryActionEvent E)
		{
			if (E.Command == "ResupplyForCloning")
			{
				if (E.Actor.UseDrams(1, "cloning"))
				{
					...
					E.Actor.UseEnergy(1000, "Action Resupply", null, null);
		...
		public bool PerformCloning(GameObject Target)
		{
			...
			ParentObject.UseEnergy(1000, "Ability Clone", null, null);
		...
		public bool AttemptCloning()
		{
			...
			if (!CanBeCloned(combatTarget))
			{
				if (ParentObject.IsPlayer())
				{
					...
					{
						ParentObject.Fail("You cannot reach " + combatTarget.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
					}
					else if (!combatTarget.PhaseMatches(ParentObject))
					{
						ParentObject.Fail("You cannot make contact with " + combatTarget.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
					}
					else if (Cloning.CanBeCloned(combatTarget))
					{
						ParentObject.Fail("You cannot clone " + combatTarget.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
					}
					else
					{
						ParentObject.Fail(combatTarget.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " cannot be cloned.");
					}
				}
				return false;
			}
			...
			{
				return ParentObject.Fail("You fail to clone " + combatTarget.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
			}
			return false;
		}
	}
