...
namespace XRL.World.Parts
{
	...
	public class AutomatedExternalDefibrillator : IPoweredPart
	{
		...
		public bool AttemptDefibrillate(GameObject Actor, IEvent FromEvent = null)
		{
			...
			{
				return Actor.Fail("You don't know how to use " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
			}
			int value = MyPowerLoadLevel();
			...
			if (Object == null)
			{
				...
				if (Object == null)
				{
					if (Actor.IsPlayer())
					{
						...
						{
							Actor.Fail("There is no one there to use " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " on.");
						}
						else
						{
							Actor.Fail("There is no one there you can use " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " on.");
						}
					}
					return false;
				}
				string message = ((Object != Actor) ? (Object.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + Object.Is + " not in cardiac arrest. Do you want to use " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " on " + Object.them + " anyway?") : ("You are not in cardiac arrest. Do you want to use " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " on " + Actor.itself + " anyway?"));
			...
			Actor.UseEnergy(1000, "Item Medical Defibrillator", null, null);
