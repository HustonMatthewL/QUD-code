...
namespace XRL.World.Parts
{
	...
	public class PetFrondzie : IPart
	{
		...
		public void taunt(GameObject target)
		{
			...
			string text = ((num <= 50) ? EncountersAPI.GetAnObject().an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) : ((num > 90) ? tauntTargets.GetRandomElement() : Factions.GetRandomFaction().DisplayName));
