	...
	public class Salve_Tonic_Applicator : IPart
	{
		...
		public override bool FireEvent(Event E)
		{
			if (E.ID == "ApplyTonic")
			{
				...
				int @for = GetTonicDurationEvent.GetFor(ParentObject, gameObjectParameter, gameObjectParameter2, "Salve", 5 * intParameter, intParameter, Healing: true);
				gameObjectParameter2.FireEvent("ApplyingSalve");
				Salve_Tonic e = new Salve_Tonic(@for);
