...
namespace XRL.World.Parts
{
	...
	public class DecoyHologramEmitter : IPoweredPart
	{
		...
		public override bool HandleEvent(CommandEvent E)
		{
			if (E.Command == "ToggleHologramEmitter" && GameObject.Validate(E.Actor))
			{
				if (HologramActive)
				{
					...
					DestroyHolograms();
					E.Actor.UseEnergy(1000, "Item Deactivation", null, null);
		...
		{
			if (!HologramActive && !IsDisabled(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) && (E.Distance > 1 || 20.in100()))
			{
		...
		{
			if (HologramActive && Holograms.Contains(E.Object) && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				return false;
			}
			return base.HandleEvent(E);
		...
		public override bool HandleEvent(GetInventoryActionsEvent E)
		{
			if (HologramActive)
			{
				if (GetActivePartStatus(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) != ActivePartStatus.NeedsSubject)
				{
					E.AddAction("Deactivate", "deactivate", "DeactivateHologramBracelet", null, 'a', FireOnActor: false, 10);
				}
			}
			else if (GetActivePartStatus(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) != ActivePartStatus.NeedsSubject)
			{
		...
		public override bool FireEvent(Event E)
		{
			if (E.ID == "BeginTakeAction")
			{
				if (HologramActive)
				{
					...
					if (IsDisabled(UseCharge: true, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, value, UseChargeIfUnpowered: false, 0L, null))
					{
						DestroyHolograms();
					}
				}
			...
			else if (E.ID == "AfterMoved")
			{
				if (HologramActive && !Stationary)
				{
					for (int i = 0; i < Holograms.Count; i++)
					{
						...
						{
							gameObject.Move(Directions.GetOppositeDirection(E.GetStringParameter("Direction")), Forced: true, System: false, IgnoreGravity: false, NoStack: false, AllowDashing: true, DoConfirmations: true, null, null, NearestAvailable: false, null, null, null);
						}
					}
				}
			}
			...
			else if (E.ID == "EffectApplied" && HologramActive && IsDisabled(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				DestroyHolograms();
			}
		...
		public static GameObject CreateHologramOf(GameObject Object)
		{
			...
			gameObject.SetStringProperty("HologramOf", Object.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null));
		...
		private bool ActivateHologramBracelet(GameObject Who, IEvent E = null)
		{
			...
			if (!HologramActive)
			{
				...
				if (HologramActive)
				{
					Who.UseEnergy(1000, "Item Activation", null, null);
					E?.RequestInterfaceExit();
				...
				if (Who.IsPlayer())
				{
					...
					{
						Popup.Show(ParentObject.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ParentObject.Is + " still starting up.");
					}
					else
					{
						...
						case ActivePartStatus.Unpowered:
							Popup.Show(ParentObject.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ParentObject.GetVerb("do") + " not have enough charge to sustain the hologram.");
							break;
						default:
							Popup.Show(ParentObject.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ParentObject.Is + " unresponsive.");
							break;
