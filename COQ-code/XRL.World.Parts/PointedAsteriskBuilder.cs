...
namespace XRL.World.Parts
{
	...
	public class PointedAsteriskBuilder : IPart
	{
		...
		public static void AsteriskWish(string Value)
		{
			...
			GameObject @object = GameObjectFactory.Factory.CreateObject("n-Pointed Asterisk", 0, 0, null, null, null, "Wish");
			The.Player.ReceiveObject(BuildAsterisk(@object, faction, result));
		}
