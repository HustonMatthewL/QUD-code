...
namespace XRL.World.Parts
{
	...
	public class CyberneticsSocialCoprocessor : IPoweredPart
	{
		...
		public override bool HandleEvent(WaterRitualStartEvent E)
		{
			...
			{
				int num = (IsReady(UseCharge: true, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) ? GetWaterRitualReputationBonus() : 0);
		...
		{
			if (E.BaseAmount < 0 && !E.Transient && E.Type == "WaterRitualUse" && IsReady(!E.Prospective, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
