...
namespace XRL.World.Parts
{
	...
	public class ModMagnetized : IModification
	{
		...
		public override bool FireEvent(Event E)
		{
			...
			{
				if (IsDisabled(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: true, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
				{
		...
		public void CheckFloating()
		{
			...
			if (equipped == null || (IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) && ParentObject.GetCarriedWeight() <= 25))
			{
				return;
			}
			if (equipped.OnWorldMap())
			{
				...
				{
					Popup.Show(ParentObject.Does("fall", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " to the ground; you pick " + ParentObject.them + " up.");
				}
			}
			else
			{
