...
namespace XRL.World.Parts
{
	...
	public class DamageContents : IPoweredPart
	{
		...
		private bool DoDamageContentsItem(GameObject obj)
		{
			...
			if (obj.TakeDamage(Damage.RollCached(), Attributes: DamageAttributes, Message: "from " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", DeathReason: null, ThirdPersonDeathReason: null, Owner: null, Attacker: null, Source: ParentObject, Perspective: ParentObject, DescribeAsFrom: null, Accidental: false, Environmental: false, Indirect: false, ShowUninvolved: false, IgnoreVisibility: false, ShowForInanimate: true))
			{
				AnyDamage = true;
			}
			return true;
