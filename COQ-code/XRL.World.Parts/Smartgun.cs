...
namespace XRL.World.Parts
{
	...
	public class Smartgun : IPoweredPart
	{
		...
		{
			if (E.Checking == "Actor" && IsObjectActivePartSubject(E.Actor) && E.Target == E.AimedAt && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) && !E.Prospective && UseTurn < XRLCore.Core.Game.Turns)
			{
		...
		{
			if (E.ID == "ModifyAimVariance" && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
