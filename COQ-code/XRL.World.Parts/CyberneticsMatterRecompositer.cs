...
namespace XRL.World.Parts
{
	...
	public class CyberneticsMatterRecompositer : IPart
	{
		...
		{
			if (E.TargetCell != null && !commandId.IsNullOrEmpty() && E.Distance >= 40 && GameObject.Validate(E.Actor) && E.Actor == ParentObject.Implantee && E.Actor.IsActivatedAbilityAIUsable(ActivatedAbilityID) && 10.in100() && IComponent<GameObject>.CheckRealityDistortionAdvisability(E.Actor, null, E.Actor, ParentObject, null, null))
			{
				E.Add(commandId);
			}
			return base.HandleEvent(E);
		...
		{
			if (!commandId.IsNullOrEmpty() && (E.TargetCell == null || E.Distance >= 5) && GameObject.Validate(E.Actor) && E.Actor == ParentObject.Implantee && E.Actor.IsActivatedAbilityAIUsable(ActivatedAbilityID) && IComponent<GameObject>.CheckRealityDistortionAdvisability(E.Actor, null, E.Actor, ParentObject, null, null))
			{
				E.Add(commandId);
			}
			return base.HandleEvent(E);
		...
		{
			if (!commandId.IsNullOrEmpty() && E.Distance >= 40 && GameObject.Validate(E.Actor) && E.Actor == ParentObject.Implantee && E.Actor.IsActivatedAbilityAIUsable(ActivatedAbilityID) && 5.in100() && IComponent<GameObject>.CheckRealityDistortionAdvisability(E.Actor, null, E.Actor, ParentObject, null, null))
			{
				E.Add(commandId);
			}
			return base.HandleEvent(E);
