...
namespace XRL.World.Parts
{
	...
	public class DischargeOnStep : IActivePart
	{
		...
		{
			if (CooldownLeft > 0 || GetActivePartFirstSubject(ValidStepTarget) == null || !IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) || !Chance.in100())
			{
				return;
			}
