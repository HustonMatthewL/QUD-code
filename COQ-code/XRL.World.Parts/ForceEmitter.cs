...
namespace XRL.World.Parts
{
	...
	public class ForceEmitter : IPoweredPart
	{
		...
		{
			if (!IsActive() && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) && ForceFieldAdvisable() && IsMyActivatedAbilityAIUsable(ActivatedAbilityID) && !ParentObject.CurrentCell.AnyAdjacentCell(ContainsAlly))
			{
		...
		public override bool HandleEvent(InventoryActionEvent E)
		{
			if (E.Command == COMMAND_NAME && ActivateForceEmitter(E))
			{
				...
				E.Actor.UseEnergy(1000, "Item Force Bracelet", null, null);
			}
			return base.HandleEvent(E);
		}
		...
		public bool ActivateForceEmitter(IEvent E = null)
		{
			...
			if (IsActive())
			{
				if (IsSuspended())
				{
					activePartFirstSubject.Fail(ParentObject.Does("vibrate", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " slightly.");
				}
				...
				{
					IComponent<GameObject>.AddPlayerMessage("The {{B|force bubble}} around " + activePartFirstSubject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " snaps off.");
				}
				DestroyBubble();
				return true;
			}
			...
			{
				activePartFirstSubject.Fail(ParentObject.Does("don't", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " have enough charge to sustain the field!");
			}
			else
			{
