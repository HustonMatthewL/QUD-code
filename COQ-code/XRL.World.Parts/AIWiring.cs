...
namespace XRL.World.Parts
{
	...
	public class AIWiring : AIBehaviorPart
	{
		...
		public override bool HandleEvent(IsConversationallyResponsiveEvent E)
		{
			...
			{
				E.Message = E.Speaker.Does("ignore", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " " + E.Actor.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".";
				return false;
			}
			return base.HandleEvent(E);
		}
