...
namespace XRL.World.Parts
{
	...
	public class ModLiquidCooled : IModification
	{
		...
		{
			ActivePartStatus activePartStatus = GetActivePartStatus(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, E.ActivePartsIgnoreSubject, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null);
		...
		public override bool HandleEvent(CommandReloadEvent E)
		{
			if ((E.Weapon == null || E.Weapon == ParentObject) && !E.CheckedForReload.Contains(this))
			{
				...
				if (freeDrams <= 0)
				{
					if (E.Actor.IsPlayer())
					{
						IComponent<GameObject>.AddPlayerMessage("You have no " + ConsumesLiquid + " for " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", 'r');
					}
					return true;
				}
				...
				liquidVolume.MixWith(new LiquidVolume(ConsumesLiquid, num), null, null, null);
				E.Reloaded.Add(this);
				...
				if (gameObjectParameter2 != null && gameObject != null)
				{
					...
					if (gameObject.IsPlayer())
					{
						if (num > 0)
						{
							...
							num.ToString();
							int? num2 = Popup.AskNumber("Supply " + gameObjectParameter2.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " with how many drams of your " + ConsumesLiquid + "? (max=" + num + ")", "Sounds/UI/ui_notification", "", num, 0, num);
							int num3 = 0;
							try
							{
						...
						{
							Popup.Show("You have no " + ConsumesLiquid + " to supply " + gameObjectParameter2.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " with.");
						}
						else if (storableDrams <= 0)
						{
							Popup.Show(gameObjectParameter2.Does("have", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " no room for more " + ConsumesLiquid + ".");
						}
					}
					if (num > 0)
					{
		...
		public string GetStatusMessage(ActivePartStatus Status)
		{
			...
			{
				return ParentObject.Does("emit", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " a grinding noise.";
			}
			return ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " " + GetStatusPhrase(Status) + ".";
		}
