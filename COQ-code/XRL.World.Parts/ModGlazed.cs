...
namespace XRL.World.Parts
{
	...
	public class ModGlazed : IModification
	{
		...
		public override bool HandleEvent(GetShortDescriptionEvent E)
		{
			...
			{
				int @for = GetSpecialEffectChanceEvent.GetFor(ParentObject.Equipped ?? ParentObject.Implantee, ParentObject, "Modification ModGlazed Dismember", Chance);
				E.Postfix.AppendRules(@for + "% chance to dismember on hit.");
			}
