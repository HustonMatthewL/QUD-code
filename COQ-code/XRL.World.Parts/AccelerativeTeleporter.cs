...
namespace XRL.World.Parts
{
	...
	public class AccelerativeTeleporter : IPoweredPart
	{
		...
		{
			if (CurrentDirection != null && !IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				ResetAcceleration();
			}
		...
		private bool ProcessMoveInner(Cell oldCell, Cell newCell, Event E, bool forced)
		{
			...
			if (!IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: true, 0L, null))
			{
				return false;
			}
			...
			if (dir == CurrentDirection)
			{
				...
				if (CurrentDistance >= TriggerDistance)
				{
					...
					ForeachActivePartSubjectWhile((GameObject o) => PerformAccelerativeTeleport(o, dir, E, null), MayMoveAddOrDestroy: true);
					return false;
				}
		...
		public override bool FireEvent(Event E)
		{
			...
			else if (E.ID == "CellChanged" && CurrentDirection != null && !IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				ResetAcceleration();
			}
		...
		public override bool HandleEvent(AfterTravelEvent E)
		{
			if (AcceleratedTravel && ChargeUse > 0 && IsObjectActivePartSubject(E.Actor) && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				...
				ParentObject.UseCharge(ChargeUse * num, LiveOnly: false, 0L, IncludeTransient: true, IncludeBiological: true, null);
