		...
		public override bool HandleEvent(KilledEvent E)
		{
			if (E.Dying.GetPsychicGlimmer() >= DimensionManager.GLIMMER_FLOOR)
			{
				if (ParentObject.GetPrimaryFaction() == "Seekers")
				{
					...
					E.ThirdPersonReason = E.Dying.Does("were", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: true, SecondPerson: true, null) + " @@resorbed into the Mass Mind.";
				}
