...
namespace XRL.World.Parts
{
	...
	public class PluckablePolyp : IPart
	{
		...
		public void Pluck(GameObject Actor)
		{
			...
			IComponent<GameObject>.XDidY(Actor, "pluck", (The.Player.IsConfused ? ParentObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) : "a coral polyp") + " off the strut" + ((cell == cell2) ? "" : Actor.DescribeDirectionToward(cell)) + " and" + Actor.GetVerb("toss") + " it aside");
