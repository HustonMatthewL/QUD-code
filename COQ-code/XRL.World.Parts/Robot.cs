		...
		public override bool FireEvent(Event E)
		{
			if (E.ID == "ApplyingTonic" || E.ID == "CanApplyTonic")
			{
				if (E.HasFlag("ShowMessage"))
				{
					...
					gameObjectParameter.Fail(string.Concat(str2: E.GetGameObjectParameter("Tonic").t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null), str0: gameObjectParameter2.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null), str1: " robotic and cannot be affected by ", str3: "."));
				}
				return false;
			}
