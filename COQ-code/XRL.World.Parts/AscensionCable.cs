...
namespace XRL.World.Parts
{
	public class AscensionCable : IPart
	{
		...
		public bool TryAscend(GameObject Actor, bool FromDialog = false)
		{
			...
			{
				Popup.Show("You don't have the capacity to ascend " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				return false;
			}
			if (!The.Game.HasQuest("We Are Starfreight") || !The.Game.HasFinishedQuest("Reclamation"))
			{
				Popup.Show("You can't safely ascend " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " right now.");
				return false;
			}
		...
		public bool TryDescend(GameObject Actor, bool FromDialog = false)
		{
			...
			if (!Actor.HasTag("Golem") || Actor.IsTemporary || !Actor.HasPart<Vehicle>() || part?.Zone == null)
			{
				Popup.Show("You don't have the capacity to descend " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				return false;
			}
			if (!EndGame.IsArkOpened)
			{
				Popup.Show("You can't safely descend " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " right now.");
				return false;
			}
