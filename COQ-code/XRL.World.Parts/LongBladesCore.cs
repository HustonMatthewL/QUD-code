		...
		public override bool FireEvent(Event E)
		{
			...
			else if (E.ID == "CommandLunge")
			{
				...
				if (currentStance == "aggressive")
				{
					...
					ParentObject.UseEnergy(1000, "Skill Lunge", null, null);
					if (Ultmode <= 0)
					{
			...
			else if (E.ID == "CommandSwipe")
			{
				...
				if (currentStance == "aggressive")
				{
					...
					ParentObject.UseEnergy(1000, "Skill Aggressive Swipe", null, null);
					if (Ultmode <= 0)
					{
				...
				else if (currentStance == "defensive")
				{
					...
					ParentObject.UseEnergy(1000, "Skill Defensive Swipe", null, null);
					if (Ultmode <= 0)
					{
				...
				else
				{
					...
					ParentObject.UseEnergy(1000, "Skill Duelist Swipe", null, null);
					if (Ultmode <= 0)
					{
