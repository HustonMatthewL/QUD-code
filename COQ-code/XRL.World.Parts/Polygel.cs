				...
				try
				{
					...
					try
					{
						if (E.Actor.IsPlayer() && !E.Item.Understood())
						{
							...
							Popup.Show(ParentObject.Itis + " " + ParentObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + "!");
						}
					}
