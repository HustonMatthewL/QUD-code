	...
	public class BioAmmoLoader : IActivePart
	{
		...
		public override bool HandleEvent(CheckLoadAmmoEvent E)
		{
			if (Available <= 0)
			{
				if (E.Message == null)
				{
					E.Message = ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " exhausted!";
				}
				return false;
			}
			return base.HandleEvent(E);
				...
				if (ParentObject.IsEquippedProperly() && E.MinimumCharge <= 0)
				{
					...
					if (liquidVolume != null)
					{
						if (CorrectLiquid(liquidVolume) && liquidVolume.Volume >= liquidVolume.MaxVolume)
						{
							if (E.Actor.IsPlayer())
							{
								IComponent<GameObject>.AddPlayerMessage(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " already full.");
							}
						}
						else
						{
		...
		{
			if (Available < MaxCapacity && IsReady(UseCharge: true, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				TurnsGenerating++;
