...
namespace XRL.World.Parts
{
	...
	public class CyberneticsBiodynamicPowerPlant : IPoweredPart
	{
		...
		public override bool FireEvent(Event E)
		{
			...
			if (E.ID == "QueryCharge")
			{
				if ((ConsiderLive || !E.HasFlag("LiveOnly")) && E.HasFlag("IncludeTransient") && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
				{
			...
			else if (E.ID == "QueryChargeProduction" && (ConsiderLive || !E.HasFlag("LiveOnly")) && E.HasFlag("IncludeTransient") && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
