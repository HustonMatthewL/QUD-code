...
namespace XRL.World.Parts
{
	...
	public class CyberneticsStasisProjector : IPoweredPart
	{
		...
		{
			if (!CommandID.IsNullOrEmpty() && E.Distance == 1 && GameObject.Validate(E.Actor) && GameObject.Validate(E.Target) && IsObjectActivePartSubject(E.Actor) && E.Actor.IsActivatedAbilityAIUsable(ActivatedAbilityID) && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) && IComponent<GameObject>.CheckRealityDistortionAdvisability(E.Actor, E.Target.CurrentCell, E.Actor, ParentObject, null, null))
			{
				E.Add(CommandID);
			}
			return base.HandleEvent(E);
		...
		{
			if (!CommandID.IsNullOrEmpty() && GameObject.Validate(E.Actor) && IsObjectActivePartSubject(E.Actor) && E.Actor.IsActivatedAbilityAIUsable(ActivatedAbilityID) && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) && IComponent<GameObject>.CheckRealityDistortionAdvisability(E.Actor, null, E.Actor, ParentObject, null, null))
			{
				...
				{
					if (obj.IsCreature && obj != E.Actor && E.Actor.IsHostileTowards(obj) && E.Actor.HasLOSTo(obj, IncludeSolid: true, BlackoutStops: false, UseTargetability: true) && IComponent<GameObject>.CheckRealityDistortionAdvisability(null, obj.CurrentCell, E.Actor, ParentObject, null, null))
					{
		...
		public override bool HandleEvent(CommandEvent E)
		{
			if (E.Command == CommandID)
			{
				...
				E.Actor.UseEnergy(1000, "Cybernetics Stasis Projector", null, null);
