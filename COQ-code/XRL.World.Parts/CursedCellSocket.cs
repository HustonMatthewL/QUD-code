	...
	public class CursedCellSocket : IPart
	{
		...
		public override bool HandleEvent(CellChangedEvent E)
		{
			if (E.NewCell != null)
			{
				...
				if (E.Actor.IsPlayer())
				{
					Popup.Show(E.NewCell.Does("lock", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " firmly into the socket, preventing removal.", null, "Sounds/UI/ui_notification", CopyScrap: true, Capitalize: true, DimBackground: true, LogMessage: false);
				}
			}
		...
		public override bool HandleEvent(CellDepletedEvent E)
		{
			...
			{
				EmitMessage(E.Object.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " burns into bright slag.");
