...
namespace XRL.World.Parts
{
	...
	public class ModHeartstopper : IModification
	{
		...
		public string GetInstanceDescription()
		{
			...
			return "Heartstopper: When powered, this weapon has " + Grammar.A(part.GetActivationChance(ParentObject.Holder, null, null, null)) + "% chance to put opponents into cardiac arrest" + (part.SaveAttribute.IsNullOrEmpty() ? "" : (" if they fail a difficulty " + part.GetSaveTarget(null) + " " + part.SaveAttribute + " save")) + ".";
		}
