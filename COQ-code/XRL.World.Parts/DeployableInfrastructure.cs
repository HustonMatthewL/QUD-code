...
namespace XRL.World.Parts
{
	...
	public class DeployableInfrastructure : IPart
	{
		...
		public bool AttemptDeploy(GameObject Actor)
		{
			...
			if (num2 == 0)
			{
				Popup.ShowFail("There is no useful way to " + DeployVerb + " " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " there.");
				return false;
			}
			Actor.PlayWorldOrUISound(DeploySound, null);
			...
			{
				Popup.Show("You " + DeployVerb + " " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
			}
			if (EnergyCost > 0)
			{
				Actor.UseEnergy(EnergyCost, "Tinkering", null, null);
			}
			if (UsesStack)
			{
		...
		public bool DeployOne(GameObject Actor, Cell Cell, bool Message = false, bool Sound = false)
		{
			...
			if (Message && flag)
			{
				Actor.EmitMessage(Actor.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " " + Actor.GetVerb(DeployVerb, PrependSpace: false) + " " + ParentObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", null, null, Actor.IsPlayer());
			}
			return flag;
		}
