...
namespace XRL.World.Parts
{
	...
	public class GlimmerAlteration : IPoweredPart
	{
		...
		{
			if (Amount != 0 && IsObjectActivePartSubject(E.Subject) && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
