...
namespace XRL.World.Parts
{
	...
	public class Engraver : IPoweredPart
	{
		...
		public override bool HandleEvent(InventoryActionEvent E)
		{
			...
			{
				E.Actor.UseEnergy(10000, "Item Engraver", null, null);
		...
		public bool AttemptEngrave(GameObject Actor)
		{
			...
			case ActivePartStatus.Unpowered:
				return Actor.Fail(ParentObject.Does("click", int.MaxValue, null, null, "merely", AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + ".");
			default:
				return Actor.Fail(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " " + GetStatusPhrase(activePartStatus) + ".");
			case ActivePartStatus.Operational:
			{
				...
				if (body == null)
				{
					return Actor.Fail("You cannot engrave " + ((firstObjectWithPart == Actor) ? Actor.itself : firstObjectWithPart.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null)) + ".");
				}
				...
				case Tattoos.ApplyResult.TooManyTattoos:
					return Actor.Fail("There are too many engravings on " + ((firstObjectWithPart == Actor) ? "your" : Grammar.MakePossessive(firstObjectWithPart.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null))) + " " + bodyPart.GetOrdinalName() + " to add more.");
				case Tattoos.ApplyResult.AbstractBodyPart:
				case Tattoos.ApplyResult.NonContactBodyPart:
					return Actor.Fail("You can't engrave " + ((firstObjectWithPart == Actor) ? "your" : Grammar.MakePossessive(firstObjectWithPart.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null))) + " " + bodyPart.GetOrdinalName() + ".");
				case Tattoos.ApplyResult.InappropriateBodyPart:
					return Actor.Fail(((firstObjectWithPart == Actor) ? "Your" : Grammar.MakePossessive(firstObjectWithPart.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null))) + " " + bodyPart.GetOrdinalName() + " can't be engraved because " + (bodyPart.Plural ? "they don't" : "it doesn't") + " have a hard enough body part.");
				default:
					return Actor.Fail("You can't engrave " + ((firstObjectWithPart == Actor) ? "your" : Grammar.MakePossessive(firstObjectWithPart.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null))) + " " + bodyPart.GetOrdinalName() + ".");
				case Tattoos.ApplyResult.Engravable:
				{
					string text = Popup.AskString("Describe your engraving. For example: \"a tiny snail\".", "", "Sounds/UI/ui_notification", "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 -+/#()!@$%*<>", null, 30, 0, ReturnNullForEscape: false, EscapeNonMarkupFormatting: true, null);
