...
namespace XRL.World.Parts
{
	...
	public class SmartItem : IPart
	{
		...
		public void SetUpSmartItem(int nLikes = -1, int nDislikes = -1)
		{
			...
			Initialized = true;
			Name = NameMaker.MakeName(EncountersAPI.GetACreature(), null, null, null, null, null, null, null, null, null, null, null, null, FailureOkay: false, SpecialFaildown: false, null, null);
			if (nLikes == -1)
			{
