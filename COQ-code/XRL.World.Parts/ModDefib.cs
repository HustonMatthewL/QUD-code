...
namespace XRL.World.Parts
{
	...
	public class ModDefib : IModification
	{
		...
		public bool? CheckDefib(GameObject Subject)
		{
			...
			Subject.TakeDamage(num, Owner: ParentObject, Message: "from an {{electrical|electrical shock}} delivered by " + Subject.poss(ParentObject, Definite: true, null) + ".", Attributes: "Electric", DeathReason: null, ThirdPersonDeathReason: null, Attacker: null, Source: null, Perspective: null, DescribeAsFrom: null, Accidental: true);
