...
namespace XRL.World.Parts
{
	...
	public class CyberneticsTerminal2 : IPoweredPart, IHackingSifrahHandler
	{
		...
		{
			if (E.Actor.IsPlayer() && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				return false;
			}
			return base.HandleEvent(E);
		...
		public void HackingResultExceptionalSuccess(GameObject Actor, GameObject Object, HackingSifrah Game)
		{
			if (Object == ParentObject)
			{
				...
				if (Actor.IsPlayer())
				{
					Popup.Show("In the course of the hack, you are able to insert instructions into " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " granting you an extra " + ((num2 == 1) ? "cybernetics license point" : num2.Things("cybernetics license point")) + "!");
				}
		...
		public void HackingResultFailure(GameObject Actor, GameObject Object, HackingSifrah Game)
		{
			if (Object == ParentObject)
			{
				...
				if (Actor.IsPlayer())
				{
					Popup.Show("The hack fails, and alert lights on " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " begin pulsing rhythmically...");
				}
			}
		}
		...
		public void HackingResultCriticalFailure(GameObject Actor, GameObject Object, HackingSifrah Game)
		{
			...
			if (Actor.IsPlayer())
			{
				Popup.Show("The hack fails, and alert lights on " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " begin pulsing urgently...");
			}
		}
