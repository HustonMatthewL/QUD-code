...
namespace XRL.World.Parts
{
	...
	public class Circuitry : IPoweredPart
	{
		...
		{
			if ((!E.LiveOnly || ConsiderLive) && E.IncludeTransient && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
		...
		{
			if (E.Pass == 1 && (!E.LiveOnly || ConsiderLive) && E.IncludeTransient && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				CheckTurn(E.Multiple);
				int num = ChargeUse * E.Multiple;
				int num2 = Math.Min(E.Amount, GetCharge() - num);
