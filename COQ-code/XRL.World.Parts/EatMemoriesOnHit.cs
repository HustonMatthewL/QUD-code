...
namespace XRL.World.Parts
{
	...
	public class EatMemoriesOnHit : IPart
	{
		...
		public static void EatMemories(GameObject attacker, GameObject defender, GameObject weapon, string memoriesLost)
		{
			...
			{
				IComponent<GameObject>.AddPlayerMessage(attacker.Does("try", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " to eat your memories, but " + attacker.does("starve", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: true, SecondPerson: true, null) + ".");
			}
		}
