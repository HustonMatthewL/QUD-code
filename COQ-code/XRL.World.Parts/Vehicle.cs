	...
	public class Vehicle : IActivePart
	{
		...
		public override bool HandleEvent(InventoryActionEvent E)
		{
			...
			else if (E.Command == "CompanionEnterVehicle")
			{
				...
				if (list.Count == 0)
				{
					return E.Actor.Fail("You have no followers that can enter " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				}
