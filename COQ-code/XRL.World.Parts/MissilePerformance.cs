...
namespace XRL.World.Parts
{
	...
	public class MissilePerformance : IActivePart
	{
		...
		{
			if (IsObjectActivePartSubject(E.Subject) && IsReady(E.Active, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
