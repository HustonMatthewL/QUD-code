...
namespace XRL.World.Parts
{
	...
	public class Flywheel : IPoweredPart
	{
		...
		{
			if (IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) && E.Amount > 0 && Charge < MaxCharge)
			{
				int num = E.Amount;
		...
		{
			if (E.ID == "BeforeDeathRemoval" && MinimumChargeToExplode > 0 && Charge >= MinimumChargeToExplode && (CatastrophicDisable || !IsDisabled(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null)))
			{
				if (Visible())
				{
