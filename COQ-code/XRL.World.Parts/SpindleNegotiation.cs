			...
			if (E.ID == "BeginSpindleNegotiation")
			{
				...
				if (bArrived)
				{
					...
					case 2:
					{
						...
						Popup.Show("The delegate for " + Faction.GetFormattedName(text6) + " gives you " + heirloom.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + "!");
