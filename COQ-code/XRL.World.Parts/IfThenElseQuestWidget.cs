...
namespace XRL.World.Parts
{
	...
	public class IfThenElseQuestWidget : IPart
	{
		...
		public void RequireSubjects()
		{
			if (Tau == null)
			{
				GameObject gameObject2 = (Tau = ParentObject.CurrentZone.GetCell(40, 10).AddObject(TauBlueprint));
			}
			...
			if (Companion == null)
			{
				GameObject gameObject2 = (Companion = ParentObject.CurrentZone.GetCell(33, 19).AddObject("AoygNoLonger"));
			}
		}
