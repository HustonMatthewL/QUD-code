...
namespace XRL.World.Parts
{
	...
	public class EnergyAmmoLoader : IPoweredPart
	{
		...
		{
			if (GetActivePartStatus(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) == ActivePartStatus.Unpowered)
			{
		...
		{
			int activeChargeUse = GetActiveChargeUse(null, null);
				...
				if (part != null)
				{
					...
					else
					{
						part.Cell.ForeachPartDescendedFrom(delegate(IEnergyCell P)
						{
							...
							if (text2 != null)
							{
								E.Items.Append(" [").Append(text2).Append(']');
							}
						});
					}
				}
		...
		{
			if (E.Skip != this && (E.Weapon == null || E.Weapon == ParentObject) && GetActivePartStatus(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) == ActivePartStatus.Unpowered && ParentObject.IsEquippedProperly())
			{
				return false;
			}
			return base.HandleEvent(E);
		...
		public override bool HandleEvent(CommandReloadEvent E)
		{
			if (E.Pass >= 3 && (E.Weapon == null || E.Weapon == ParentObject) && !E.CheckedForReload.Contains(this))
			{
				...
				{
					bool flag = GetActivePartStatus(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) == ActivePartStatus.Unpowered;
		...
		public string GetStatusMessage(ActivePartStatus Status)
		{
			...
			{
				return ParentObject.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " merely " + ParentObject.GetVerb("click", PrependSpace: false) + ".";
			}
						...
						if (inventory != null)
						{
							if (gameObject.IsPlayer())
							{
								...
								while (true)
								{
									...
									int num2 = Popup.PickOption("Select " + ((num == 0) ? "one" : "another") + " of your cells to supply " + gameObjectParameter2.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " with, if desired.", null, "", "Sounds/UI/ui_notification", OptionStrings.ToArray(), keymap.ToArray(), null, null, null, null, null, 0, 60, 0, -1, AllowEscape: true);
									...
									{
										Popup.Show(gameObjectParameter2.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " cannot take " + gameObject3.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
