		...
		public override bool HandleEvent(UnequippedEvent E)
		{
			...
			if (latchedOnEffectValidated != null)
			{
				if (LatchedOnto.ReceiveObject(ParentObject))
				{
					...
					if (E.Actor.IsPlayer())
					{
						IComponent<GameObject>.AddPlayerMessage("Since " + ParentObject.does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " still latched onto " + LatchedOnto.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", releasing " + ParentObject.them + " leaves " + ParentObject.them + " in " + LatchedOnto.its + " possession!", color);
					}
					else if (LatchedOnto.IsPlayer())
					{
						if (ParentObject.HasProperName)
						{
							IComponent<GameObject>.AddPlayerMessage("Since " + ParentObject.does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " still latched onto you, " + E.Actor.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " releasing " + ParentObject.them + " leaves " + ParentObject.them + " in your possession!", color);
						}
						else
						{
							IComponent<GameObject>.AddPlayerMessage("Since " + ParentObject.does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " still latched onto you, " + E.Actor.its + " releasing " + ParentObject.them + " leaves " + ParentObject.them + " in your possession!");
						}
					}
					else if (LatchedOnto.IsVisible() && E.Actor.IsVisible())
					{
						if (ParentObject.HasProperName)
						{
							IComponent<GameObject>.AddPlayerMessage("Since " + ParentObject.does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " still latched onto " + LatchedOnto.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", " + E.Actor.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " releasing " + ParentObject.them + " leaves " + ParentObject.them + " in " + LatchedOnto.poss("possession") + "!");
						}
						else
						{
							IComponent<GameObject>.AddPlayerMessage("Since " + ParentObject.does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " still latched onto " + LatchedOnto.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", " + E.Actor.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " releasing " + ParentObject.them + " leaves " + ParentObject.them + " in " + LatchedOnto.poss("possession") + "!");
		...
		public override bool FireEvent(Event E)
		{
			...
			else if (E.ID == "BeginMove")
			{
				...
				if (latchedOnEffectValidated != null && E.GetParameter("DestinationCell") is Cell c && LatchedOnto.DistanceTo(c) == 2)
				{
					...
					if (!LatchedOnto.FireEvent("BeforeGrabbed") || LatchedOnto.MakeSave(MoveSaveStat, MoveSaveTarget + MyPowerLoadBonus(), gameObject, MoveSaveDifficultyStat, "LatchOn Move Drag Restraint", IgnoreNaturals: false, IgnoreNatural1: false, IgnoreNatural20: false, IgnoreGodmode: false, ParentObject))
					{
						...
						gameObject.UseEnergy(1000, "Movement Failure", null, null);
						return false;
					}
				}
			}
			...
			else if (E.ID == "EnteredCell")
			{
				if (GetLatchedOnEffectValidated(out var Distance, UseCharge: false, 2) != null)
				{
					if (Distance == 2 && LeftCell != null)
					{
						...
						LatchedOnto.Move(directionFromCell, Forced: false, System: false, IgnoreGravity: false, NoStack: false, AllowDashing: true, DoConfirmations: true, ParentObject, null, NearestAvailable: false, null, null, null);
					}
			...
			else if (E.ID == "WeaponHit")
			{
				if (GetLatchedOnEffectValidated() == null)
				{
					...
					if (gameObject2 != null && IsReady(UseCharge: true, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
					{
