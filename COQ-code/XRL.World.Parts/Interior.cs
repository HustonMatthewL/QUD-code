	...
	public class Interior : IPart
	{
		...
		public override bool HandleEvent(TookDamageEvent E)
		{
			if (E.Object == ParentObject && InteriorZone.Active?.ParentObject == ParentObject)
			{
				...
				IComponent<GameObject>.AddPlayerMessage(Event.NewStringBuilder().Append(ParentObject.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null)).Append(' ')
