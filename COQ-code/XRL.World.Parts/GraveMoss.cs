	...
	public class GraveMoss : IPart
	{
		...
		public void Trigger()
		{
			if (!Triggered)
			{
				if (Visible())
				{
					IComponent<GameObject>.AddPlayerMessage(ParentObject.Does("start", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " to fizz hungrily.");
				}
				Triggered = true;
			}
		}
