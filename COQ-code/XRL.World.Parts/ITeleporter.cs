	...
	public abstract class ITeleporter : IPoweredPart
	{
		...
		public bool AttemptTeleport(GameObject Actor, IEvent FromEvent = null)
		{
			...
			if (!UsableInCombat && Actor.AreHostilesNearby())
			{
				...
				return Actor.Fail("You can't use " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " with hostiles nearby!");
			}
			int num = ParentObject.QueryCharge(LiveOnly: false, 0L);
			The.ZoneManager.GetZone(DestinationZone);
			ActivePartStatus activePartStatus = GetActivePartStatus(UseCharge: true, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: true, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null);
			string customTeleportFailure = GetCustomTeleportFailure(Actor);
			if (!customTeleportFailure.IsNullOrEmpty() || activePartStatus != 0 || !IsObjectActivePartSubject(Actor))
			{
				if (Actor.IsPlayer())
				{
					...
					case ActivePartStatus.LocallyDefinedFailure:
						...
						case 4:
						{
							...
							else if (text3 == "THIN")
							{
								...
								{
									Popup.ShowFail(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " encoded with an imprint of the Thin World that has no meaning in the Thick World.");
								}
								else
								{
							...
							{
								Popup.ShowFail(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " encoded with an imprint that has no meaning in your present context.");
							}
							break;
						}
						case 2:
						{
							...
							{
								Popup.ShowFail(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " encoded with the imprint of a remote pocket dimension, " + text + ", that is inaccessible from your present vibrational plane.");
							}
							break;
						}
						default:
					...
					case ActivePartStatus.Rusted:
						Popup.ShowFail(ParentObject.Poss("activation button") + " activation button is rusted in place.");
						break;
					case ActivePartStatus.Broken:
						Popup.ShowFail(ParentObject.Itis + " broken...");
						break;
					case ActivePartStatus.Booting:
						Popup.ShowFail(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " still starting up.");
						break;
					case ActivePartStatus.Unpowered:
						if (num > 0 && ParentObject.QueryCharge(LiveOnly: false, 0L) < num)
						{
							Popup.ShowFail(ParentObject.Does("hum", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " for a moment, then powers down. " + ParentObject.Does("don't", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: true, SecondPerson: true, null) + " have enough charge to function.");
						}
						else
						{
							Popup.ShowFail(ParentObject.Does("don't", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " have enough charge to function.");
						}
						break;
					default:
			...
			Actor.PlayWorldOrUISound(Sound, null);
			if (Actor.IsPlayer())
			{
