	...
	public class GasShame : IGasBehavior
	{
		...
		public void ApplyShame(GameObject GO)
		{
			...
			if (IsAffectable(GO, part))
			{
				...
				if (@for > 0 && !GO.MakeSave("Willpower", 5 + part.Level + @for / 10, null, null, "Shame Inhaled Gas", IgnoreNaturals: false, IgnoreNatural1: false, IgnoreNatural20: false, IgnoreGodmode: false, ParentObject))
				{
