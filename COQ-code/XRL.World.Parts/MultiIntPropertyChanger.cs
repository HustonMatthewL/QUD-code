...
namespace XRL.World.Parts
{
	...
	public class MultiIntPropertyChanger : IPoweredPart
	{
		...
		private void CheckApply(GameObject GO = null, bool ConsumeCharge = false, int Turns = 1)
		{
			if (Applied)
			{
				if (IsDisabled(ConsumeCharge, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, Turns, null, UseChargeIfUnpowered: false, 0L, null))
				{
					Unapply(GO ?? ParentObject.Equipped);
				}
			}
			else if (IsReady(ConsumeCharge, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, Turns, null, UseChargeIfUnpowered: false, 0L, null))
			{
