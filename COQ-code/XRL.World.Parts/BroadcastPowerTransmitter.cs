	...
	public class BroadcastPowerTransmitter : IPoweredPart
	{
		...
		public override bool HandleEvent(CollectBroadcastChargeEvent E)
		{
			if (IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				...
				if (num > 0)
				{
					ParentObject.UseCharge(num + ChargeUse, LiveOnly: false, 0L, IncludeTransient: true, IncludeBiological: true, null);
					E.Charge -= num;
					if (num >= E.Charge)
					{
						return false;
		...
		public override int GetDraw(QueryDrawEvent E = null)
		{
			...
			if (anyBasisZone != null && anyBasisZone.IsActive() && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				bool flag = false;
				int num2 = 0;
				int num3 = 0;
