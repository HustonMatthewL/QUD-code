	...
	public class Engulfing : IPoweredPart
	{
		...
		public override bool HandleEvent(CanChangeMovementModeEvent E)
		{
			if (E.Object == ParentObject && E.To == "Flying" && CheckEngulfed())
			{
				if (E.ShowMessage)
				{
					E.Object.Fail("You cannot fly while engulfing " + Engulfed.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				}
				return false;
			}
			return base.HandleEvent(E);
		...
		public bool Engulf(GameObject who, Event E = null)
		{
			...
			{
				ParentObject.ShowFailure(who.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " too large for you to engulf.");
				return false;
			}
			...
			{
				ParentObject.ShowFailure("You cannot do that while " + who.does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " in " + who.its + " present situation.");
				return false;
			}
			...
			if (EnterSaveTarget > 0 && who.MakeSave(EnterSaveStat, EnterSaveTarget, ParentObject, "Strength", "Engulfment"))
			{
				...
				{
					ParentObject.Fail("You fail to engulf " + who.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				}
				else if (who.IsPlayer())
				{
					IComponent<GameObject>.AddPlayerMessage(ParentObject.Does("try", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " to engulf you, but" + ParentObject.GetVerb("fail") + ".");
				}
				else if (IComponent<GameObject>.Visible(ParentObject))
				{
					IComponent<GameObject>.AddPlayerMessage(ParentObject.Does("try", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " to engulf " + who.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", but" + ParentObject.GetVerb("fail") + ".");
				}
				CheckEnterDamage(who, Failed: true);
				ParentObject.UseEnergy(1000, "Position", null, null);
