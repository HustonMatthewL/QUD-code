	...
	public class SpaceTimeVortex : IPart
	{
		...
		public bool ApplyVortex(GameObject GO)
		{
			...
			else
			{
				...
				{
					Popup.Show("Your companion, " + GO.GetDisplayName(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, ColorOnly: false, Visible: true, WithoutTitles: false, ForSort: false, Short: true, BaseOnly: false, WithIndefiniteArticle: true, WithDefiniteArticle: false, null, IndicateHidden: false, Capitalize: false, SecondPerson: false, Reflexive: false, null) + "," + GO.GetVerb("have") + " been sucked into " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " " + The.Player.DescribeDirectionToward(ParentObject) + "!");
				}
				else
				{
					IComponent<GameObject>.XDidYToZ(GO, "are", "sucked into", ParentObject, null, "!", null, null, null, GO, UseFullNames: false, IndefiniteSubject: false, IndefiniteObject: true, IndefiniteObjectForOthers: false, PossessiveObject: false, null, null, null, DescribeSubjectDirection: true);
