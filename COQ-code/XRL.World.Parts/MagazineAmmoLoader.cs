	...
	public class MagazineAmmoLoader : IPoweredPart
	{
		...
		public override bool HandleEvent(CheckLoadAmmoEvent E)
		{
			if (Ammo == null)
			{
				...
				{
					checkLoadAmmoEvent.Message = ParentObject.Does("have", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " no more ammo!";
				}
				return false;
			}
			if (GetActivePartStatus(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, E.ActivePartsIgnoreSubject, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) != 0)
			{
				CheckLoadAmmoEvent checkLoadAmmoEvent = E;
				if (checkLoadAmmoEvent.Message == null)
				{
					checkLoadAmmoEvent.Message = ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " jammed!";
				}
				return false;
			}
			return base.HandleEvent(E);
		...
		public override bool HandleEvent(LoadAmmoEvent E)
		{
			if (Ammo == null)
			{
				...
				{
					loadAmmoEvent.Message = ParentObject.Does("have", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " no more ammo!";
				}
				return false;
			}
			if (GetActivePartStatus(UseCharge: true, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, E.ActivePartsIgnoreSubject, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) != 0)
			{
				LoadAmmoEvent loadAmmoEvent = E;
				if (loadAmmoEvent.Message == null)
				{
					loadAmmoEvent.Message = ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " jammed!";
				}
				return false;
			}
		...
		{
			if (Ammo == null || IsDisabled(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				return false;
			}
			return base.HandleEvent(E);
		...
		public override bool HandleEvent(GetMissileWeaponStatusEvent E)
		{
			if (E.Override == null)
			{
				...
				else
				{
					...
					{
						E.Items.Append("{{").Append(@for).Append('|');
					}
					...
					if (flag || (E.NeededReload.Count <= 0 && !NeedsReloadEvent.Check(E.Actor, this)))
					{
						...
						if (list.Count == 0)
						{
							if (E.Actor.IsPlayer())
							{
								...
								IComponent<GameObject>.EmitMessage(E.Actor, "You have no more ammo for " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", ' ', E.FromDialog);
							}
							return true;
						}
						if (!flag && list.Count == 1 && Ammo != null && Ammo.Blueprint == list[0].Blueprint)
						{
							if (E.Actor.IsPlayer())
							{
								IComponent<GameObject>.EmitMessage(E.Actor, ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " already fully loaded.", ' ', E.FromDialog);
							}
							return true;
						}
		...
		public override bool HandleEvent(GetDisplayNameEvent E)
		{
			if (E.Understood())
			{
				if (E.Cutoff >= 1100)
				{
					E.AddMissileWeaponDamageTag(GetMissileWeaponPerformanceEvent.GetFor(ParentObject.Equipped, ParentObject, (Ammo != null && ProjectileObject.IsNullOrEmpty()) ? GetProjectileObjectEvent.GetFor(Launcher: ParentObject, Ammo: Ammo) : null, null, null, null, null, null, null, null, null));
				}
				if (!E.Reference)
				{
					if (GameObject.Validate(ref Ammo))
		...
		public bool Load(GameObject Loader, GameObject ChosenAmmo, bool FromDialog = false)
		{
			try
			{
				...
				if (Loader.FireEvent(@event))
				{
					...
					if (Loader.IsPlayer())
					{
						IComponent<GameObject>.EmitMessage(Loader, "You reload " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " with " + ((Ammo.Count == 1) ? Ammo.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) : Ammo.ShortDisplayName) + ".", ' ', FromDialog);
					}
					return true;
				}
				return false;
					...
					if (inventory != null)
					{
						...
						foreach (GameObject item in list)
						{
							...
							if (gameObject.IsPlayer())
							{
								...
								int? num3 = Popup.AskNumber("Supply " + gameObjectParameter.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " with how many " + (item.HasProperName ? ("of " + item.DisplayNameSingle) : Grammar.Pluralize(item.DisplayNameSingle)) + "? (max=" + count + ")", "Sounds/UI/ui_notification", "", count, 0, count);
								int num4 = 0;
								try
								{
