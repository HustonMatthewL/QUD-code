...
namespace XRL.World.Parts
{
	...
	public class Tombstone : IPart
	{
		...
		public void GenerateTombstone()
		{
			if (name == null)
			{
				name = NameMaker.MakeName(null, null, null, null, null, faction, null, null, null, null, null, null, null, FailureOkay: false, SpecialFaildown: false, null, null);
			}
			...
			else if (num < 200)
			{
				...
				text += gameObject.an(int.MaxValue, null, null, 75.in100(), Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
			...
			else if (num < 475)
			{
				...
				text = new string[3] { "Swallowed ", "Overdosed on ", "Accidentally ingested " }.GetRandomElement() + gameObject4.an(int.MaxValue, null, null, 75.in100(), Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
			...
			else if (num < 575)
			{
				...
				text = new string[4] { "Sat on ", "Swallowed ", "Forgot about ", "Knocked over " }.GetRandomElement() + gameObject7.an(int.MaxValue, null, null, 75.in100(), Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
			...
			else if (num < 600)
			{
				...
				text = string.Concat(str1: gameObject8.GetDisplayName(int.MaxValue, null, null, AsIfKnown: true, Single: false, NoConfusion: false, NoColor: false, Stripped: true, ColorOnly: false, Visible: true, WithoutTitles: false, ForSort: false, Short: true, BaseOnly: false, WithIndefiniteArticle: false, WithDefiniteArticle: false, null, IndicateHidden: false, Capitalize: false, SecondPerson: false, Reflexive: false, null), str0: list2.GetRandomElement());
				gameObject8.Obliterate();
			}
			else if (num < 625)
			{
				GameObject gameObject9 = GameObject.CreateSample(EncountersAPI.GetARandomDescendantOf("Book"));
				string displayName3 = gameObject9.GetDisplayName(int.MaxValue, null, null, AsIfKnown: true, Single: false, NoConfusion: false, NoColor: false, Stripped: true, ColorOnly: false, Visible: true, WithoutTitles: false, ForSort: false, Short: true, BaseOnly: false, WithIndefiniteArticle: false, WithDefiniteArticle: false, null, IndicateHidden: false, Capitalize: false, SecondPerson: false, Reflexive: false, null);
				text = "Became obsessed with " + displayName3 + " and forgot to eat";
			...
			else if (num < 675)
			{
				...
				text = list3.GetRandomElement() + gameObject10.an(int.MaxValue, null, null, 75.in100(), Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
			...
			else if (num < 750)
			{
				...
				text = list5.GetRandomElement() + gameObject12.an(int.MaxValue, null, null, 75.in100(), Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
