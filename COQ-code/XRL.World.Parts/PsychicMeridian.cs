...
namespace XRL.World.Parts
{
	...
	public class PsychicMeridian : IActivePart
	{
		...
		{
			if ((!Guarded || E.Penetrations <= 0) && CurrentCooldown <= 0 && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
		...
		public override bool FireEvent(Event E)
		{
			if ((E.ID == "DefenderAfterAttack" || E.ID == "DefenderProjectileHit") && CurrentCooldown <= 0)
			{
				...
				if (IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) && E.GetParameter("Damage") is Damage damage && damage.HasAttribute("Mental"))
				{
