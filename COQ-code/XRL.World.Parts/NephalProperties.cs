...
namespace XRL.World.Parts
{
	...
	public class NephalProperties : IPart
	{
		...
		public bool TryPacify()
		{
			...
			The.Core.RenderBase();
			CheckAchievement();
			Popup.Show(The.Speaker.Does("slouch", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " in pacification and radiates a chord of light.");
			return true;
		}
