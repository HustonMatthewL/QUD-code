...
namespace XRL.World.Parts
{
	...
	public class Hookah : IPart
	{
		...
		public bool SmokeHookah(GameObject Actor, bool FromDialog)
		{
			if (!CanPuff())
			{
				return Actor.Fail(ParentObject.Does("need", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " water in " + ParentObject.them + ".");
			}
			...
			Actor.UseEnergy(1000, "Item", null, null);
			for (int i = 2; i < 5; i++)
			{
