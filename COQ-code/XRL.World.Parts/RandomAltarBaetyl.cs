	...
	public class RandomAltarBaetyl : IPart
	{
		...
		public GameObject GenerateItem(string Spec, int Value, int TierSpec)
		{
			...
			if (flag || flag2)
			{
				...
				if (Name == null)
				{
					...
					Dictionary<string, string> vars = new Dictionary<string, string>
					{
						...
						},
						{
							...
							Grammar.MakePossessive(aLegendaryEligibleCreature.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null))
						}
					};
				...
				obj.GiveProperName(Name, Force: true, null, SpecialFaildown: false, null, null);
		...
		public void BaetylWantsSacrifice()
		{
			...
			if (num >= num2)
			{
				stringBuilder.Append("\n\nOffer ").Append(ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null)).Append(' ');
				if (num > num2)
				{
		...
		public string GiveReward(GameObject Receiver, bool IgnorePlayerControl = false, bool SkipItemMessage = false, bool SkipAttributePointsMessage = false, bool SkipMutationPointsMessage = false, bool SkipSkillPointsMessage = false, bool SkipExperiencePointsMessage = false, bool SkipLicensePointsMessage = false, bool SkipReputationMessage = false, int Value = 100)
		{
			...
			if (!RewardID.IsNullOrEmpty())
			{
				...
				if (!SkipItemMessage)
				{
					list.Add(gameObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: false, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null));
				}
			}
			if (RewardAttributePointsAmount > 0)
			{
		...
		private static bool HandleBaetylRewardWish(string Spec)
		{
			...
			Popup.Show("Generated " + gameObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " as reward for " + randomAltarBaetyl.GetDemandName());
