	...
	public class TinkerItem : IPart
	{
		...
		public override bool HandleEvent(InventoryActionEvent E)
		{
			if ((E.Command == "Disassemble" || E.Command == "DisassembleAll") && E.Actor.IsPlayer() && CanBeDisassembled(E.Actor))
			{
				...
				{
					E.Actor.ShowFailure("You need be near " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " in order to disassemble " + ParentObject.them + ".");
					return false;
				}
				if (E.Actor.IsPlayer())
				{
					...
					{
						Popup.ShowFail("You cannot seem to affect " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " in any way.");
						return false;
					}
					...
					else if (ConfirmBeforeDisassembling(ParentObject) && Popup.ShowYesNoCancel("Are you sure you want to disassemble " + (flag2 ? ("all the " + (ParentObject.GetGender().Plural ? ParentObject.ShortDisplayName : Grammar.Pluralize(ParentObject.ShortDisplayName))) : ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null)) + "?") != 0)
					{
						return false;
					}
					...
					{
						if (Popup.ShowYesNoCancel(inInventory.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " not owned by you. Are you sure you want to disassemble " + (flag2 ? "items" : ParentObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null)) + " inside " + inInventory.them + "?") != 0)
						{
							return false;
						}
						if (list == null)
		...
		{
			if (ParentObject.CurrentCell != null && E.Actor.Owns(ParentObject) && Tinkering_Repair.IsRepairableBy(ParentObject, E.Actor, null, null, null))
			{
