...
namespace XRL.World.Parts
{
	...
	public class UniversalCharger : IPoweredPart
	{
		...
		{
			if (IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) && AnyActivePartSubjectWantsEvent(RechargeAvailableEvent.ID, IChargeEvent.CascadeLevel))
			{
				CheckTurn();
		...
		{
			if (IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) && AnyActivePartSubjectWantsEvent(QueryRechargeStorageEvent.ID, IChargeEvent.CascadeLevel))
			{
				CheckTurn();
