...
namespace XRL.World.Parts
{
	...
	public class Campfire : IActivePart
	{
		...
		{
			if (!ParentObject.HasTagOrProperty("CampfireHeatSelfOnly") && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				return false;
			}
			return base.HandleEvent(E);
		...
		public override bool HandleEvent(EndTurnEvent E)
		{
			...
			if (IsReady(UseCharge: true, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				...
				{
					ParentObject.TemperatureChange(150, ParentObject, Radiant: false, MinAmbient: false, MaxAmbient: false, IgnoreResistance: false, 5, null, null);
				}
				if (cell.Objects.Count > 1 && !ParentObject.HasTagOrProperty("CampfireHeatSelfOnly"))
				{
					...
					for (int count = cell.Objects.Count; i < count; i++)
					{
						...
						if (gameObject != ParentObject)
						{
							...
							{
								gameObject.TemperatureChange(150, ParentObject, Radiant: false, MinAmbient: false, MaxAmbient: false, IgnoreResistance: false, phase, null, null);
							}
						}
					}
				}
		...
		public bool Preserve()
		{
			...
			{
				PerformPreserve(inventoryDirect[i], stringBuilder, The.Player);
		...
		public bool CookFromIngredients(bool random)
		{
			...
			foreach (GameObject item6 in validCookingIngredients)
			{
				if (!The.Player.HasPart<Carnivorous>() || (!item6.HasTag("Plant") && !item6.HasTag("Fungus")))
				{
					...
					{
						string text = o.go.LiquidVolume?.GetPreparedCookingIngredient();
						return (!liquidIngredient1.IsNullOrEmpty() && !text.IsNullOrEmpty()) ? (liquidIngredient1 == text) : (o.name == name);
					});
					if (num2 != -1)
					{
			...
			else
			{
				...
				while (true)
				{
					...
					list8.Add("{{W|Cook with the {{" + text2 + "|" + num5 + "}} selected ingredients.}}" + text3);
					list9.Add(null);
					int num6 = 0;
					foreach (var item10 in list)
					{
						...
						string text4 = $" {{{{K|x{item3}}}}}";
						if (list7[num6])
						{
							list8.Add("{{y|[{{G|X}}]}}   " + item5 + text4);
						}
						else
						{
							list8.Add("[ ]   " + item5 + text4);
						}
				...
				for (int i = 0; i < list7.Count; i++)
				{
					...
					string type;
					if (list[i].Item2.HasPart<PreparedCookingIngredient>())
					{
						PreparedCookingIngredient part = list[i].Item2.GetPart<PreparedCookingIngredient>();
						type = list[i].Item2.GetPart<PreparedCookingIngredient>().GetTypeInstance();
					...
					{
						type = list[i].Item2.LiquidVolume.GetPreparedCookingIngredient().Split(',').GetRandomElement();
					}
					if (!list2.Contains(type))
					{
						list2.Add(type);
					}
					list3.Add(list[i].Item2);
					if (gameObject != null)
					{
		...
		public bool Cook()
		{
			...
			if (activePartStatus != 0)
			{
				...
				case ActivePartStatus.SwitchedOff:
					Popup.Show(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " turned off.");
					break;
				case ActivePartStatus.Unpowered:
					Popup.Show(ParentObject.Does("do", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " not have enough charge to operate.");
					break;
				case ActivePartStatus.NotHanging:
					Popup.Show(ParentObject.Does("need", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " to be hung up first.");
					break;
				default:
					Popup.Show(ParentObject.Does("do", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " not seem to be working.");
					break;
				}
				return false;
			}
			...
			for (int i = 0; i < Amount; i++)
			{
				try
				{
					if (Objects != null && i < Objects.Count)
					{
						...
						{
							array[i] = Objects[i].an(int.MaxValue, null, "CookingIngredient", AsIfKnown: false, Single: true, NoConfusion: true, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
						}
					}
					else
					{
		...
		public void NostrumsStopBleeding()
		{
			...
			foreach (GameObject item in playerAndAdjacentCompanions)
			{
				...
				{
					Popup.ShowFail("You try to staunch the wounds of " + item.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", but your limbs pass through " + item.them + ".");
				}
				else if (!item.IsPlayer() && item.IsInStasis())
				{
					Popup.ShowFail("You try to staunch the wounds of " + item.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", but cannot affect " + item.them + ".");
				}
				else if (flag)
				{
					...
					if (flag2)
					{
						...
						{
							Popup.Show("You staunch the wounds of " + item.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", though some are too deep to treat.");
						}
					}
					...
					{
						Popup.Show("You staunch the wounds of " + item.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
					}
					int num2 = 0;
			...
			if (num == 0)
			{
				...
				{
					Popup.ShowFail("Neither you nor " + playerAndAdjacentCompanions[1].t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " are bleeding.");
				}
				else
				{
		...
		public void NostrumsTreatPoison()
		{
			...
			while (list.Count > 0)
			{
				...
				{
					Popup.ShowFail("You have no medicinal ingredients with which to treat the poison coursing through " + gameObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
					break;
				}
				...
				{
					Popup.ShowFail("You try to cure the poison coursing through " + gameObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", but your limbs pass through " + gameObject.them + ".");
					continue;
				}
				if (gameObject.IsInStasis())
				{
					Popup.ShowFail("You try to cure the poison coursing through " + gameObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", but cannot affect " + gameObject.them + ".");
					continue;
				}
				...
				if (num > 0)
				{
					...
					Popup.Show("You cure the " + ((num == 1) ? "poison" : "poisons") + " coursing through " + gameObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " with a balm made from " + gameObject2.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
					gameObject2.Destroy();
				}
				else
				{
					Popup.ShowFail("You try to cure the poison coursing through " + gameObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", but your cures are ineffective.");
				}
			}
			if (count != 0)
			{
			...
			if (playerAndAdjacentCompanions.Any((GameObject who) => who.HasEffectOfType(65536)))
			{
				...
				if (list2.Contains(The.Player))
				{
					...
					{
						Popup.ShowFail("The poison affecting you and " + list2[1].t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " is too strong to be cured by your nostrums.");
					}
					else
					{
			...
			{
				Popup.ShowFail("Neither you nor " + playerAndAdjacentCompanions[1].t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " are poisoned.");
			}
			else
			{
		...
		public void NostrumsTreatIllness()
		{
			...
			while (list.Count > 0)
			{
				...
				else
				{
					...
					Popup.Show("You cure " + gameObject.poss("illness") + " with a balm made from " + gameObject2.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
					gameObject2.Destroy();
				}
			}
			if (count == 0)
			{
				...
				{
					Popup.ShowFail("Neither you nor " + playerAndAdjacentCompanions[1].t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " are ill.");
				}
				else
				{
		...
		public void NostrumsTreatDiseaseOnset()
		{
			...
			for (int count = playerAndAdjacentCompanions.Count; i < count; i++)
			{
				...
				Effect @for = GetDiseaseOnsetEvent.GetFor(gameObject);
				if (@for != null)
				{
					list.Add(gameObject);
					list2.Add(@for);
			...
			while (list.Count > 0)
			{
				...
				list.RemoveAt(index);
				Effect @for = list2[index];
				list2.RemoveAt(index);
				if (gameObject.HasEffect<BoostedImmunity>())
				{
					Popup.ShowFail(gameObject.Does("have", int.MaxValue, null, null, "already", AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " boosted immunity from a nostrum.");
					continue;
				}
				List<GameObject> medicinalIngredients = GetMedicinalIngredients();
				if (medicinalIngredients.Count == 0)
				{
					Popup.ShowFail("You have no medicinal ingredients with which to treat " + gameObject.poss(@for.GetDescription()) + ".");
					break;
				}
				GameObject gameObject2 = Popup.PickGameObject("Select an ingredient to use.", medicinalIngredients, AllowEscape: true);
				if (gameObject2 == null)
				...
				else if (chance.in100())
				{
					...
					Popup.Show("You cure " + gameObject.poss(@for.GetDescription()) + " with a balm made from " + gameObject2.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
					gameObject.RemoveEffect(@for);
					gameObject2.Destroy();
				}
				else if (gameObject.ApplyEffect(new BoostedImmunity()))
				{
					IComponent<GameObject>.PlayUISound("Sounds/Interact/sfx_interact_campfire_treat_disease");
					Popup.Show("You boost " + gameObject.poss("immunity") + " with a balm made from " + gameObject2.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
					gameObject2.Destroy();
				}
				else
				{
					Popup.Show("You try to boost " + gameObject.poss("immunity") + " with a balm made from " + gameObject2.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", but it is ineffective.");
					gameObject2.Destroy();
				}
			}
			if (count2 == 0)
			{
				...
				{
					Popup.ShowFail("Neither you nor " + playerAndAdjacentCompanions[1].t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " are suffering from the onset of a disease.");
				}
				else
				{
		...
		public void Extinguish(GameObject Actor = null, GameObject Object = null)
		{
			...
			{
				EmitMessage(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " extinguished by " + Object.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
			}
