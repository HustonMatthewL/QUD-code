...
namespace XRL.World.Parts
{
	...
	public class ConversationScript : IPart
	{
		...
		{
			if (E.Actor.IsPlayer() && (!ParentObject.IsPlayerLed() || !ParentObject.IsMobile()) && ParentObject.FireEvent(eCanHaveSmartUseConversation) && AttemptConversation(Silent: false, null))
			{
				return false;
			}
			return base.HandleEvent(E);
		...
		public static bool IsPhysicalConversationPossible(GameObject Who, GameObject With, bool ShowPopup = true, bool AllowCombat = false, bool AllowFrozen = false, int ChargeUse = 0)
		{
			...
			if (Who.HasEffect<Confused>())
			{
				if (ShowPopup && Who.IsPlayer())
				{
					Popup.ShowFail("You can't seem to make out what " + With.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + With.Is + " saying.");
				}
				return false;
			}
			...
			if (ChargeUse > 0 && !With.TestCharge(ChargeUse, LiveOnly: false, 0L))
			{
				if (ShowPopup && Who.IsPlayer())
				{
					Popup.ShowFail(With.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + With.Is + " utterly unresponsive.");
				}
				return false;
			}
			...
			if (!AllowCombat && With.IsHostileTowards(Who))
			{
				if (ShowPopup && Who.IsPlayer())
				{
					Popup.ShowFail(With.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + With.GetVerb("refuse") + " to speak to you.");
				}
				return false;
			}
			if (!AllowCombat && With.IsEngagedInMelee())
			{
				if (ShowPopup && Who.IsPlayer())
				{
					Popup.ShowFail(With.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " engaged in hand-to-hand combat and" + With.Is + " too busy to have a conversation with you.");
				}
				return false;
			}
			if (!AllowCombat && With.IsAflame())
			{
				if (ShowPopup && Who.IsPlayer())
				{
					Popup.ShowFail(With.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " on fire and" + With.Is + " too busy to have a conversation with you.");
				}
				return false;
			}
			if (!CanStartConversationEvent.Check(Who, With, out var FailureMessage, Physical: true))
			{
				if (ShowPopup && Who.IsPlayer())
				{
					...
					{
						Popup.ShowFail("You cannot seem to engage " + With.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " in conversation.");
					}
				}
				return false;
			}
		...
		public static bool IsMentalConversationPossible(GameObject Who, GameObject With, bool ShowPopup = true, bool AllowCombat = false, int ChargeUse = 0)
		{
			...
			if (!Who.CanMakeTelepathicContactWith(With) || (ChargeUse > 0 && !With.TestCharge(ChargeUse, LiveOnly: false, 0L)))
			{
				if (ShowPopup && Who.IsPlayer())
				{
					Popup.ShowFail("You can sense nothing from " + With.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				}
				return false;
			}
			...
			if (!AllowCombat && With.IsHostileTowards(Who))
			{
				if (ShowPopup && Who.IsPlayer())
				{
					Popup.ShowFail("You sense only hostility from " + With.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				}
				return false;
			}
			if (!CanStartConversationEvent.Check(Who, With, out var FailureMessage, Physical: false, Mental: true))
			{
				if (ShowPopup && Who.IsPlayer())
				{
					...
					{
						Popup.ShowFail("You cannot seem to make contact with " + With.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
					}
				}
				return false;
			}
		...
		public static bool AttemptConversation(GameObject Listener, GameObject Speaker, GameObject Transmitter = null, GameObject Receiver = null, ConversationXMLBlueprint Blueprint = null, int ChargeUse = 0, bool Silent = false, bool Dynamic = false, bool? Mental = null, IEvent ParentEvent = null)
		{
			...
			if (Blueprint == null)
			{
				if (!Silent)
				{
					return Listener.ShowFailure(Speaker.Does("have", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " nothing to say.");
				}
				return false;
			}
			if (Dynamic)
		...
		public static string PronounExchangeDescription(GameObject Player, GameObject Speaker, bool SpeakerGivePronouns, bool SpeakerGetPronouns, bool SpeakerGetNewPronouns)
		{
			...
			{
				return "you and " + Speaker.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " exchange pronouns; " + Speaker.its + " are " + Speaker.GetPronounSet().GetShortName();
			}
			if (SpeakerGivePronouns)
			{
				return Speaker.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + Speaker.GetVerb("give") + " you " + Speaker.its + " pronouns, which are " + Speaker.GetPronounSet().GetShortName();
			}
			if (SpeakerGetNewPronouns)
			{
				return "you give " + Speaker.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " your new pronouns";
			}
			if (SpeakerGetPronouns)
			{
				return "you give " + Speaker.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " your pronouns";
			}
			return null;
		}
	}
