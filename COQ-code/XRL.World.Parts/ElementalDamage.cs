...
namespace XRL.World.Parts
{
	...
	public class ElementalDamage : IActivePart
	{
		...
		{
			if (E.Weapon == ParentObject && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
		...
		public override bool HandleEvent(GetShortDescriptionEvent E)
		{
			...
			int effectiveChance = GetEffectiveChance(null);
		...
		public override bool FireEvent(Event E)
		{
			if (E.ID == "WeaponHit")
			{
				...
				if (_WillActivateOnNextHit)
				{
					...
					{
						string message = ((gameObjectParameter3 != null && !IComponent<GameObject>.TerseMessages) ? ("from " + gameObjectParameter.poss(gameObjectParameter3, Definite: true, null) + ".") : "from %t attack.");
			...
			else if (E.ID == "AdjustWeaponScore" && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
