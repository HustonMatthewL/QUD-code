...
namespace XRL.World.Parts
{
	...
	public class LowStatBooster : IPoweredPart
	{
		...
		{
			if (IsDisabled(UseCharge, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, MultipleCharge, null, UseChargeIfUnpowered: false, 0L, null))
			{
				UnapplyEffects(obj);
				return;
			}
