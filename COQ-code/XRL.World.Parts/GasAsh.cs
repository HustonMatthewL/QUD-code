...
namespace XRL.World.Parts
{
	...
	public class GasAsh : IObjectGasBehavior
	{
		...
		public override bool ApplyGas(GameObject Object)
		{
			...
			int @for = GetRespiratoryAgentPerformanceEvent.GetFor(Object, ParentObject, baseGas, null);
			if (@for <= 0)
			{
				return false;
			}
			...
			return Object.TakeDamage((int)Math.Max(Math.Floor((double)(@for + 1) / 10.0), 1.0), "from %t {{K|choking ash}}!", "InhaleDanger Asphyxiation Gas", null, null, null, baseGas.Creator, null, null, null, Accidental: false, Environmental: true);
		}
