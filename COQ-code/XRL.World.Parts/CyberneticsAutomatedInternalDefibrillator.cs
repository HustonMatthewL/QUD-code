...
namespace XRL.World.Parts
{
	...
	public class CyberneticsAutomatedInternalDefibrillator : IPoweredPart
	{
		...
		public override void TurnTick(long TimeTick, int Amount)
		{
			...
			if (implantee != null && implantee.HasEffect<CardiacArrest>() && IsReady(UseCharge: true, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null) && GetChance(implantee).in100())
			{
