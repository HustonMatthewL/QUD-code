	...
	public class Physics : IPart, IContextRelationManager
	{
		...
		public bool Push(string Direction, int Force, int MaxDistance = 9999999, bool IgnoreGravity = false, bool Involuntary = true, GameObject Actor = null)
		{
			...
			foreach (string item in adjacentDirections)
			{
				...
				{
					if (ParentObject.Move(Direction, Forced: true, System: false, IgnoreGravity, NoStack: false, AllowDashing: true, DoConfirmations: true, null, null, NearestAvailable: false, null, null, null))
					{
						return true;
					}
					continue;
		...
		protected int AccelerateInternal(int Force, string Direction = null, Cell Toward = null, Cell AwayFrom = null, string Type = null, GameObject Actor = null, bool Accidental = false, GameObject IntendedTarget = null, string BonusDamage = null, double DamageFactor = 1.0, bool SuspendFalling = true, bool OneShort = false, bool Repeat = false, bool BuiltOnly = true, bool MessageForInanimate = true, bool DelayForDisplay = true, bool Subsequent = false)
		{
			...
			while (true)
			{
				...
				if (cellFromDirection.IsEmpty())
				{
					...
					type = Type;
					if (!parentObject.Move(direction, Forced: true, System: false, SuspendFalling, NoStack: true, AllowDashing: true, DoConfirmations: true, null, null, NearestAvailable: false, null, type, null))
					{
				...
				if (list4.Count > 0)
				{
					...
					string text2 = (ParentObject.IsPlayer() ? "you" : ParentObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null));
					foreach (GameObject item2 in list4)
					{
						...
						if (!list3.Contains(item2))
						{
							...
							if (num9 > 0)
							{
								string text3 = "from colliding with " + (item2.IsPlayer() ? "you" : item2.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null)) + ".";
								if (!flag2)
								{
				...
				type = Type;
				if (!parentObject3.Move(direction2, Forced: true, System: false, SuspendFalling, NoStack: true, AllowDashing: true, DoConfirmations: true, null, null, NearestAvailable: false, null, type, null))
				{
					break;
				}
				if (Type == "Telekinetic")
		...
		public static void LegacyApplyExplosion(Cell C, List<Cell> UsedCells, List<GameObject> Hit, int Force, bool Local = true, bool Show = true, GameObject Owner = null, string BonusDamage = null, int Phase = 1, float DamageModifier = 1f)
		{
			...
			while (cleanQueue.Count > 0)
			{
				...
				foreach (GameObject item2 in cell.GetObjectsWithPartReadonly("Physics"))
				{
					...
					if (@event == null || !BonusDamage.IsNullOrEmpty())
					{
						...
						foreach (GameObject item3 in cell3.GetObjectsWithPartReadonly("Physics"))
						{
							if (!Hit.Contains(item3))
							{
								...
								if (item3.PhaseMatches(Phase))
								{
									...
									if (event2 == null || !BonusDamage.IsNullOrEmpty())
									{
							...
							if (item3.PhaseMatches(Phase))
							{
								...
								if (kineticResistance > 0)
								{
									item3.Move((text == ".") ? Directions.GetRandomDirection() : text, Forced: true, System: false, IgnoreGravity: false, NoStack: false, AllowDashing: true, DoConfirmations: true, null, null, NearestAvailable: false, null, null, null);
								}
							}
						}
						if (cell3.IsSolid())
		...
		public static void ApplyExplosion(Cell C, int Force, List<Cell> UsedCells = null, List<GameObject> Hit = null, bool Local = true, bool Show = true, GameObject Owner = null, string BonusDamage = null, int Phase = 1, bool Neutron = false, bool Indirect = false, float DamageModifier = 1f, GameObject WhatExploded = null)
		{
			...
			{
				CombatJuice.playPrefabAnimation(C.Location, "Impacts/ImpactVFXExplosion", null, null, async: true);
			}
			if (Options.UseParticleVFX && C != null && C.IsVisible() && Neutron)
			{
				CombatJuice.playPrefabAnimation(C.Location, "Impacts/ImpactVFXNeutronImpact", null, null, async: true);
			}
			...
			while (cleanQueue.Count > 0)
			{
				...
				{
					CombatJuice.playPrefabAnimation(cell.Location, "Impacts/ImpactVFXExplosion", null, null, async: true);
				}
				if (Options.UseParticleVFX && cell.IsVisible() && Neutron)
				{
					...
					for (int k = 0; k < list.Count; k++)
					{
						...
						foreach (GameObject item2 in cell4.GetObjectsWithPartReadonly("Physics"))
						{
							...
							if (num7 > 0)
							{
								...
								if (IsMoveable(item2))
								{
									item2.Move((text == ".") ? Directions.GetRandomDirection() : text, Forced: true, System: false, IgnoreGravity: false, NoStack: false, AllowDashing: true, DoConfirmations: true, null, null, NearestAvailable: false, null, "Explosion", null);
								}
							}
						}
						if (cell4.IsSolid())
			...
			if (GO.PhaseMatches(Phase))
			{
				...
				else
				{
					...
					else
					{
						...
						{
							stringBuilder.Append("the explosion of ").Append(WhatExploded.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null));
							stringBuilder2.Append("the explosion of ").Append(WhatExploded.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null));
						}
						else
						{
					...
					if (Owner != null && Owner != WhatExploded)
					{
						...
						{
							stringBuilder.Append(" caused by ").Append(Owner.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null));
							stringBuilder2.Append(" caused by ").Append(Owner.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null));
						}
					}
		...
		public int ApplyDischarge(Cell C, Cell TargetCell, int Voltage, ref int Shown, int Damage = 0, string DamageRange = null, DieRoll DamageRoll = null, GameObject Target = null, List<Cell> UsedCells = null, GameObject Owner = null, GameObject Source = null, GameObject DescribeAsFrom = null, GameObject Skip = null, List<GameObject> SkipList = null, bool? SourceVisible = null, string SourceDesc = null, string SourceDirectionTowardTarget = null, int Phase = 0, bool Accidental = false, bool Environmental = false, GameObject Alternate = null, GameObject AlternateAvoidedBecauseObject = null, string AlternateAvoidedBecauseReason = null, int Depth = 0, bool UsePopups = false)
		{
			...
			for (int i = num; (list == null) ? (i == num) : (i < list.Count); i++)
			{
				...
				if (GameObject.Validate(Source))
				{
					...
					{
						text2 = text + " {{electrical|electrical arc}} leaps from " + Source.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " toward " + Target.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + (Target.IsPlayer() ? "" : (" " + Source.DescribeDirectionToward(Target)));
						Shown++;
						flag2 = true;
					}
					...
					{
						text2 = text + " {{electrical|electrical arc}} leaps from " + Source.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " toward something " + Source.DescribeDirectionToward(Target);
						Shown++;
						flag2 = true;
					}
				}
				else if (!SourceDesc.IsNullOrEmpty() && !SourceDirectionTowardTarget.IsNullOrEmpty())
				{
					...
					{
						text2 = text + " {{electrical|electrical arc}} leaps from " + SourceDesc + " toward " + Target.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " " + SourceDirectionTowardTarget;
						Shown++;
					}
					else if (IComponent<GameObject>.Visible(Target))
					{
						text2 = text + " {{electrical|electrical arc}} leaps toward " + Target.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " " + SourceDirectionTowardTarget;
						Shown++;
					}
				...
				{
					text2 = text + " {{electrical|electrical arc}} leaps toward " + Target.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
					Shown++;
				}
				if (!text2.IsNullOrEmpty())
				{
					...
					{
						text2 = text2 + ", avoiding " + Alternate.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
						...
						{
							text2 = ((AlternateAvoidedBecauseObject.GetObjectContext() != Alternate) ? (text2 + " because of " + AlternateAvoidedBecauseObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null)) : (text2 + " because of " + Alternate.its_(AlternateAvoidedBecauseObject)));
						}
					...
					if (flag3)
					{
						...
						if (adjacentCells.Count > 0)
						{
							...
							if (gameObject2 != null)
							{
								...
								text3 = Target.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
				...
				if (flag3 && gameObject2 != null)
				{
					...
					if (cell2 != null)
					{
						...
						int phase2 = Phase;
						int depth = Depth + 1;
						ApplyDischarge(c, cell2, voltage, ref Shown, damage, DamageRange, damageRoll, target, usedCells, Owner, source, DescribeAsFrom, null, null, sourceVisible, sourceDesc, sourceDirectionTowardTarget, phase2, Accidental: true, Environmental, gameObject3, alternateAvoidedBecauseObject, alternateAvoidedBecauseReason, depth, UsePopups);
					}
				}
				break;
			}
			...
			if (IsPlayer())
			{
				...
				if (!IComponent<GameObject>.TerseMessages)
				{
					...
					for (int count = CurrentCell.Objects.Count; i < count; i++)
					{
						...
						{
							PassingBy.Add(gameObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null));
						}
					}
				...
				if ((brain == null || !brain.WallWalker || E.Object.IsFlying) && (!E.Object.IsPlayer() || !The.Core.IDKFA) && (!ParentObject.HasPropertyOrTag("Flyover") || !E.Object.IsFlying) && E.Object.PhaseMatches(ParentObject) && (E.Ignore == null || E.Ignore != ParentObject))
				{
					...
					if (ParentObject.FireEvent(eBeforePhysicsRejectObjectEntringCell) && Solid && E.Object.FireEvent(Event.New("ObjectEnteringCellBlockedBySolid", "Object", ParentObject)) && Solid)
					{
						if (E.Object.IsPlayer() && !ParentObject.HasTagOrProperty("NoBlockMessage"))
						{
							if (E.Forced)
							{
								string text = "OUCH! You collide with " + ParentObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".";
							...
							else if (E.Object.OnWorldMap())
							{
								...
								{
									IComponent<GameObject>.AddPlayerMessage(ParentObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " too difficult to traverse via the world map. You'll have to find your way on the surface.");
								}
							}
							else
							{
								IComponent<GameObject>.AddPlayerMessage("The way is blocked by " + ParentObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
							}
						}
		...
		public override bool HandleEvent(InventoryActionEvent E)
		{
			...
			else if (E.Command == "CleanItem")
			{
				...
				if (@for != null && @for.Count > 0)
				{
					...
					if (gameObject != null)
					{
						if (!gameObject.Owner.IsNullOrEmpty() && Popup.ShowYesNoCancel(gameObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " not owned by you. Are you sure you want to pour from " + gameObject.them + "?") != 0)
						{
							return false;
						}
				...
				{
					Popup.ShowFail("You don't have any " + cleaningLiquidGeneralization + " to clean " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " with.");
				}
			}
			...
			{
				bool flag = true;
				if (E.Actor.IsPlayer() && !ParentObject.IsHostileTowards(E.Actor) && ParentObject != E.Actor.Target && Popup.ShowYesNo("Do you really want to attack " + ((ParentObject == E.Actor) ? E.Actor.itself : ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null)) + "?") != 0)
				{
					flag = false;
				}
				if (flag)
			...
			{
				string text = Popup.AskString("Enter notes for " + E.Item.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", "", "Sounds/UI/ui_notification", null, null, 30, 0, ReturnNullForEscape: false, EscapeNonMarkupFormatting: true, null);
				if (!text.IsNullOrEmpty())
				{
		...
		private void UpdateTemperature()
		{
			...
			if (IsVaporizing())
			{
				...
				if (VaporizedEvent.Check(ParentObject, InflamedBy))
				{
					...
					ParentObject.Die(InflamedBy, null, "You were vaporized.", ParentObject.Does("were", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: true, SecondPerson: true, null) + " @@vaporized.", Accidental: true);
		...
		public override bool HandleEvent(GetDisplayNameEvent E)
		{
			if (!E.NoConfusion && The.Player != null && The.Player.IsConfused)
			{
				...
				{
					ConfusedName = NameMaker.MakeName(null, null, null, null, null, null, null, null, null, null, null, flag ? "FuriousConfusion" : "Confusion", null, FailureOkay: false, SpecialFaildown: false, null, null);
				}
			...
			if (E.Name == "Hitpoints")
			{
				if (E.NewValue < E.OldValue && E.NewValue - E.OldValue != E.NewBaseValue - E.OldBaseValue)
				{
					...
					if (AutoAct.IsInterruptable())
					{
						...
						{
							AutoAct.Interrupt("you " + ParentObject.GetPerceptionVerb() + " " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: true, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " being injured" + (ParentObject.IsVisible() ? "" : (" " + The.Player.DescribeDirectionToward(ParentObject))), null, ParentObject, IsThreat: true);
						}
					}
				}
				if (!ParentObject.WillCheckHP(null))
				{
		...
		public bool ProcessTakeDamage(Event E)
		{
			...
			else
			{
				...
				if (gameObject2 != null && gameObject2 != ParentObject)
				{
					...
					{
						string value2 = gameObject2.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: false, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
				...
				if (flag6)
				{
					...
					if (gameObject4 != null)
					{
						stringBuilder2.Append("## with ").Append(gameObject4.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null)).Append("##");
					}
				}
				stringBuilder.Append('.');
				stringBuilder2.Append('.');
			...
			if (!stringParameter.IsNullOrEmpty() && (damage.Amount > 0 || !E.HasFlag("SilentIfNoDamage")))
			{
				...
				if (flag8)
				{
					...
					else if (ParentObject.HasPart<Combat>() || E.HasFlag("ShowForInanimate"))
					{
						...
						stringBuilder4.Append(ParentObject.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null)).Append(' ').Append(ParentObject.GetVerb("take", PrependSpace: false))
							.Append(' ');
						if (damage.Amount > 0)
						{
				...
				else
				{
					...
					if ((ParentObject.FireEvent(Event.New(PreEvent, "Cell", TargetCell, Type, 1)) || System) && ParentObject.ProcessBeginMove(out var _, TargetCell, Forced, System, IgnoreGravity, NoStack, null, Type, null, null, null, Ignore))
					{
						...
						if (ParentObject.ProcessObjectLeavingCell(cell, ref Blocking, Forced, System, IgnoreGravity, NoStack, null, Type, null, null, null, Ignore) && ParentObject.ProcessEnteringCell(TargetCell, ref Blocking, Forced, System, IgnoreGravity, NoStack, null, Type, null, null, null, Ignore) && ParentObject.ProcessObjectEnteringCell(TargetCell, ref Blocking, Forced, System, IgnoreGravity, NoStack, null, Type, null, null, null, Ignore) && (zone == TargetCell.ParentZone || ParentObject.ProcessEnteringZone(cell, TargetCell, ref Blocking, Forced, System, IgnoreGravity, NoStack, null, Type, null, null, null, Ignore)) && ParentObject.ProcessLeaveCell(cell, ref Blocking, Forced, System, IgnoreGravity, NoStack, null, Type, null, null, null, Ignore))
						{
							...
							ParentObject.UseEnergy(amount, "Movement", null, null);
		...
		public bool ProcessTemperatureChange(int Amount, GameObject Actor = null, bool Radiant = false, bool MinAmbient = false, bool MaxAmbient = false, bool IgnoreResistance = false, int Phase = 0, int? Min = null, int? Max = null)
		{
			...
			if (!flag && IsAflame())
			{
				...
				if (AutoAct.IsActive())
				{
					...
					{
						AutoAct.Interrupt("you " + ParentObject.GetPerceptionVerb() + " " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: true, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " catch fire" + (ParentObject.IsVisible() ? "" : (" " + The.Player.DescribeDirectionToward(ParentObject))), null, ParentObject, IsThreat: true);
					}
				}
			}
			...
			if ((CurrentHP ?? ParentObject.hitpoints) <= 0)
			{
				...
				if (GameObject.Validate(ref LastDamagedBy))
				{
					if (LastDeathReason.IsNullOrEmpty())
					{
						...
						{
							LastDeathReason = "You were " + (LastDamageAccidental ? "accidentally " : "") + "killed by " + LastDamagedBy.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".";
						}
					}
					if (LastThirdPersonDeathReason.IsNullOrEmpty())
					{
						...
						{
							LastThirdPersonDeathReason = ParentObject.It + " were @@" + (LastDamageAccidental ? "accidentally " : "") + "killed by " + LastDamagedBy.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".";
						}
					}
					if (flag)
					{
