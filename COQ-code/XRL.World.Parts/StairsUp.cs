	...
	public class StairsUp : IPart
	{
		...
		public override bool HandleEvent(CommandSmartUseEvent E)
		{
			if (E.Actor.CurrentCell == ParentObject.CurrentCell)
			{
				...
				{
					E.Actor.Move("U", Forced: false, System: false, IgnoreGravity: false, NoStack: false, AllowDashing: false, DoConfirmations: true, null, null, NearestAvailable: false, null, null, null);
				}
			}
			return false;
		}
		...
		public override bool HandleEvent(IdleQueryEvent E)
		{
			if (ParentObject.HasTagOrProperty("IdleStairs") && E.Actor.HasPart<Brain>() && Stat.Random(1, 2000) == 2000)
			{
				...
				who.Brain.PushGoal(new DelegateGoal(delegate(GoalHandler h)
				{
					...
					{
						who.Move("U", Forced: false, System: false, IgnoreGravity: false, NoStack: false, AllowDashing: false, DoConfirmations: true, null, null, NearestAvailable: false, null, null, null);
					}
					h.FailToParent();
				}));
		...
		public override bool FireEvent(Event E)
		{
			if (E.ID == "ClimbUp")
			{
				...
				if (gameObjectParameter.Move("U", Forced: false, System: false, IgnoreGravity: false, NoStack: false, AllowDashing: false, DoConfirmations: true, null, null, NearestAvailable: false, null, null, null))
				{
