			...
			if (E.Command == "ActivateGenocideCurio")
			{
				...
				if (E.Actor != null && E.Actor.IsPlayer())
				{
					...
					if (num != -1)
					{
						...
						if (E.Actor != null && E.Actor.IsPlayer())
						{
							Popup.Show("You activate " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " and toss it into the air.");
						}
