...
public class SteamWorkshopUploaderView : SingletonWindowBase<SteamWorkshopUploaderView>
{
	...
	public void SetModInfo(ModInfo info)
	{
		...
		else
		{
			...
			{
				rootObject.transform.Find("DetailsPanel/Scroll View/Viewport/Content/TagsField/Field").GetComponent<TMP_InputField>().text = currentMod.WorkshopInfo.Tags;
			}
	...
	public void SubmitCurrentMod()
	{
		try
		{
			...
			currentMod.WorkshopInfo.Tags = rootObject.transform.Find("DetailsPanel/Scroll View/Viewport/Content/TagsField/Field").GetComponent<TMP_InputField>().text;
