...
namespace Assets.QupKit.Components
{
	public class HotkeyCommand : MonoBehaviour
	{
		...
		public void Update()
		{
			if ((parentControl == null || parentControl.interactable) && Hotkey != 0 && Input.GetKeyDown(Hotkey) && HotkeyCapitalized == (GameManager.capslock || Input.GetKey(UnityEngine.KeyCode.LeftShift) || Input.GetKey(UnityEngine.KeyCode.RightShift)))
			{
				Keyboard.ClearInput();
