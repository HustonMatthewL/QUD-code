		...
		public override void Generate()
		{
			...
			do
			{
				if (CHANCE_REGIONAL_NAME.in100())
				{
					...
					value = NameMaker.MakeName(null, null, null, null, culture, null, text, null, null, null, null, "Site", null, FailureOkay: false, SpecialFaildown: false, null, null);
				}
				else
				{
					value = NameMaker.MakeName(null, null, null, null, culture, null, null, null, null, null, null, "Site", null, FailureOkay: false, SpecialFaildown: false, null, null);
				}
			}
