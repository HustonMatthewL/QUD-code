		...
		public override void Generate()
		{
			...
			while (true)
			{
				...
				if (num <= 200)
				{
					...
					string text2 = NameMaker.MakeName(VillageBase.getBaseVillager(snapshotAtYear.GetProperty("baseFaction"), property) ?? GameObject.Create(PopulationManager.RollOneFrom("LairOwners_" + property).Blueprint), null, null, null, null, null, null, null, null, null, null, null, null, FailureOkay: false, SpecialFaildown: false, null, null);
