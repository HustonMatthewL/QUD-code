	...
	public class Marry : HistoricEvent
	{
		public override void Generate()
		{
			...
			if (50.in100())
			{
				...
				text4 = ((factionMembers.Count <= 0) ? NameMaker.MakeName(null, null, null, null, "Qudish", null, null, null, null, null, null, "Site", null, FailureOkay: false, SpecialFaildown: false, null, null) : NameMaker.MakeName(GameObject.Create(factionMembers.GetRandomElement().Name), null, null, null, null, null, null, null, null, null, null, null, null, FailureOkay: false, SpecialFaildown: false, null, null));
			...
			else
			{
				...
				text4 = NameMaker.MakeName(null, null, null, null, "Qudish", null, null, null, null, null, null, "Site", null, FailureOkay: false, SpecialFaildown: false, null, null);
