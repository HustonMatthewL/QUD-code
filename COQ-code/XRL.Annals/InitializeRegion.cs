...
namespace XRL.Annals
{
	...
	public class InitializeRegion : HistoricEvent
	{
		...
		public void NameRegion()
		{
			...
			do
			{
				text = NameMaker.MakeName(null, null, null, null, "Qudish", null, null, null, null, null, null, "Site", null, FailureOkay: false, SpecialFaildown: false, null, null);
			}
		...
		{
			string text = NameMaker.MakeName(null, null, null, null, "Qudish", null, null, null, null, null, null, "Site", null, FailureOkay: false, SpecialFaildown: false, null, null);
			if (25.in100())
			{
				switch (Random(0, 14))
				{
