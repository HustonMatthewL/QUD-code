	...
	public class PopulationInflux : HistoricEvent
	{
		...
		public override void Generate()
		{
			...
			else if (num <= 800)
			{
				...
				{
					value3 = $"Why{gameObject2.Is} there {gameObject2.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: true, IndicateHidden: false, SecondPerson: true, Reflexive: false, null)} here?";
					num3 = 1;
				}
