	...
	public static class Wishing
	{
		...
		public static void HandleWish(GameObject who, string Wish)
		{
			...
			if (Wish == "showcharset")
			{
				...
				for (int m = 1; m <= 255; m++)
				{
					string s2 = ((m != 10) ? (((char)m).ToString() ?? "") : "(newline)");
					array2[m - 1] = m.ToString().PadLeft(3, 'ÿ') + ": " + ConsoleLib.Console.ColorUtility.EscapeFormatting(s2);
				}
			...
			if (Wish.StartsWith("allaggroxp"))
			{
				...
				for (int num6 = 0; num6 < parentZone.Height; num6++)
				{
					for (int num7 = 0; num7 < parentZone.Width; num7++)
					{
						foreach (GameObject item4 in parentZone.GetCell(num7, num6).GetObjectsWithPart("Brain"))
						{
			...
			if (Wish == "showcooldownminima")
			{
				...
				while (num8 <= 600)
				{
					int num10 = ActivatedAbilities.MinimumValueForCooldown(num8);
					stringBuilder2.Append(num8).Append(": ").Append(num10)
						.Append(" (")
						.Append((int)Math.Round((double)num10 * 100.0 / (double)num8, MidpointRounding.AwayFromZero))
						.Append("%)\n");
					num8 += num9;
					num9 += 10;
				}
			...
			if (Wish == "testcardinal")
			{
				...
				{
					stringBuilder4.Append(num11).Append(": ").Append(Grammar.Cardinal(num11))
						.Append('\n');
				}
			...
			if (Wish == "testordinal")
			{
				...
				{
					stringBuilder5.Append(num12).Append(": ").Append(Grammar.Ordinal(num12))
						.Append('\n');
				}
			...
			if (Wish == "showgenders")
			{
				...
				for (int num13 = 0; num13 < all.Count; num13++)
				{
					stringBuilder6.Length = 0;
					stringBuilder6.Append(num13 + 1).Append('/').Append(all.Count)
						.Append("\n\n");
					all[num13].GetSummary(stringBuilder6);
			...
			if (Wish == "showpronounsets")
			{
				...
				for (int num14 = 0; num14 < all2.Count; num14++)
				{
					stringBuilder7.Length = 0;
					stringBuilder7.Append(num14 + 1).Append('/').Append(all2.Count)
						.Append("\n\n");
					all2[num14].GetSummary(stringBuilder7);
			...
			if (Wish == "zoneparts")
			{
				...
				string text9 = "";
				int num15 = 0;
				for (int count = currentZone4.Parts.Count; num15 < count; num15++)
				{
					text9 = text9 + "\n" + currentZone4.Parts[num15].Name;
				}
				Popup.Show(text9);
				return;
			}
			...
			{
				Action<StringBuilder, string> obj2 = delegate(StringBuilder sb, string s)
				{
					if (!sb.Contains(s))
					{
			...
			if (Wish == "what")
			{
				...
				{
					foreach (GameObject object2 in who.Physics.CurrentCell.Objects)
					{
						MessageQueue.AddPlayerMessage(object2.Blueprint);
					}
					return;
				}
			}
			...
			if (Wish == "bordertest")
			{
				for (int num16 = 0; num16 < 10000; num16++)
				{
			...
			{
				Keys num17 = Popup.ShowBlock("1) random maze\n2) recursive backtrack maze");
				if (num17 == Keys.D1)
				{
			...
			else if (Wish == "tunneltest")
			{
				do
				{
					...
					for (int num18 = 0; num18 < tunnelMaker.Height; num18++)
					{
						for (int num19 = 0; num19 < tunnelMaker.Width; num19++)
						{
							scrapBuffer.Goto(num19, num18);
							if (tunnelMaker.Map[num19, num18] == "")
							{
								scrapBuffer.Write(".");
							}
							if (tunnelMaker.Map[num19, num18].Contains("N") && tunnelMaker.Map[num19, num18].Contains("S"))
							{
								scrapBuffer.Write(186);
							}
							if (tunnelMaker.Map[num19, num18].Contains("E") && tunnelMaker.Map[num19, num18].Contains("W"))
							{
								scrapBuffer.Write(205);
							}
							if (tunnelMaker.Map[num19, num18].Contains("E") && tunnelMaker.Map[num19, num18].Contains("N"))
							{
								scrapBuffer.Write(200);
							}
							if (tunnelMaker.Map[num19, num18].Contains("W") && tunnelMaker.Map[num19, num18].Contains("N"))
							{
								scrapBuffer.Write(188);
							}
							if (tunnelMaker.Map[num19, num18].Contains("E") && tunnelMaker.Map[num19, num18].Contains("S"))
							{
								scrapBuffer.Write(201);
							}
							if (tunnelMaker.Map[num19, num18].Contains("W") && tunnelMaker.Map[num19, num18].Contains("S"))
							{
								scrapBuffer.Write(187);
							}
							if (tunnelMaker.Map[num19, num18] == "N")
							{
								scrapBuffer.Write(208);
							}
							if (tunnelMaker.Map[num19, num18] == "S")
							{
								scrapBuffer.Write(210);
							}
							if (tunnelMaker.Map[num19, num18] == "E")
							{
								scrapBuffer.Write(198);
							}
							if (tunnelMaker.Map[num19, num18] == "W")
							{
			...
			else
			{
				...
				else if (Wish == "sultantomb1")
				{
					...
					who.SystemMoveTo(The.ZoneManager.ActiveZone.GetCell(39, 14), null);
				...
				else if (Wish == "stage2" || Wish == "stage3a" || Wish == "stage3" || Wish == "stage4" || Wish == "stage5" || Wish == "stage6" || Wish == "stage8" || Wish.StartsWith("stage9") || Wish == "stage10" || Wish == "stage11" || Wish == "tombbeta" || Wish == "fastforwardtomb" || Wish == "tombbetastart" || Wish == "tombbetaend" || Wish == "tombbetainside" || Wish == "reefjump" || Wish == "pregolem" || Wish == "golemstart" || Wish == "posttomb" || Wish == "startmoonstair" || Wish == "postgolem")
				{
					...
					if (Wish == "stage2")
					{
						...
						who.SystemMoveTo(The.ZoneManager.ActiveZone.GetCell(0, 0), null);
						The.ZoneManager.ProcessGoToPartyLeader();
					...
					if (Wish == "postgolem")
					{
						...
						if (!game.GetBooleanGameState("Recame"))
						{
							...
							bool? dynamic = true;
							body.AddPart("Floating Nearby", 0, null, null, null, null, null, null, null, null, null, null, null, null, null, dynamic, null, null, null, null);
							game.SetBooleanGameState("Recame", Value: true);
						}
						The.Player.ReceiveObject("BarathrumKey");
						GritGateScripts.PromoteToJourneyfriend();
						...
						if (!The.Game.HasFinishedQuest("The Golem"))
						{
							...
							{
								MetricsManager.LogException("Postgolem", x2);
							}
						}
					}
				...
				{
					The.Player.ReceiveObject(GameObjectFactory.Factory.CreateObject("Phial", delegate(GameObject x)
					{
				...
				else
				{
					...
					if (Wish == "garbagetest")
					{
						for (int num21 = 0; num21 < 1000000; num21++)
						{
					...
					if (Wish.StartsWith("confusion"))
					{
						...
						int num22 = ((array4.Length >= 3) ? int.Parse(array4[2]) : 5);
						who.ApplyEffect(new XRL.World.Effects.Confused(duration, num22, num22 + 2));
						return;
					}
					...
					if (Wish.StartsWith("license:"))
					{
						...
						if (num23 != 0)
						{
							MessageQueue.AddPlayerMessage("License tier now " + who.ModIntProperty("CyberneticsLicenses", num23));
						}
						return;
					}
					if (Wish == "impl")
					...
					if (Wish.StartsWith("gainmp:"))
					{
						...
						if (num25 != 0)
						{
							Popup.Show(who.GainMP(num25).ToString());
						}
						return;
					}
					if (Wish == "bits")
					...
					{
						int num26 = int.Parse(Wish.Split(':')[1]);
						if (num26 > 0)
						{
							who.RequirePart<BitLocker>().AddAllBits(num26);
						}
						return;
					}
					if (Wish == "smartass")
					...
					else
					{
						...
						if (Wish.StartsWith("sultantest:"))
						{
							...
							for (int num29 = 0; num29 < num28; num29++)
							{
								...
								string zoneID2 = "JoppaWorld." + vector2i.x + "." + vector2i.y + ".1.1." + (num29 + 10);
								if (num29 == 0)
								{
						...
						if (Wish == "sultanreveal")
						{
							...
							{
								for (int num31 = 0; num31 < 80; num31++)
								{
									zone2.GetCell(num31, num30).GetFirstObjectWithPart("TerrainTravel").FireEvent("SultanReveal");
								}
							}
							Popup.Suppress = false;
							ItemNaming.Suppress = false;
						...
						if (Wish == "villagereveal")
						{
							...
							for (int num32 = 0; num32 < 25; num32++)
							{
								for (int num33 = 0; num33 < 80; num33++)
								{
									zone3.GetCell(num33, num32).GetFirstObjectWithPart("TerrainTravel").FireEvent("VillageReveal");
								}
							}
							Popup.Suppress = false;
							ItemNaming.Suppress = false;
						...
						if (Wish == "sultanquests")
						{
							...
							for (int num34 = 0; num34 < entitiesWherePropertyEquals.entities.Count; num34++)
							{
								for (int num35 = 0; num35 < entitiesWherePropertyEquals.entities[num34].events.Count; num35++)
								{
									entitiesWherePropertyEquals.entities[num34].events[num35].Reveal();
								}
							}
							return;
						}
						...
						if (Wish == "glass")
						{
							...
							for (int num36 = 0; num36 < entitiesWithProperty.entities.Count; num36++)
							{
								HistoricEntitySnapshot currentSnapshot2 = entitiesWithProperty.entities[num36].GetCurrentSnapshot();
						...
						if (Wish.StartsWith("findmod:"))
						{
							...
							if (!modBySpec.IsApproved)
							{
								list11.Add("unapproved");
							}
						...
						if (Wish.StartsWith("randomrelic:"))
						{
							...
							for (int num37 = 0; num37 < Convert.ToInt32(array9[1]); num37++)
							{
						...
						if (Wish == "sultanrelics")
						{
							...
							for (int num38 = 0; num38 < entitiesWithProperty2.entities.Count; num38++)
							{
								HistoricEntitySnapshot currentSnapshot3 = entitiesWithProperty2.entities[num38].GetCurrentSnapshot();
						...
						if (Wish == "relic")
						{
							...
							for (int num39 = 0; num39 < entitiesWithProperty3.entities.Count; num39++)
							{
								HistoricEntitySnapshot currentSnapshot4 = entitiesWithProperty3.entities[num39].GetCurrentSnapshot();
						...
						if (Wish == "testearl")
						{
							...
							{
								list16.Add(Faction.GetFormattedName(list15[num40]));
							}
							...
							string text16 = "";
							for (int num41 = 0; num41 < list15.Count; num41++)
							{
								text16 = text16 + list15[num41] + ", ";
							}
						...
						if (Wish == "bookfuck")
						{
							for (int num42 = 0; num42 < 10; num42++)
							{
								...
								File.WriteAllText(DataManager.SavePath("book_" + num42 + ".rtf"), stringBuilder15.ToString());
							}
							return;
						}
						if (Wish == "bookfuckonefile")
						{
							...
							for (int num43 = 0; num43 < 300; num43++)
							{
						...
						if (Wish == "objtest")
						{
							...
							for (int num47 = 0; num47 < 100; num47++)
							{
						...
						if (Wish.StartsWith("spawn:"))
						{
							...
							for (int num48 = 0; num48 < 16; num48++)
							{
						...
						if (Wish == "sultanmuralwalltest2")
						{
							...
							for (int num49 = 0; num49 < 12; num49++)
							{
								Cell cell6 = parentZone3.GetCell(num49, 0);
								cell6.ClearWalls();
						...
						if (Wish.StartsWith("redrock:"))
						{
							...
							The.Player.SystemMoveTo(The.ZoneManager.GetZone(zoneID4).GetCell(40, 24), null);
							return;
						}
						if (Wish == "ensurevoids")
						{
						...
						if (Wish == "ydfreehold")
						{
							...
							The.Player.SystemMoveTo(The.ZoneManager.GetZone(zoneID5).GetCell(40, 23), null);
							return;
						}
						if (Wish == "eyn")
						{
							string zoneID6 = "JoppaWorld.76.5.1.1.10";
							The.Player.SystemMoveTo(The.ZoneManager.GetZone(zoneID6).GetCell(40, 14), null);
							return;
						}
						if (Wish == "moonstair")
						{
							string zoneID7 = "JoppaWorld.75.13.1.1.10";
							The.Player.SystemMoveTo(The.ZoneManager.GetZone(zoneID7).GetCell(40, 24), null);
							return;
						}
						if (Wish == "moonstair2")
						{
							string zoneID8 = "JoppaWorld.76.5.1.1.11";
							The.Player.SystemMoveTo(The.ZoneManager.GetZone(zoneID8).GetCell(31, 9), null);
							return;
						}
						if (Wish == "delaytest")
						{
						...
						if (Wish == "findimportant")
						{
							...
							{
								foreach (GameObject item26 in The.ZoneManager.ActiveZone.FindObjects((GameObject o) => o.HasObjectInInventory((GameObject o) => o.IsImportant())))
								{
									item26.ForeachInventoryAndEquipment(delegate(GameObject obj)
									{
										if (obj.IsImportant())
										{
											MessageQueue.AddPlayerMessage(obj.DisplayName + " at " + obj.CurrentCell.ToString());
										}
									});
								}
								return;
						...
						if (Wish == "fetchimportant")
						{
							...
							foreach (GameObject item28 in The.ZoneManager.ActiveZone.FindObjects((GameObject o) => o.HasObjectInInventory((GameObject o) => o.IsImportant())))
							{
								item28.ForeachInventoryAndEquipment(delegate(GameObject obj)
								{
									if (obj.IsImportant())
									{
										gos.Add(obj);
						...
						if (Wish.StartsWith("deathtestcategory:"))
						{
							foreach (GameObject object3 in The.Player.CurrentZone.GetObjects())
							{
								...
								{
									object3.Die(null, null, null, null, Accidental: false, null, null, Force: false, AlwaysUsePopups: false, null, null, Wish.Split(':')[1]);
								}
							}
							return;
						}
						...
						{
							foreach (GameObject object4 in The.Player.CurrentZone.GetObjects())
							{
								if (object4.IsCombatObject() && !object4.IsPlayer())
								{
									string tile = object4.Render.Tile;
									string tileForegroundColor = object4.Render.GetTileForegroundColor();
									char detailColor = object4.Render.getDetailColor();
									Cell currentCell5 = object4.CurrentCell;
									object4.Die();
						...
						if (Wish.StartsWith("gosecret:"))
						{
							...
							string zoneID9 = ((from n in JournalAPI.GetAllNotes()
								where n.ID == secretID
								select n).First() as JournalMapNote).ZoneID;
							The.Player.SystemLongDistanceMoveTo(The.ZoneManager.GetZone(zoneID9).GetCell(40, 24), null);
							return;
						}
						if (Wish == "go:shuglair")
						{
							string zoneID10 = ((from n in JournalAPI.GetAllNotes()
								where n.ID == "$shugruithlair"
								select n).First() as JournalMapNote).ZoneID;
							The.Player.SystemLongDistanceMoveTo(The.ZoneManager.GetZone(zoneID10).GetCell(40, 24), null);
							return;
						}
						if (Wish == "go:shug")
						{
							string zoneID11 = ((from n in JournalAPI.GetAllNotes()
								where n.ID == "$shugruithmouth"
								select n).First() as JournalMapNote).ZoneID;
							The.Player.SystemLongDistanceMoveTo(The.ZoneManager.GetZone(zoneID11).GetCell(40, 24), null);
							return;
						}
						if (Wish == "go:agolgot")
						{
							string zoneID12 = JournalAPI.MapNotes.Find((JournalMapNote x) => x.ID == "$agolgotlair").ZoneID;
							The.Player.SystemLongDistanceMoveTo(The.ZoneManager.GetZone(zoneID12).GetCell(40, 24), null);
							return;
						}
						if (Wish == "go:bethsaida")
						{
							string zoneID13 = JournalAPI.MapNotes.Find((JournalMapNote x) => x.ID == "$bethsaidalair").ZoneID;
							The.Player.SystemLongDistanceMoveTo(The.ZoneManager.GetZone(zoneID13).GetCell(40, 24), null);
							return;
						}
						if (Wish == "go:rermadon")
						{
							string zoneID14 = JournalAPI.MapNotes.Find((JournalMapNote x) => x.ID == "$rermadonlair").ZoneID;
							The.Player.SystemLongDistanceMoveTo(The.ZoneManager.GetZone(zoneID14).GetCell(40, 24), null);
							return;
						}
						if (Wish == "go:qas" || Wish == "go:qon" || Wish == "go:qasqon")
						{
							string zoneID15 = JournalAPI.MapNotes.Find((JournalMapNote x) => x.ID == "$qasqonlair").ZoneID;
							The.Player.SystemLongDistanceMoveTo(The.ZoneManager.GetZone(zoneID15).GetCell(40, 24), null);
							return;
						}
						if (Wish == "techscan")
						{
						...
						if (Wish == "sbtest")
						{
							...
							for (int num52 = 0; num52 < 100000; num52++)
							{
						...
						if (Wish == "tut:joppa")
						{
							...
							The.Player.SystemMoveTo(The.ZoneManager.GetZone("JoppaWorld.11.22.1.1.10").GetCell(37, 22), null);
							return;
						}
						if (Wish == "tut:bear")
						{
						...
						{
							TutorialManager.AdvanceStep(null);
							The.Player.SystemMoveTo(The.ZoneManager.GetZone("JoppaWorld.11.24.1.0.10").GetCell(48, 11), null);
						...
						if (Wish == "tut:worldmap")
						{
							...
							The.Player.SystemMoveTo(The.ZoneManager.GetZone("JoppaWorld").GetCell(11, 24), null);
							return;
						}
						if (Wish == "tut:books")
						{
							TutorialManager.AdvanceStep(null);
							The.Player.SystemMoveTo(The.ZoneManager.GetZone("JoppaWorld.11.24.1.0.11").GetCell(38, 17), null);
						...
						if (Wish == "forcethawcurrent")
						{
							...
							The.Player.SystemMoveTo(null, null);
						...
						if (Wish == "eventtest")
						{
							...
							for (int num54 = 0; num54 < 100000; num54++)
							{
						...
						if (Wish == "shove")
						{
							...
							The.Player.GetCurrentCell().GetCellFromDirection(direction).GetObjectsWithPart("Physics")[0].Move(direction, Forced: true, System: false, IgnoreGravity: false, NoStack: false, AllowDashing: true, DoConfirmations: true, null, null, NearestAvailable: false, null, null, null);
							return;
						}
						...
						if (Wish == "filljournal")
						{
							for (int num61 = 0; num61 < 100; num61++)
							{
						...
						if (Wish == "wavetilegen")
						{
							GameManager.Instance.uiQueue.queueTask(delegate
							{
								...
								for (int num62 = 0; num62 < currentZone7.Height; num62++)
								{
									for (int num63 = 0; num63 < currentZone7.Width; num63++)
									{
										Cell cell7 = currentZone7.GetCell(num63, num62);
										if (cell7.HasWall())
										{
											texture2D.SetPixel(num63, num62, new Color32(0, 0, 0, byte.MaxValue));
										}
										else if (cell7.HasObjectWithPart("Combat"))
										{
											texture2D.SetPixel(num63, num62, new Color32(byte.MaxValue, 0, 0, byte.MaxValue));
										}
										else if (cell7.HasObjectWithPart("LiquidVolume"))
										{
											texture2D.SetPixel(num63, num62, new Color32(0, 0, byte.MaxValue, byte.MaxValue));
										}
										else if (cell7.HasObjectWithPart("PlantProperties"))
										{
											texture2D.SetPixel(num63, num62, new Color32(0, byte.MaxValue, 0, byte.MaxValue));
										}
										else if (cell7.HasObjectWithPart("Door"))
										{
											texture2D.SetPixel(num63, num62, new Color32(byte.MaxValue, byte.MaxValue, 0, byte.MaxValue));
										}
										else if (cell7.HasObjectWithPart("Furniture"))
										{
											texture2D.SetPixel(num63, num62, new Color32(byte.MaxValue, 0, byte.MaxValue, byte.MaxValue));
										}
										else
										{
											texture2D.SetPixel(num63, num62, new Color32(byte.MaxValue, byte.MaxValue, byte.MaxValue, byte.MaxValue));
										}
									}
								}
						...
						{
							The.ActiveZone.ForeachObject(delegate(GameObject obj)
							{
								if (obj.TryGetPart<GenericInventoryRestocker>(out var Part))
								{
									Part.PerformRestock();
						...
						else if (Wish == "clone")
						{
							...
							if (text26 != null)
							{
								...
								{
									GameObject @object = who.DeepCopy();
									cellFromDirection.AddObject(@object);
								}
							}
						}
						else if (Wish == "copy")
						...
						else
						{
							if (Wish == "yoink")
							{
								...
								{
									foreach (GameObject object5 in cellFromDirection4.Objects)
									{
										object5.SystemMoveTo(physics2.currentCell, null);
									}
									return;
								}
							}
							...
							else if (Wish == "dismiss")
							{
								...
								if (cellFromDirection6 != null)
								{
									...
									if (firstObjectWithPart2 != null)
									{
										...
										MessageQueue.AddPlayerMessage(firstObjectWithPart2.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " no longer your follower.");
									}
								}
							}
							else if (Wish == "beguile")
							{
								...
								if (cellFromDirection7 != null)
								{
									...
									if (firstObjectWithPart3 != null)
									{
										...
										MessageQueue.AddPlayerMessage(firstObjectWithPart3.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " now your follower.");
									}
								}
							}
							...
							else if (Wish.StartsWith("item:"))
							{
								...
								if (array20.Length > 2)
								{
									num66 = Convert.ToInt32(array20[2]);
								}
								...
								{
									cell8.AddObject(GameObjectFactory.Factory.CreateObject(result, 0, 0, null, null, null, "Wish"));
								}
							}
							else if (Wish.StartsWith("understandpartial:"))
							{
								...
								GameObject gameObject19 = GameObjectFactory.Factory.CreateObject(result2, 0, 0, null, null, null, "Wish");
								gameObject19.SetIntProperty("PartiallyUnderstood", 1);
								Cell cell9 = who.GetCurrentCell();
								if (!array21.Contains("here"))
								{
									cell9 = cell9.GetFirstEmptyAdjacentCell();
								}
								cell9.AddObject(gameObject19);
							}
							...
							else
							{
								...
								if (Wish == "objdump")
								{
									...
									{
										string text35 = "?";
										GameObject gameObject20 = GameObjectFactory.Factory.CreateObject(key4, -200);
										if (gameObject20.HasPart("Description"))
										{
											text35 = gameObject20.GetPart<Description>()._Short;
										}
										gameObject20.MakeUnderstood();
										string displayNameOnly = gameObject20.DisplayNameOnly;
								...
								else if (wishResult2.Type == WishResultType.Blueprint)
								{
									...
									for (int num69 = 0; num69 < num68; num69++)
									{
										foreach (Cell adjacentCell in who.CurrentCell.GetAdjacentCells())
										{
											...
											{
												GameObject gameObject21 = GameObjectFactory.Factory.CreateObject(wishResult2.Result, 0, 0, null, null, null, "Wish");
												adjacentCell.AddObject(gameObject21);
												gameObject21.MakeActive();
												flag5 = true;
												break;
											}
										}
								...
								else
								{
									...
									Cell cell10 = null;
									for (int num70 = zone5.Height - 2; num70 >= 0; num70--)
									{
										for (int num71 = zone5.Width / 2; num71 >= 0; num71--)
										{
											Cell cell11 = zone5.GetCell(num71, num70);
											if (cell11.IsReachable() && cell11.IsEmptyOfSolid())
											{
												cell10 = cell11;
												break;
											}
											Cell cell12 = zone5.GetCell(40 - num71, num70);
											if (cell12.IsReachable() && cell12.IsEmptyOfSolid())
											{
												cell10 = cell12;
												break;
											}
