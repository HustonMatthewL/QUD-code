	...
	public static class Flight
	{
		...
		public static bool StartFlying(GameObject Source, GameObject Object, IFlightSource FS = null)
		{
			...
			if (Object.GetEffectCount(typeof(Flying)) == 0)
			{
				...
				{
					MessageQueue.AddPlayerMessage(Object.Does("begin", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " flying.");
				}
			...
			Object.ToggleActivatedAbility(FS.FlightActivatedAbilityID, Silent: false, null);
		...
		public static bool StopFlying(GameObject Source, GameObject Object, IFlightSource FS = null, bool Silent = false, bool FromFail = false)
		{
			...
			if (!Silent)
			{
				if (effectCount <= 1)
				{
					...
					{
						MessageQueue.AddPlayerMessage(Object.Does("return", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " to the ground.");
					}
				}
				else if (Object.IsPlayer())
				{
		...
		public static bool FailFlying(GameObject Source, GameObject Object, IFlightSource FS = null)
		{
			...
			if (effectCount <= 1)
			{
				...
				{
					MessageQueue.AddPlayerMessage(Object.Does("fall", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " to the ground.");
				}
			}
			else if (Object.IsPlayer())
			{
