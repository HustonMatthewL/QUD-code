...
namespace XRL.World.Capabilities
{
	public static class Cloning
	{
		...
		private static GameObject StartBuddedClone(GameObject Original, GameObject Clone)
		{
			...
			{
				Popup.Show(Clone.Does("detach", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: true, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " from you!");
			...
			{
				MessageQueue.AddPlayerMessage(Clone.Does("detach", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: true, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " from " + Original.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + "!");
			}
			return Clone;
		}
