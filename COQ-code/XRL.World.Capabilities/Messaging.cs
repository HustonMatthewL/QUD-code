	...
	public static class Messaging
	{
		...
		public static void XDidY(GameObject Actor, string Verb, string Extra = null, string EndMark = null, string SubjectOverride = null, string Color = null, GameObject ColorAsGoodFor = null, GameObject ColorAsBadFor = null, bool UseFullNames = false, bool IndefiniteSubject = false, GameObject SubjectPossessedBy = null, GameObject Source = null, bool DescribeSubjectDirection = false, bool DescribeSubjectDirectionLate = false, bool AlwaysVisible = false, bool FromDialog = false, bool UsePopup = false, GameObject UseVisibilityOf = null)
		{
			...
			if (SubjectPossessedBy != null && (value2.IsNullOrEmpty() || DescribeSubjectDirectionLate))
			{
				...
				{
					bool @short = !UseFullNames;
					text = Grammar.MakePossessive(SubjectPossessedBy.One(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, !UseFullNames, @short, BaseOnly: false, IndefiniteSubject, null, IndicateHidden: true, SecondPerson: true, Reflexive: false, null));
				}
			...
			else
			{
				...
				if (gameObject != null)
				{
					...
					{
						bool @short = !UseFullNames;
						text = Grammar.MakePossessive(gameObject.One(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, !UseFullNames, @short, BaseOnly: false, IndefiniteSubject, null, IndicateHidden: true, SecondPerson: true, Reflexive: false, null));
					}
					withIndefiniteArticle = false;
				}
			}
			if (SubjectOverride == null)
			{
				...
				{
					bool @short = !UseFullNames;
					stringBuilder2.Append(Actor.One(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, !UseFullNames, @short, BaseOnly: false, withIndefiniteArticle, text, IndicateHidden: true, SecondPerson: true, Reflexive: false, null));
				}
			}
			...
			if (!value2.IsNullOrEmpty() && !DescribeSubjectDirectionLate)
			{
				if (SubjectPossessedBy != null && (Actor == null || !Actor.HasProperName))
				{
					...
					bool @short = !UseFullNames;
					stringBuilder3.Append(SubjectPossessedBy.one(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, !UseFullNames, @short, BaseOnly: false, IndefiniteSubject, null, IndicateHidden: true, SecondPerson: true, Reflexive: false, null)).Append(' ').Append(value2);
				}
				else
				{
		...
		public static void XDidYToZ(GameObject Actor, string Verb, string Preposition = null, GameObject Object = null, string Extra = null, string EndMark = null, string SubjectOverride = null, string Color = null, GameObject ColorAsGoodFor = null, GameObject ColorAsBadFor = null, bool UseFullNames = false, bool IndefiniteSubject = false, bool IndefiniteObject = false, bool IndefiniteObjectForOthers = false, bool PossessiveObject = false, GameObject SubjectPossessedBy = null, GameObject ObjectPossessedBy = null, GameObject Source = null, bool DescribeSubjectDirection = false, bool DescribeSubjectDirectionLate = false, bool AlwaysVisible = false, bool FromDialog = false, bool UsePopup = false, GameObject UseVisibilityOf = null)
		{
			...
			try
			{
				...
				if (SubjectOverride == null && Actor != null && Actor.IsPlayer())
				{
					...
					else
					{
						...
						if (ObjectPossessedBy != null)
						{
							...
							{
								@short = !UseFullNames;
								defaultDefiniteArticle = Grammar.MakePossessive(ObjectPossessedBy.One(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, !UseFullNames, @short, BaseOnly: false, IndefiniteSubject, null, IndicateHidden: true, SecondPerson: true, Reflexive: false, null));
							}
							withIndefiniteArticle = false;
						}
						GameObject gameObject = Object;
						@short = !UseFullNames;
						string text = gameObject.one(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, !UseFullNames, @short, BaseOnly: false, withIndefiniteArticle, defaultDefiniteArticle, IndicateHidden: true, SecondPerson: true, Reflexive: false, null);
						if (PossessiveObject)
						{
				...
				if (SubjectPossessedBy != null && (value3.IsNullOrEmpty() || DescribeSubjectDirectionLate))
				{
					...
					{
						bool @short = !UseFullNames;
						text2 = Grammar.MakePossessive(SubjectPossessedBy.One(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, !UseFullNames, @short, BaseOnly: false, IndefiniteSubject, null, IndicateHidden: true, SecondPerson: true, Reflexive: false, null));
					}
				}
				else
				{
					...
					if (gameObject2 != null)
					{
						...
						{
							bool @short = !UseFullNames;
							text2 = Grammar.MakePossessive(gameObject2.One(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, !UseFullNames, @short, BaseOnly: false, IndefiniteSubject, null, IndicateHidden: true, SecondPerson: true, Reflexive: false, null));
						}
				...
				if (SubjectOverride == null)
				{
					...
					{
						bool @short = !UseFullNames;
						stringBuilder2.Append(Actor.One(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, !UseFullNames, @short, BaseOnly: false, withIndefiniteArticle2, text2, IndicateHidden: true, SecondPerson: true, Reflexive: false, null));
					}
				}
				else if (stringBuilder2.Length > 0)
				{
				...
				if (!value3.IsNullOrEmpty() && !DescribeSubjectDirectionLate)
				{
					if (SubjectPossessedBy != null && (Actor == null || !Actor.HasProperName))
					{
						StringBuilder stringBuilder3 = stringBuilder2.Append(" of ");
						bool @short = !UseFullNames;
						stringBuilder3.Append(SubjectPossessedBy.one(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, !UseFullNames, @short, BaseOnly: false, IndefiniteSubject, null, IndicateHidden: true, SecondPerson: true, Reflexive: false, null)).Append(' ').Append(value3);
					}
					else
					{
				...
				else
				{
					...
					if (ObjectPossessedBy != null)
					{
						...
						{
							@short = !UseFullNames;
							defaultDefiniteArticle2 = Grammar.MakePossessive(ObjectPossessedBy.One(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, !UseFullNames, @short, BaseOnly: false, IndefiniteObject, null, IndicateHidden: true, SecondPerson: true, Reflexive: false, null));
						}
						withIndefiniteArticle3 = false;
					}
					GameObject gameObject3 = Object;
					@short = !UseFullNames;
					string text3 = gameObject3.one(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, !UseFullNames, @short, BaseOnly: false, withIndefiniteArticle3, defaultDefiniteArticle2, IndicateHidden: true, SecondPerson: true, Reflexive: false, null);
					if (PossessiveObject)
					{
		...
		public static void WDidXToYWithZ(GameObject Actor, string Verb, string DirectPreposition, GameObject DirectObject, string IndirectPreposition, GameObject IndirectObject, string Extra = null, string EndMark = null, string SubjectOverride = null, string Color = null, GameObject ColorAsGoodFor = null, GameObject ColorAsBadFor = null, bool UseFullNames = false, bool IndefiniteSubject = false, bool IndefiniteDirectObject = false, bool IndefiniteIndirectObject = false, bool IndefiniteDirectObjectForOthers = false, bool IndefiniteIndirectObjectForOthers = false, bool PossessiveDirectObject = false, bool PossessiveIndirectObject = false, GameObject SubjectPossessedBy = null, GameObject DirectObjectPossessedBy = null, GameObject IndirectObjectPossessedBy = null, GameObject Source = null, bool DescribeSubjectDirection = false, bool DescribeSubjectDirectionLate = false, bool AlwaysVisible = false, bool FromDialog = false, bool UsePopup = false, GameObject UseVisibilityOf = null)
		{
			...
			if (SubjectOverride == null && Actor != null && Actor.IsPlayer())
			{
				...
				else
				{
					...
					bool @short = !UseFullNames;
					string text2 = gameObject2.one(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, !UseFullNames, @short, BaseOnly: false, withIndefiniteArticle2, defaultDefiniteArticle2, IndicateHidden: true, SecondPerson: true, Reflexive: false, null);
			...
			if (SubjectPossessedBy != null && (value3.IsNullOrEmpty() || DescribeSubjectDirectionLate))
			{
				...
				{
					bool @short = !UseFullNames;
					text3 = Grammar.MakePossessive(SubjectPossessedBy.One(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, !UseFullNames, @short, BaseOnly: false, IndefiniteSubject, null, IndicateHidden: true, SecondPerson: true, Reflexive: false, null));
				}
				withIndefiniteArticle3 = false;
			}
			else
			{
				...
				if (gameObject3 != null)
				{
					...
					{
						bool @short = !UseFullNames;
						text3 = Grammar.MakePossessive(gameObject3.One(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, !UseFullNames, @short, BaseOnly: false, IndefiniteSubject, null, IndicateHidden: true, SecondPerson: true, Reflexive: false, null));
					}
					withIndefiniteArticle3 = false;
				}
			}
			if (SubjectOverride == null)
			{
				...
				{
					bool @short = !UseFullNames;
					stringBuilder2.Append(Actor.One(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, !UseFullNames, @short, BaseOnly: false, withIndefiniteArticle3, text3, IndicateHidden: true, SecondPerson: true, Reflexive: false, null));
				}
			}
			else if (stringBuilder2.Length > 0)
			{
			...
			else
			{
				...
				bool @short = !UseFullNames;
				string text4 = gameObject4.one(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, !UseFullNames, @short, BaseOnly: false, withIndefiniteArticle4, defaultDefiniteArticle3, IndicateHidden: true, SecondPerson: true, Reflexive: false, null);
				if (PossessiveDirectObject)
				{
			...
			else
			{
				...
				bool @short = !UseFullNames;
				string text5 = gameObject5.one(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, !UseFullNames, @short, BaseOnly: false, withIndefiniteArticle5, defaultDefiniteArticle4, IndicateHidden: true, SecondPerson: true, Reflexive: false, null);
				if (PossessiveIndirectObject)
				{
