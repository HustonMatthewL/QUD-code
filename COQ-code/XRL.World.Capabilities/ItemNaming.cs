...
namespace XRL.World.Capabilities
{
	...
	public static class ItemNaming
	{
			...
			do
			{
				...
				if (list.Count > 1)
				{
					if (Owner.IsPlayer())
					{
						...
						if (num2 >= 0)
						{
							@object = list3[num2] as GameObject;
						}
					}
					else
					{
						...
						@object = dictionary.GetRandomElement();
					}
				}
				...
				flag2 = NameItem(@object, Owner, Kill, InfluencedBy, ZoneID, OpportunityType);
			}
		...
		private static string GenerateRelicStyleName(GameObject Object, GameObject Owner, GameObject Kill, GameObject InfluencedBy, string ZoneID, ref string Element, ref string Type)
		{
			...
			string text2 = ((Kill != null && Kill.HasProperName && 30.in100()) ? Kill.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: false, Reflexive: false, null) : ((InfluencedBy != null && InfluencedBy.HasProperName && 50.in100()) ? InfluencedBy.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: false, Reflexive: false, null) : Owner.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: false, Reflexive: false, null)));
		...
		public static bool? NameItem(GameObject Object, GameObject Owner, GameObject Kill = null, GameObject InfluencedBy = null, string ZoneID = null, string OpportunityType = "General", bool CanBestow = true)
		{
			...
			if (Owner.IsPlayer())
			{
				...
				while (true)
				{
					int num = Popup.PickOption("", "Rename " + Object.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", "", "Sounds/UI/ui_notification", list.ToArray(), list2.ToArray(), null, null, null, null, null, 1, 60, 0, -1, !BestowalsPossible);
					if (num < 0)
					{
						return null;
					}
					...
					{
					case 0:
						text2 = Popup.AskString("Enter a new name for " + Object.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", "", "Sounds/UI/ui_notification", "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789 -+/#()!@$%*<>'", null, 30, 0, ReturnNullForEscape: false, EscapeNonMarkupFormatting: true, null);
					...
					case 1:
						...
						break;
					case 2:
						text2 = NameMaker.MakeName(Owner, null, null, null, null, null, null, null, null, null, "Item", null, null, FailureOkay: false, SpecialFaildown: true, null, null);
						break;
					case 3:
						text2 = NameMaker.MakeName(Kill, null, null, null, null, null, null, null, null, null, "Item", null, null, FailureOkay: false, SpecialFaildown: true, null, null);
						break;
					case 4:
						text2 = NameMaker.MakeName(InfluencedBy, null, null, null, null, null, null, null, null, null, "Item", null, null, FailureOkay: false, SpecialFaildown: true, null, null);
						break;
					}
					break;
				}
				text3 = Popup.ShowColorPicker("", 0, "You select the name '" + text2 + "' for " + Object.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ". Choose a color for " + Object.them + ".", 60, RespectOptionNewlines: false, !BestowalsPossible, null, "", includeNone: true, includePatterns: true, allowBackground: false, text2);
				if (text3 == null)
				{
					return null;
				}
		...
		public static bool NameItem(GameObject Object, GameObject Owner, string Name, string Color = null, string Element = null, string Type = null, bool UseAnsify = false, bool CanBestow = false, GameObject Kill = null, GameObject InfluencedBy = null, string OpportunityType = "General", bool BestowalsChecked = false, int DidBasicBestowals = 0, bool DidElementBestowal = false)
		{
			...
			string displayName = Object.GetDisplayName(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, ColorOnly: false, Visible: true, WithoutTitles: false, ForSort: false, Short: true, BaseOnly: false, WithIndefiniteArticle: false, WithDefiniteArticle: false, null, IndicateHidden: false, Capitalize: false, SecondPerson: false, Reflexive: false, null);
			string text = Object.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null);
			if (Owner.IsPlayer())
			{
				Popup.Show("You name " + Object.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " '" + Name + "'.");
			}
			Object.RequirePart<OriginalItemType>();
			Object.SplitStack(1, Owner);
			Object.GiveProperName(Name, Force: true, null, SpecialFaildown: false, null, null);
		...
		private static void CheckBestowals(GameObject Owner, GameObject Object, string Type, string Element, GameObject Kill, GameObject InfluencedBy, string OpportunityType, out bool BestowalsPossible, out int DidBasicBestowals, out bool DidElementBestowal)
		{
			...
			{
				int @for = GetNamingBestowalChanceEvent.GetFor(Owner, Object, GlobalConfig.GetIntSetting("ItemNamingBestowalBaseChance"));
				if (@for > 0)
				{
					BestowalsPossible = true;
				}
				if (Owner.IsPlayer() ? @for.in100(Stat.NamingRnd) : @for.in100())
				{
					num++;
					if (Owner.IsPlayer() ? @for.in100(Stat.NamingRnd) : @for.in100())
					{
			...
			if (num2 == -1)
			{
				int num3 = Owner.Stat("Level");
				num2 = Tier.Constrain(Stat.Random((num3 < 20) ? 1 : 2, 1 + num3 / 5));
			}
			...
			if (Object2 != null)
			{
				...
				flag2 = Object2.FireEvent(@event);
			}
			try
			{
				for (int i = 0; i < num; i++)
				{
					if (RelicGenerator.ApplyBasicBestowal(Object, Type, num2, text, Standard: false, ShowInShortDescription: true))
					{
						DidBasicBestowals++;
					}
				}
				...
				if (flag)
				{
					...
					{
						DidElementBestowal = RelicGenerator.ApplyElementBestowal(Object, Element, Type, num2, text);
					}
				}
				if ((DidBasicBestowals > 0) | DidElementBestowal)
				{
					...
					if (Owner.IsPlayer())
					{
						Popup.Show(Object.Does("seem", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " to have taken on new qualities.");
						InventoryActionEvent.Check(Object, Owner, Object, "Look");
					}
					AfterPseudoRelicGeneratedEvent.Send(Object, Element, Type, text, num2);
				}
			}
			finally
			{
