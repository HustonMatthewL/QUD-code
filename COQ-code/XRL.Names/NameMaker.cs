...
namespace XRL.Names
{
	public class NameMaker
	{
		...
		public static string Eater()
		{
			if (If.Chance(50))
			{
				return MakeName(null, null, null, null, "Eater", null, null, null, null, null, null, null, null, FailureOkay: false, SpecialFaildown: false, null, null);
			}
			return MakeName(EncountersAPI.GetASampleCreature(), null, null, null, null, null, null, null, null, null, null, null, null, FailureOkay: false, SpecialFaildown: false, null, null);
		}
