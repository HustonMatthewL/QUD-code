...
public static class Extensions
{
	...
	public static DelimitedStringEnumerator DelimitedBy(this string Value, char Separator)
	{
		return new DelimitedStringEnumerator(Value, Separator);
	}

	public static DelimitedSpanEnumerator DelimitedBy(this ref ReadOnlySpan<char> Value, char Separator)
	{
		return new DelimitedSpanEnumerator(ref Value, Separator);
	}
	...
	public static void AsDelimitedSpans(this string Text, char Separator, out ReadOnlySpan<char> First, out ReadOnlySpan<char> Second)
	{
		...
		Second = null;
		int num = 0;
		DelimitedStringEnumerator enumerator = Text.DelimitedBy(Separator).GetEnumerator();
	...
	public static void Split(this ReadOnlySpan<char> Text, char Separator, out ReadOnlySpan<char> First, out ReadOnlySpan<char> Second)
	{
		...
		Second = null;
		int num = 0;
		DelimitedSpanEnumerator enumerator = Text.DelimitedBy(Separator).GetEnumerator();
		while (enumerator.MoveNext())
		{
			ReadOnlySpan<char> current = enumerator.Current;
			if (++num == 1)
	...
	public static ref Utf16ValueStringBuilder Compound(this ref Utf16ValueStringBuilder SB, string Value, char With)
	{
		if (SB.Length > 0)
		{
			SB.Append(With);
	...
	public static ref Utf16ValueStringBuilder Compound(this ref Utf16ValueStringBuilder SB, string Value)
	{
		if (SB.Length > 0)
		{
			SB.Append(' ');
