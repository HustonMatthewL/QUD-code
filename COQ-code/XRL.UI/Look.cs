...
namespace XRL.UI
{
	...
	public class Look : IWantsTextConsoleInit
	{
		...
		public static TooltipInformation GenerateTooltipInformation(XRL.World.GameObject go)
		{
			...
			TooltipInformation result = default(TooltipInformation);
			result.DisplayName = go.GetDisplayName(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, ColorOnly: false, Visible: true, WithoutTitles: false, ForSort: false, Short: false, BaseOnly: false, WithIndefiniteArticle: false, go.HasProperName, null, IndicateHidden: false, Capitalize: false, SecondPerson: false, Reflexive: false, null);
			result.FeelingText = part.GetFeelingDescription();
			result.DifficultyText = part.GetDifficultyDescription();
			result.WoundLevel = Strings.WoundLevel(go);
			result.LongDescription = stringBuilder.ToString();
			result.IconRenderable = go.RenderForUI();
			return result;
		}
					...
					if (!Options.ModernUI)
					{
						if (gameObject2 != null && description != null)
						{
							if (gameObject != gameObject2)
							{
								...
								string displayName = gameObject2.GetDisplayName(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, ColorOnly: false, Visible: true, WithoutTitles: false, ForSort: false, Short: false, BaseOnly: false, WithIndefiniteArticle: false, gameObject2.HasProperName, null, IndicateHidden: false, Capitalize: false, SecondPerson: false, Reflexive: false, null);
