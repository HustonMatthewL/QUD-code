	...
	public class LifeDrain : Effect, ITierInitialized
	{
		...
		public override bool Apply(GameObject Object)
		{
			...
			else if (Object.IsPlayerLed() && !Object.IsTrifling)
			{
				...
				{
					AutoAct.Interrupt("you hear a cry of distress from " + Object.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null), null, Object, IsThreat: true);
				}
			}
			return true;
		}
		...
		public override bool HandleEvent(EndTurnEvent E)
		{
			...
			if (RealityDistortionBased && (!IComponent<GameObject>.CheckRealityDistortionUsability(Drainer, null, Drainer, null, Drainer.GetPart<XRL.World.Parts.Mutation.LifeDrain>(), null) || !IComponent<GameObject>.CheckRealityDistortionAccessibility(base.Object, null, Drainer, null, Drainer.GetPart<XRL.World.Parts.Mutation.LifeDrain>())))
			{
				Duration = 0;
				return true;
			}
			if (Duration > 0)
			{
				...
				{
					IComponent<GameObject>.AddPlayerMessage(base.Object.Does("resist", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " your life drain!", 'r');
				}
