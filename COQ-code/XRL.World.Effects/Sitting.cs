...
namespace XRL.World.Effects
{
	...
	public class Sitting : Effect, ITierInitialized
	{
		...
		public Sitting(GameObject SittingOn)
		{
			...
			Duration = 1;
			DisplayName = "{{C|sitting on " + SittingOn.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + "}}";
		}
		...
		public override bool HandleEvent(GetDisplayNameEvent E)
		{
			if (!E.Reference)
			{
				...
				if (SittingOn != null)
				{
					E.AddTag("[{{B|sitting on " + SittingOn.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + "}}]", 20);
				}
				else
				{
