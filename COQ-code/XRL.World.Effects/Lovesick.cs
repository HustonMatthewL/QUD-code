	...
	public class Lovesick : Effect, ITierInitialized
	{
		...
		public override bool Apply(GameObject Object)
		{
			...
			if (Object.IsPlayer())
			{
				...
				JournalAPI.AddAccomplishment("Your heart sang at the sight of " + Beauty.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", "The troubadour-hero =name= rode the tides of " + The.Player.GetPronounProvider().PossessiveAdjective + " passions and shipwrecked on the shores of " + Beauty.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", "<spice.elements." + The.Player.GetMythicDomain() + ".weddingConditions.!random.capitalize>, =name= cemented " + The.Player.GetPronounProvider().PossessiveAdjective + " friendship with " + Object.GetPrimaryFactionName(VisibleOnly: true, Formatted: true, Base: true) + " by marrying " + Object.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", null, "general", MuralCategory.CommitsFolly, MuralWeight.High, null, -1L);
			}
		...
		public override void Remove(GameObject Object)
		{
			...
			{
				JournalAPI.AddAccomplishment("Though your affection for " + Beauty.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " endowed you with a certain wisdom, you no longer feel the tug on your heartstrings.", "The call of the sea rang through the troubadour-hero =name= once again, and " + The.Player.GetPronounProvider().Subjective + " set sail from the familiar shore of " + Beauty.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", "<spice.elements." + The.Player.GetMythicDomain() + ".weddingConditions.!random.capitalize>, =name= cemented " + The.Player.GetPronounProvider().PossessiveAdjective + " friendship with " + Object.GetPrimaryFactionName(VisibleOnly: true, Formatted: true, Base: true) + " by annulling " + The.Player.GetPronounProvider().PossessiveAdjective + " marriage to " + Object.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", null, "general", MuralCategory.HasInspiringExperience, MuralWeight.High, null, -1L);
			}
		}
