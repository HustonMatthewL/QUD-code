	...
	public class Budding : Effect, ITierInitialized
	{
		...
		public override bool Apply(GameObject Object)
		{
			...
			if (Visible())
			{
				...
				{
					IComponent<GameObject>.AddPlayerMessage("A grotesque protuberance swells from " + Object.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " as " + Object.does("begin", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: true, SecondPerson: true, null) + " to bud!");
				}
			}
			return true;
		}
