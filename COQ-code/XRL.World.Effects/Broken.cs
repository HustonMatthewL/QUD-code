...
namespace XRL.World.Effects
{
	...
	public class Broken : Effect, ITierInitialized, IBusted
	{
		...
		public override bool FireEvent(Event E)
		{
			...
			{
				string text = "You can't equip " + base.Object.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", " + base.Object.itis + " broken!";
