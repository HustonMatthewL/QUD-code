	...
	public class Exhausted : Effect, ITierInitialized
	{
		...
		public override bool HandleEvent(IsConversationallyResponsiveEvent E)
		{
			if (E.Speaker == base.Object)
			{
				...
				{
					E.Message = base.Object.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + base.Object.GetVerb("stare") + " at you dully.";
				}
				return false;
			}
			return base.HandleEvent(E);
