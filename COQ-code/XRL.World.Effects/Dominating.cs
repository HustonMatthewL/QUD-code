	...
	public class Dominating : Effect
	{
		...
		public override bool HandleEvent(IsConversationallyResponsiveEvent E)
		{
			if (E.Speaker == base.Object && GameObject.Validate(ref Target))
			{
				...
				{
					E.Message = base.Object.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " utterly unresponsive.";
				}
				return false;
			}
			return base.HandleEvent(E);
