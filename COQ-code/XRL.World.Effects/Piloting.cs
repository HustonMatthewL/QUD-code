...
namespace XRL.World.Effects
{
	...
	public class Piloting : Effect
	{
		...
		public Piloting(GameObject Vehicle)
		{
			...
			DisplayName = "{{C|piloting " + Vehicle.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + "}}";
			Duration = 1;
		}
