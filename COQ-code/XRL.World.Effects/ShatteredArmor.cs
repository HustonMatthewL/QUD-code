...
namespace XRL.World.Effects
{
	...
	public class ShatteredArmor : IShatterEffect, ITierInitialized
	{
		...
		public override bool Apply(GameObject Object)
		{
			...
			{
				IComponent<GameObject>.AddPlayerMessage(Object.Does("were", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " cracked.", 'R');
			}
			return result;
		}
