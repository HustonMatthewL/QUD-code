...
namespace XRL.World.Effects
{
	...
	public class Beguiled : Effect
	{
		...
		public Beguiling GetMutation()
		{
			...
			if (part.RealityDistortionBased && !CheckMyRealityDistortionUsability(null, null, null, null, null, null))
			{
				return null;
			}
			return part;
