	...
	public class Stuck : Effect, ITierInitialized
	{
		...
		public string GetStateDescription(GameObject From = null)
		{
			...
			if (GameObject.Validate(ref From))
			{
				...
				stringBuilder.Append(' ').Append(From.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null));
		...
		public override string GetDetails()
		{
			...
			if (gameObject != null)
			{
				stringBuilder.Append("in ").Append(gameObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null));
			}
			else
			{
