...
namespace XRL.World.Effects
{
	...
	public class Asleep : Effect, ITierInitialized
	{
		...
		public override bool Apply(GameObject Object)
		{
			...
			if (((Voluntary || Object.FireEvent("CanApplyInvoluntarySleep")) && Object.FireEvent("CanApplySleep") && (Voluntary || Object.FireEvent("ApplyInvoluntarySleep")) && Object.FireEvent("ApplySleep") && ApplyEffectEvent.Check(Object, "Sleep", this)) || forced)
			{
				...
				else if (Visible())
				{
					if (UsesSleepMode(Object))
					{
						IComponent<GameObject>.AddPlayerMessage(Object.Does("go", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " into {{C|sleep mode}}.");
					}
					else
					{
						IComponent<GameObject>.AddPlayerMessage(Object.Does("fall", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " {{C|asleep}}.");
					}
				}
			...
			if (E.Command == "WakeSleeper")
			{
				...
				if (CanWake(actor) && actor.CheckFrozen(Telepathic: false, Telekinetic: true))
				{
					...
					if (actor.IsPlayer())
					{
						...
						{
							Popup.Show("You gently shake " + base.Object.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " awake.");
					...
					else if (base.Object.IsPlayer())
					{
						if (UsesSleepMode(base.Object))
						{
							IComponent<GameObject>.AddPlayerMessage(actor.Does("press", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " your activation panel.");
						}
						else
						{
							IComponent<GameObject>.AddPlayerMessage(actor.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " gently" + actor.GetVerb("shake") + " you awake.");
							WakeMessageDone = true;
						}
					}
					else if (Visible())
					{
						if (UsesSleepMode(base.Object))
						{
							IComponent<GameObject>.AddPlayerMessage(actor.Does("press", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " " + base.Object.poss("activation panel") + ".");
						}
						else
						{
							IComponent<GameObject>.AddPlayerMessage(actor.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " gently" + actor.GetVerb("shake") + " " + base.Object.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " awake.");
							WakeMessageDone = true;
						}
					}
					base.Object.RemoveEffect(this);
					actor.UseEnergy(1000, "Physical Action Wake", null, null);
					E.RequestInterfaceExit();
				}
				else if (actor.IsPlayer())
				{
					Popup.Show("You can't figure out how to wake " + base.Object.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				}
			}
			return base.HandleEvent(E);
		}
		...
		public static string GetSleepMessage(GameObject Object, bool Physical = true, bool Mental = false)
		{
			...
			if (UsesSleepMode(Object))
			{
				return Object.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + Object.Is + " utterly unresponsive.";
			}
			return Object.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + Object.GetVerb("snore") + " loudly.";
		}
