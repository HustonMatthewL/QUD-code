	...
	public class HolographicBleeding : Bleeding, ITierInitialized
	{
		...
		public override void StopMessage(GameObject Object)
		{
			if (Object.IsPlayer())
			{
				...
				{
					DidX("realize", "your one of your wounds is an illusion, and the pain from it suddenly stops", null, null, null, Object, null, UseFullNames: false, IndefiniteSubject: false, null, null, DescribeSubjectDirection: false, DescribeSubjectDirectionLate: false, AlwaysVisible: false, FromDialog: false, StopMessageUsePopup);
				}
				else
				{
