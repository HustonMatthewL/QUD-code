	...
	public class VehicleUnpowered : Effect
	{
		...
		public void PreventActionMessage(GameObject Actor)
		{
			...
			if (base.Object.TryGetPart<EnergyCellSocket>(out var Part))
			{
				...
				{
					stringBuilder.Append(Part.Cell.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null)).Append(" drained or nearly drained.\n\n").Append("Recharge or replace " + Part.Cell.it + " to power ")
						.Append(base.Object.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: false, Reflexive: false, null))
						.Append('.');
				}
				else
				{
			...
			{
				stringBuilder.Append(base.Object.Does("lack", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: false, null)).Append(" the power to act.");
			}
