	...
	public class Confused : Effect, ITierInitialized
	{
		...
		public override bool HandleEvent(IsConversationallyResponsiveEvent E)
		{
			if (E.Speaker == base.Object)
			{
				...
				{
					E.Message = base.Object.Does("don't", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " seem to understand you.";
				}
				return false;
			}
			return base.HandleEvent(E);
		...
		public override bool FireEvent(Event E)
		{
			if (E.ID == "BeginTakeAction")
			{
				...
				if (Duration > 0 && !base.Object.IsPlayer())
				{
					...
					if (num <= 50)
					{
						base.Object.Move(Directions.GetRandomDirection(), Forced: false, System: false, IgnoreGravity: false, NoStack: false, AllowDashing: true, DoConfirmations: true, null, null, NearestAvailable: false, null, null, null);
