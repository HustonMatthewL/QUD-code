	...
	public class Rusted : Effect, ITierInitialized, IBusted
	{
		...
		public override bool Apply(GameObject Object)
		{
			...
			if (Object.HasEffect<Rusted>())
			{
				...
				Object.Die(null, null, "You were reduced to dust.", Object.Does("were", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: true, SecondPerson: true, null) + " @@reduced to dust.", Accidental: false, null, null, Force: false, AlwaysUsePopups: false, "");
			}
			else
			{
		...
		public override bool FireEvent(Event E)
		{
			...
			{
				string text = "You can't equip " + base.Object.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ", " + base.Object.itis + " badly rusted!";
