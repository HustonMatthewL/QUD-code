...
namespace XRL.World.Effects
{
	...
	public class Prone : Effect, ITierInitialized
	{
			...
			: this()
		{
			...
			if (LyingOn != null)
			{
				DisplayName = "{{C|lying on " + LyingOn.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + "}}";
			}
		}
		...
		public override string GetDescription()
		{
			...
			if (LyingOn != null)
			{
				return "{{C|lying on " + LyingOn.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + "}}";
			}
			return "{{C|prone}}";
		}
		...
		public override bool HandleEvent(GetDisplayNameEvent E)
		{
			if (!E.Reference)
			{
				...
				if (LyingOn != null)
				{
					E.AddTag("[{{B|lying on " + LyingOn.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + "}}]");
				}
				else
				{
					E.AddTag("[{{B|prone}}]");
		...
		private void StandUp(bool UsePopup = false)
		{
			...
			base.Object.UseEnergy(1000, "Position", null, null);
