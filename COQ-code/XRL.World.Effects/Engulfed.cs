...
namespace XRL.World.Effects
{
	...
	public class Engulfed : Effect
	{
			...
			: this()
		{
			...
			DisplayName = "{{B|engulfed by " + EngulfedBy.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + "}}";
		}
		...
		public bool CheckEngulfedBy(bool AllowDisplayNameUpdate = true)
		{
			...
			{
				DisplayName = "{{B|engulfed by " + EngulfedBy.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + "}}";
			}
			return true;
		}
		...
		public void ApplyChanges()
		{
			...
			Engulfing part = EngulfedBy.GetPart<Engulfing>();
			if (part != null && (!part.MustBeUnderstood || !base.Object.IsPlayer() || EngulfedBy.Understood()) && !part.IsDisabled(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
			{
				ApplyChangesCore();
		...
		public override bool HandleEvent(CanChangeMovementModeEvent E)
		{
			if (E.Object == base.Object && CheckEngulfedBy())
			{
				if (E.ShowMessage)
				{
					E.Object.Fail("You cannot do that while engulfed by " + EngulfedBy.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				}
				return false;
			}
		...
		public override bool HandleEvent(GetDisplayNameEvent E)
		{
			...
			{
				E.AddTag("[{{B|engulfed by " + EngulfedBy.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: true, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + "}}]");
			}
			return base.HandleEvent(E);
		}
		...
		public override bool HandleEvent(EndTurnEvent E)
		{
			if (CheckEngulfedBy())
			{
				...
				if (ChangesWereApplied)
				{
					if (part.IsDisabled(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
					{
						UnapplyChanges();
					}
				}
				else if (!part.IsDisabled(UseCharge: false, IgnoreCharge: false, IgnoreLiquid: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, null))
				{
					ApplyChanges();
				}
			}
