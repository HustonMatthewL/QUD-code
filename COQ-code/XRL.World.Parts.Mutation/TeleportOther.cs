...
namespace XRL.World.Parts.Mutation
{
	...
	public class TeleportOther : BaseMutation
	{
		...
		{
			if (E.Distance <= 1 && IsMyActivatedAbilityAIUsable(ActivatedAbilityID) && GameObject.Validate(E.Target) && IComponent<GameObject>.CheckRealityDistortionAdvisability(E.Actor, E.Target.CurrentCell, E.Actor, null, this, null))
			{
