...
namespace XRL.World.Parts.Mutation
{
	...
	public class Teleportation : BaseMutation
	{
		...
		{
			if (GameObject.Validate(E.Actor) && E.TargetCell != null && IsMyActivatedAbilityAIUsable(ActivatedAbilityID) && CheckMyRealityDistortionAdvisability(null, null, null, null, null, null))
			{
				...
				if (E.StandoffDistance > 0)
				{
					...
					{
						if (!item.IsEmptyOfSolidFor(E.Actor) || !IComponent<GameObject>.CheckRealityDistortionAdvisability(null, item, E.Actor, null, this, null))
						{
							continue;
						}
				...
				{
					Cell randomLocalAdjacentCell = E.TargetCell.GetRandomLocalAdjacentCell((Cell c) => c.IsEmptyOfSolidFor(E.Actor) && IComponent<GameObject>.CheckRealityDistortionAdvisability(null, c, E.Actor, null, this, null) && c.GetNavigationWeightFor(E.Actor) < 10);
				...
				else if (E.Distance > num && IComponent<GameObject>.CheckRealityDistortionAdvisability(null, E.TargetCell, E.Actor, null, this, null))
				{
					E.Add(COMMAND_NAME);
				}
			}
		...
		{
			if (GameObject.Validate(E.Actor) && IsMyActivatedAbilityAIUsable(ActivatedAbilityID) && CheckMyRealityDistortionAdvisability(null, null, null, null, null, null))
			{
				...
				if (E.TargetCell == null)
				{
					if (E.AvoidCell != null || E.Target != null)
					{
						...
						if (avoidCell != null)
						{
							...
							E.Actor.CurrentZone?.ForeachCell(delegate(Cell c)
							{
								try
								{
									if (c != null && c.IsEmptyOfSolidFor(E.Actor) && IComponent<GameObject>.CheckRealityDistortionAdvisability(null, c, E.Actor, null, this, null))
									{
					...
					else
					{
						...
						if (cell2 != null && E.Actor.DistanceTo(cell2) > errorRadius && IComponent<GameObject>.CheckRealityDistortionAdvisability(null, cell2, E.Actor, null, this, null) && cell2.GetNavigationWeightFor(E.Actor) < 10)
						{
				...
				{
					Cell randomLocalAdjacentCellAtRadius = E.TargetCell.GetRandomLocalAdjacentCellAtRadius(E.StandoffDistance, (Cell c) => c.IsEmptyOfSolidFor(E.Actor) && E.Actor.DistanceTo(c) > errorRadius && IComponent<GameObject>.CheckRealityDistortionAdvisability(null, c, E.Actor, null, this, null) && c.GetNavigationWeightFor(E.Actor) < 10);
				...
				{
					Cell randomLocalAdjacentCell = E.TargetCell.GetRandomLocalAdjacentCell((Cell c) => c.IsEmptyOfSolidFor(E.Actor) && E.Actor.DistanceTo(c) > errorRadius && IComponent<GameObject>.CheckRealityDistortionAdvisability(null, c, E.Actor, null, this, null) && c.GetNavigationWeightFor(E.Actor) < 10);
					if (randomLocalAdjacentCell != null)
					{
						E.Add(COMMAND_NAME, 1, null, Inv: false, Self: false, null, randomLocalAdjacentCell);
					}
				}
				else if (E.Distance > errorRadius && IComponent<GameObject>.CheckRealityDistortionAdvisability(null, E.TargetCell, E.Actor, null, this, null))
				{
					E.Add(COMMAND_NAME);
				}
			}
		...
		{
			if (GameObject.Validate(E.Target) && E.Distance > 0 && IsMyActivatedAbilityAIUsable(ActivatedAbilityID) && IComponent<GameObject>.CheckRealityDistortionAdvisability(E.Actor, E.Target.CurrentCell, E.Actor, null, this, null))
			{
				E.Add(COMMAND_NAME);
			}
			return base.HandleEvent(E);
