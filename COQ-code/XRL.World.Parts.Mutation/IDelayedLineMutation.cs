...
namespace XRL.World.Parts.Mutation
{
	...
	public abstract class IDelayedLineMutation : BaseMutation
	{
		...
		public virtual string Label => DisplayName;
		...
		public void Refract(List<Cell> Path)
		{
			...
			for (int i = 1; i < Path.Count; i++)
			{
				...
				GameObject Object = @event.GetGameObjectParameter("By");
				...
				IComponent<GameObject>.XDidYToZ(Object, @event.GetStringParameter("Verb") ?? "refract", Projectile, "!", null, null, null, Object);
