...
namespace XRL.World.Parts.Mutation
{
	...
	public class Beguiling : BaseMutation
	{
			...
			if (cell != null)
			{
				...
				if (gameObject != null && gameObject != who && gameObject.IsValid() && gameObject.HasStat("Level") && gameObject.HasStat("Hitpoints"))
				{
					...
					if (!gameObject.FireEvent("CanApplyBeguile") || !CanApplyEffectEvent.Check(gameObject, "Beguile"))
					{
						if (who.IsPlayer())
						{
							IComponent<GameObject>.AddPlayerMessage(gameObject.Does("seem", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " utterly impervious to your charms.");
						}
						return false;
					}
					...
					if (gameObject.HasEffect(typeof(Beguiled), mutation.OurEffect))
					{
						if (who.IsPlayer())
						{
							IComponent<GameObject>.AddPlayerMessage("You have already beguiled " + gameObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", 'R');
						}
						return false;
					}
					if (gameObject.IsLedBy(who) && who.IsPlayer() && Popup.ShowYesNo(gameObject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " already your follower. Do you want to beguile " + gameObject.them + " anyway?") != 0)
					{
						return false;
					}
		...
		private bool Beguile(MentalAttackEvent E)
		{
			...
			{
				IComponent<GameObject>.AddPlayerMessage("Your coquetry infuriates " + defender.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", 'r');
