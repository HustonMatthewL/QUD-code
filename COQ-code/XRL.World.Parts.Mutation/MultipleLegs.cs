	...
	public class MultipleLegs : BaseMutation, IRankedMutation
	{
		...
		public void AddMoreLegs(GameObject Subject)
		{
			...
			if (firstAttachedPart != null)
			{
				...
				{
					body2.AddPartAt(firstAttachedPart, "Feet", 0, null, null, null, null, Category: body2.Category, Manager: AdditionsManagerID, RequiresLaterality: null, Mobility: null, Appendage: null, Integral: null, Mortal: null, Abstract: null, Extrinsic: null, Dynamic: null, Plural: null, Mass: null, Contact: null, IgnorePosition: null);
				}
				else
				{
					body2.AddPartAt(firstAttachedPart, "Feet", 64, null, null, null, null, Category: body2.Category, Manager: AdditionsManagerID, RequiresLaterality: null, Mobility: null, Appendage: null, Integral: null, Mortal: null, Abstract: null, Extrinsic: null, Dynamic: null, Plural: null, Mass: null, Contact: null, IgnorePosition: null);
			...
			else
			{
				...
				body2.AddPartAt("Feet", 0, null, null, null, null, additionsManagerID, category3, null, null, null, null, null, null, null, null, null, null, null, null, "Feet", orInsertBefore);
			}
