		...
		public override bool FireEvent(Event E)
		{
			if (E.ID == "AttackerHit")
			{
				...
				if (gameObjectParameter != null)
				{
					...
					{
						gameObjectParameter.TemperatureChange(heatOnHitAmount.RollCached(), E.GetGameObjectParameter("Attacker"), Radiant: false, MinAmbient: false, MaxAmbient: false, IgnoreResistance: false, ParentObject.GetPhase(), null, null);
					}
				}
			}
