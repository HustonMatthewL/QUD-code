...
namespace XRL.World.Parts.Mutation
{
	...
	public class BurrowingClaws : BaseDefaultEquipmentMutation
	{
		...
		public string GetClawsDamage(int Level)
		{
			...
			DelimitedStringEnumerator enumerator = Blueprint.GetTag("VariantDamage").DelimitedBy(',').GetEnumerator();
		...
		public override bool Mutate(GameObject GO, int Level)
		{
			...
			EnableActivatedAbilityID = AddMyActivatedAbility(DisplayName, "CommandToggleBurrowingClaws", "Physical Mutations", null, "ë", null, Toggleable: true, DefaultToggleState: true, ActiveToggle: true, IsAttack: false, IsRealityDistortionBased: false, IsWorldMapUsable: true);
			if (IsMyActivatedAbilityToggledOn(EnableActivatedAbilityID))
			{
