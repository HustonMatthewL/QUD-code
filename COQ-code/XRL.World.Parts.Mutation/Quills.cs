			...
			if (E.Actor != null && E.Actor != ParentObject && !ParentObject.OnWorldMap() && !E.Actor.HasPart<Quills>() && E.Damage.Amount > 0 && !E.Damage.HasAttribute("reflected") && E.Damage.HasAttribute("Unarmed"))
			{
				...
				if (num > 0)
				{
					...
					if (num2 > 0)
					{
						...
						{
							IComponent<GameObject>.AddPlayerMessage(E.Actor.Does("impale", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " " + E.Actor.itself + " on " + ParentObject.poss(QuillsObject, Definite: true, null) + " and" + E.Actor.GetVerb("take") + " " + num2 + " damage!", 'G');
						}
						else if (E.Actor != null)
						{
							if (E.Actor.IsPlayer())
							{
								IComponent<GameObject>.AddPlayerMessage("You impale " + E.Actor.itself + " on " + ParentObject.poss(QuillsObject, Definite: true, null) + " and take " + num2 + " damage!", 'R');
							}
							else if (IComponent<GameObject>.Visible(E.Actor))
							{
								if (E.Actor.IsPlayerLed())
								{
									IComponent<GameObject>.AddPlayerMessage(E.Actor.Does("impale", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " " + E.Actor.itself + " on " + ParentObject.poss(QuillsObject, Definite: true, null) + " and" + E.Actor.GetVerb("take") + " " + num2 + " damage!", 'r');
								}
								else
								{
									IComponent<GameObject>.AddPlayerMessage(E.Actor.Does("impale", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " " + E.Actor.itself + " on " + ParentObject.poss(QuillsObject, Definite: true, null) + " and" + E.Actor.GetVerb("take") + " " + num2 + " damage!", 'g');
