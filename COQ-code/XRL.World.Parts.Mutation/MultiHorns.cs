	...
	public class MultiHorns : BaseMutation
	{
		...
		public void PerformCharge(List<Cell> ChargePath, bool DoEffect = true)
		{
			...
			foreach (GameObject item5 in list)
			{
				...
				if (num9 > 0)
				{
					...
					{
						message = "from being slammed into {{W|" + num7 + "}} walls by %t charge!";
					}
					int amount = num9;
			...
			if (E.ID == "BeginTakeAction")
			{
				if (Charging > 0)
				{
					...
					else
					{
						...
						{
							Charging--;
							ParentObject.UseEnergy(1000, "Physical Mutation Massive Charge", null, null);
							if (Charging > 0)
							{
								return false;
							}
		...
		public override bool ChangeLevel(int NewLevel)
		{
			...
			if (!bSetHeads)
			{
				...
				{
					body2.AddPartAt("Head", 0, null, null, null, null, Category: body2.Category, Manager: ManagerID, RequiresLaterality: null, Mobility: null, Appendage: null, Integral: null, Mortal: null, Abstract: null, Extrinsic: null, Dynamic: null, Plural: null, Mass: null, Contact: null, IgnorePosition: null, InsertAfter: "Head", OrInsertBefore: "Back").AddPart("Face", 0, null, null, null, null, Category: body2.Category, Manager: ManagerID, RequiresLaterality: null, Mobility: null, Appendage: null, Integral: null, Mortal: null, Abstract: null, Extrinsic: null, Dynamic: null, Plural: null, Mass: null, Contact: null, IgnorePosition: null);
				}
			}
			bSetHeads = true;
