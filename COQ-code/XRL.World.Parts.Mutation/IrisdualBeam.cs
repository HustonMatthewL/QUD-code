	...
	public class IrisdualBeam : BaseMutation
	{
		...
		public void Perform()
		{
			...
			try
			{
				...
				if (flag)
				{
					...
					CombatJuice.playPrefabAnimation(ParentObject, "Particles/BeamWarmUp", null, null, async: true);
		...
		public void InflictDamage(GameObject Object, Projectile ProjectilePart)
		{
			...
			if (Amount > 0)
			{
				...
				physics.DidXToY("take", preposition, projectile, null, null, null, null, null, Object, UseFullNames: false, IndefiniteSubject: false, IndefiniteObject: false, IndefiniteObjectForOthers: false, PossessiveObject: false, null, parentObject2);
			}
		}
