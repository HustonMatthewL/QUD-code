		...
		public override void FireLine(List<Cell> Path)
		{
			...
			for (int count = Path.Count; i < count; i++)
			{
				...
				while (num < list.Count)
				{
					...
					if (gameObject.Die(ParentObject, null, "You were turned to stone by the gaze of " + ParentObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", gameObject.It + gameObject.GetVerb("were", PrependSpace: true, PronounAntecedent: true) + " @@turned to stone by the gaze of " + ParentObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".") && gameObject.IsValid())
					{
