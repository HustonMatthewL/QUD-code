...
namespace XRL.World.Parts.Mutation
{
	...
	public class ErosTeleportation : BaseMutation
	{
		...
		{
			if (E.TargetCell != null && E.Distance > 1 && IsMyActivatedAbilityAIUsable(ActivatedAbilityID) && E.Actor.PartyLeader != null && E.Actor.PartyLeader.Target != null && E.Actor.PartyLeader.DistanceTo(E.Target) <= 1 && IComponent<GameObject>.CheckRealityDistortionAdvisability(E.Actor, E.TargetCell, E.Actor, null, this, null))
			{
		...
		{
			if (E.Distance > 3 && GameObject.Validate(E.Target) && IsMyActivatedAbilityAIUsable(ActivatedAbilityID) && E.Actor.PartyLeader != null && E.Actor.PartyLeader.Target != null && E.Actor.PartyLeader.DistanceTo(E.Target) <= 1 && CheckMyRealityDistortionAdvisability(null, null, null, null, null, null))
			{
				E.Add("CommandLeaderTeleport");
			}
			return base.HandleEvent(E);
