...
namespace XRL.World.Parts.Mutation
{
	...
	public class Stinger : BaseDefaultEquipmentMutation
	{
		...
		{
			StringBuilder stringBuilder = Event.NewStringBuilder("20% chance on melee attack to sting your opponent ({{c|\u001a}}{{rules|").Append(GetPenetration(Level) + 4).Append("}} {{r|\u0003}}{{rules|")
