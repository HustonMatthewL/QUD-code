...
namespace XRL.World.Parts.Mutation
{
	...
	public class TimeDilation : BaseMutation
	{
		...
		{
			if (E.Distance <= 10 && IsMyActivatedAbilityAIUsable(ActivatedAbilityID) && GameObject.Validate(E.Target) && !E.Target.IsInStasis() && CheckMyRealityDistortionAdvisability(null, null, null, null, null, null))
			{
				E.Add(COMMAND_NAME);
			}
