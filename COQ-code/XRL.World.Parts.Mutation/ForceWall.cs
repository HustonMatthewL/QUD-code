...
namespace XRL.World.Parts.Mutation
{
	...
	public class ForceWall : BaseMutation
	{
		...
		{
			if (IsMyActivatedAbilityAIUsable(ActivatedAbilityID) && CheckMyRealityDistortionAdvisability(null, null, null, null, null, null))
			{
		...
		public override bool HandleEvent(AIGetRetreatAbilityListEvent E)
		{
			if (IsMyActivatedAbilityAIUsable(ActivatedAbilityID) && CheckMyRealityDistortionAdvisability(null, null, null, null, null, null))
			{
				...
				{
					if (obj.IsCreature && obj != E.Actor && E.Actor.IsHostileTowards(obj) && E.Actor.HasLOSTo(obj, IncludeSolid: true, BlackoutStops: false, UseTargetability: true) && IComponent<GameObject>.CheckRealityDistortionAdvisability(null, obj.CurrentCell, E.Actor, null, this, null))
					{
