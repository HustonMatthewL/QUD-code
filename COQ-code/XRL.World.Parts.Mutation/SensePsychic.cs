...
namespace XRL.World.Parts.Mutation
{
	...
	public class SensePsychic : BaseMutation
	{
		...
		public void SensePsychics()
		{
			...
			List<GameObject> list = ((!RealityDistortionBased) ? cell.ParentZone.FastSquareSearch(cell.X, cell.Y, Radius, IsOtherPsychic, CachedOkay: true) : ((!CheckMyRealityDistortionUsability(null, null, null, null, null, null)) ? null : cell.ParentZone.FastSquareSearch(cell.X, cell.Y, Radius, IsOtherReachablePsychic, CachedOkay: true)));
			if (list == null)
			{
				return;
			}
