	...
	public class Telekinesis : BaseMutation
	{
		...
		public override bool HandleEvent(InventoryActionEvent E)
		{
			if (E.Command == "TelekineticPullAndTake" || E.Command == "TelekineticPullAndTakeOne" || E.Command == "TelekineticPull" || E.Command == "TelekineticPullOne")
			{
				...
				if (flag)
				{
					ParentObject.UseEnergy(1000, "Mental Mutation Telekinesis Pull", null, null);
					...
					if (cell3 != null)
					{
						...
						if (Object2.CurrentCell != null || Object2.TryRemoveFromContext())
						{
							...
							if (!GameObject.Validate(Object2) || num5 > 0)
							{
								if (flag2)
								{
									ParentObject.UseEnergy(1000, "Mental Mutation Telekinesis Hurl", null, null);
								}
								else if (flag3)
								{
									ParentObject.UseEnergy(1000, "Mental Mutation Telekinesis Move", null, null);
								}
								else
								{
									ParentObject.UseEnergy(1000, "Mental Mutation Telekinesis", null, null);
								}
								E.RequestInterfaceExit();
							}
		...
		public override bool FireEvent(Event E)
		{
			...
			{
				ToggleMyActivatedAbility(TelekineticThrowingActivatedAbilityID, null, Silent: false, null);
			}
