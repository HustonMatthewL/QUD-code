...
namespace XRL.World.Parts.Mutation
{
	...
	public class Phasing : BaseMutation
	{
		...
		{
			if (IsMyActivatedAbilityAIUsable(PhaseOutActivatedAbilityID) && !E.Actor.HasEffect<Phased>() && E.Actor.isDamaged(0.25) && CheckMyRealityDistortionAdvisability(null, null, null, null, null, null))
			{
		...
		{
			if (E.Distance > 1 && E.Distance < 5 + base.Level && IsMyActivatedAbilityAIUsable(PhaseOutActivatedAbilityID) && !E.Actor.HasEffect<Phased>() && CheckMyRealityDistortionAdvisability(null, null, null, null, null, null))
			{
				E.Add("CommandPhaseOut");
			}
			return base.HandleEvent(E);
