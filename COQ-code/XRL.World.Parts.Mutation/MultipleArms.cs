	...
	public class MultipleArms : BaseMutation, IRankedMutation
	{
		...
		public void AddMoreArms(GameObject Subject)
		{
			...
			for (int i = 0; i < Pairs; i++)
			{
				...
				{
					(bodyPart3 = body2.AddPartAt(bodyPart3, "Arm", 10, null, null, null, null, Category: body2.Category, Manager: AdditionsManagerID, RequiresLaterality: null, Mobility: null, Appendage: null, Integral: null, Mortal: null, Abstract: null, Extrinsic: null, Dynamic: null, Plural: null, Mass: null, Contact: null, IgnorePosition: null)).AddPart("Hand", 10, null, text, null, null, Category: body2.Category, Manager: AdditionsManagerID, RequiresLaterality: null, Mobility: null, Appendage: null, Integral: null, Mortal: null, Abstract: null, Extrinsic: null, Dynamic: null, Plural: null, Mass: null, Contact: null, IgnorePosition: null);
					(bodyPart3 = body2.AddPartAt(bodyPart3, "Arm", 9, null, null, null, null, Category: body2.Category, Manager: AdditionsManagerID, RequiresLaterality: null, Mobility: null, Appendage: null, Integral: null, Mortal: null, Abstract: null, Extrinsic: null, Dynamic: null, Plural: null, Mass: null, Contact: null, IgnorePosition: null)).AddPart("Hand", 9, null, text, null, null, Category: body2.Category, Manager: AdditionsManagerID, RequiresLaterality: null, Mobility: null, Appendage: null, Integral: null, Mortal: null, Abstract: null, Extrinsic: null, Dynamic: null, Plural: null, Mass: null, Contact: null, IgnorePosition: null);
					bodyPart4 = body2.AddPartAt(bodyPart4, "Hands", 8, null, null, text, null, Category: body2.Category, Manager: AdditionsManagerID, RequiresLaterality: null, Mobility: null, Appendage: null, Integral: null, Mortal: null, Abstract: null, Extrinsic: null, Dynamic: null, Plural: null, Mass: null, Contact: null, IgnorePosition: null);
				...
				if (bodyPart3 != null)
				{
					bodyPart5 = (bodyPart3 = body2.AddPartAt(bodyPart3, "Arm", num, null, null, null, null, Category: body2.Category, Manager: AdditionsManagerID, RequiresLaterality: null, Mobility: null, Appendage: null, Integral: null, Mortal: null, Abstract: null, Extrinsic: null, Dynamic: null, Plural: null, Mass: null, Contact: null, IgnorePosition: null));
				}
				else
				{
					int laterality7 = num;
					...
					bodyPart5 = (bodyPart3 = body2.AddPartAt("Arm", laterality7, null, null, null, null, additionsManagerID, category7, null, null, null, null, null, null, null, null, null, null, null, null, "Arm", orInsertBefore));
				}
				bodyPart5.AddPart("Hand", num, null, text, null, null, Category: body2.Category, Manager: AdditionsManagerID, RequiresLaterality: null, Mobility: null, Appendage: null, Integral: null, Mortal: null, Abstract: null, Extrinsic: null, Dynamic: null, Plural: null, Mass: null, Contact: null, IgnorePosition: null);
				body2.AddPartAt(bodyPart3, "Arm", num, null, null, null, null, Category: body2.Category, Manager: AdditionsManagerID, RequiresLaterality: null, Mobility: null, Appendage: null, Integral: null, Mortal: null, Abstract: null, Extrinsic: null, Dynamic: null, Plural: null, Mass: null, Contact: null, IgnorePosition: null).AddPart("Hand", num, null, text, null, null, Category: body2.Category, Manager: AdditionsManagerID, RequiresLaterality: null, Mobility: null, Appendage: null, Integral: null, Mortal: null, Abstract: null, Extrinsic: null, Dynamic: null, Plural: null, Mass: null, Contact: null, IgnorePosition: null);
				if (bodyPart4 != null)
				{
					bodyPart4 = body2.AddPartAt(bodyPart4, "Hands", num3, null, null, text, null, Category: body2.Category, Manager: AdditionsManagerID, RequiresLaterality: null, Mobility: null, Appendage: null, Integral: null, Mortal: null, Abstract: null, Extrinsic: null, Dynamic: null, Plural: null, Mass: null, Contact: null, IgnorePosition: null);
					continue;
				}
				int laterality12 = num3;
				num4 = body2.Category;
				string additionsManagerID2 = AdditionsManagerID;
				int? category12 = num4;
				orInsertBefore = new string[3] { "Feet", "Roots", "Thrown Weapon" };
				bodyPart4 = body2.AddPartAt("Hands", laterality12, null, null, text, null, additionsManagerID2, category12, null, null, null, null, null, null, null, null, null, null, null, null, "Hands", orInsertBefore);
			}
