...
namespace XRL.World.Parts.Mutation
{
	...
	public class ForceBubble : BaseMutation
	{
		...
		public void DestroyBubble(bool Validated = false)
		{
			...
			{
				IComponent<GameObject>.AddPlayerMessage("The {{B|force bubble}} around " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " snaps off.");
			}
		}
		...
		public int CreateBubble()
		{
			...
			IComponent<GameObject>.EmitMessage(ParentObject, "A {{B|force bubble}} pops into being around " + ParentObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", ' ', FromDialog: false, UsePopup: false, AlwaysVisible: false, ParentObject);
			return num;
		}
		...
		{
			if (IsMyActivatedAbilityAIUsable(ActivatedAbilityID) && !IsMyActivatedAbilityToggledOn(ActivatedAbilityID) && (!IsRealityDistortionBased || CheckMyRealityDistortionAdvisability(null, null, null, null, null, null)) && !ParentObject.CurrentCell.AnyAdjacentCell((Cell c) => ParentObject.IsAlliedTowards(c.GetCombatObject())))
			{
				E.Add(COMMAND_NAME);
			}
