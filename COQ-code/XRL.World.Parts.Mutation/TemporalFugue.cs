...
namespace XRL.World.Parts.Mutation
{
	...
	public class TemporalFugue : BaseMutation
	{
		...
		public static bool PerformTemporalFugue(GameObject Actor, GameObject Subject = null, GameObject Source = null, TemporalFugue Mutation = null, IEvent TriggeringEvent = null, bool Involuntary = false, bool IsRealityDistortionBased = true, int? Duration = null, int? Copies = null, int HostileCopyChance = 0, string Context = "Temporal Fugue", string FriendlyCopyColorString = null, string HostileCopyColorString = null, string FriendlyCopyPrefix = null, string HostileCopyPrefix = null)
		{
			...
			{
				Actor.Fail(Subject.Does("are", int.MaxValue, null, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null) + " too tenuously anchored in this time to be temporally duplicated in it.");
				return false;
			}
			...
			{
				Actor.Fail("It is impossible to duplicate " + Subject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".");
				return false;
			}
			...
			foreach (Cell item in adjacentCells.ShuffleInPlace())
			{
				...
				GameObject @object = Subject;
				GameObject source = Source;
				if (CreateFugueCopyOf(Actor, @object, item, source, IsRealityDistortionBased, num2, HostileCopyChance, Context, FriendlyCopyColorString, HostileCopyColorString, FriendlyCopyPrefix, HostileCopyPrefix, Mutation) == null || ++num < num3)
				{
					continue;
				}
				list = null;
			...
			if (list != null)
			{
				...
				{
					GameObject object2 = Subject;
					GameObject source = Source;
					if (CreateFugueCopyOf(Actor, object2, item2, source, IsRealityDistortionBased, num2, HostileCopyChance, Context, FriendlyCopyColorString, HostileCopyColorString, FriendlyCopyPrefix, HostileCopyPrefix, Mutation) != null && ++num >= num3)
					{
						list2 = null;
						break;
					}
			...
			if (list2 != null)
			{
				...
				{
					GameObject object3 = Subject;
					GameObject source = Source;
					GameObject source2 = source;
					int duration = num2;
					if (CreateFugueCopyOf(Actor, object3, item3, source2, IsRealityDistortionBased, duration, HostileCopyChance, Context, FriendlyCopyColorString, HostileCopyColorString, FriendlyCopyPrefix, HostileCopyPrefix, Mutation) != null && ++num >= num3)
					{
						break;
					}
				}
			...
			if (num < num3)
			{
				...
				{
					GameObject object4 = Subject;
					GameObject source = Source;
					if (CreateFugueCopyOf(Actor, object4, connectedSpawnLocation, source, IsRealityDistortionBased, num2, HostileCopyChance, Context, FriendlyCopyColorString, HostileCopyColorString, FriendlyCopyPrefix, HostileCopyPrefix, Mutation) != null && ++num >= num3)
					{
						break;
					}
				}
		...
		{
			return PerformTemporalFugue(ParentObject, ParentObject, null, this, TriggeringEvent, Involuntary: false, IsRealityDistortionBased: true, null, null);
		}
		...
		public static GameObject CreateFugueCopyOf(GameObject Actor, GameObject Object, Cell TargetCell, GameObject Source = null, bool IsRealityDistortionBased = true, int Duration = 20, int HostileCopyChance = 0, string Context = "Temporal Fugue", string FriendlyCopyColorString = null, string HostileCopyColorString = null, string FriendlyCopyPrefix = null, string HostileCopyPrefix = null, IPart Mutation = null)
		{
			...
			else
			{
				...
				{
					gameObject.Brain.Goals.Clear();
					gameObject.Brain.PartyLeader = Object;
		...
		{
			return PerformTemporalFugue(ParentObject, null, null, this, TriggeringEvent, Involuntary: false, IsRealityDistortionBased: true, null, null);
		}
		...
		{
			ActivatedAbilityID = AddMyActivatedAbility(DisplayName, CommandID, AbilityClass, null, "\u0013", null, Toggleable: false, DefaultToggleState: false, ActiveToggle: false, IsAttack: false, IsRealityDistortionBased, IsWorldMapUsable: false, Silent: false, AIDisable: false, AlwaysAllowToggleOff: true, AffectedByWillpower);
