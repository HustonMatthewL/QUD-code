		...
		public void LayoutBodyPlan()
		{
			...
			foreach (PaperdollLayoutElement item2 in abstractSlots.Where((PaperdollLayoutElement s) => s.data.bodyPart.Type.Contains("Thrown")))
			{
				...
				while (num7 >= 0)
				{
					...
					grid[(num8, num7)] = item2;
					item2.gridLocation = new Rect2D(num8, num7, num8, num7);
			...
			foreach (PaperdollLayoutElement item3 in abstractSlots.Where((PaperdollLayoutElement s) => s.data.bodyPart.Contact && !s.data.bodyPart.Type.Contains("Thrown")))
			{
				...
				while (num9 >= 0)
				{
					...
					grid[(num10, num9)] = item3;
					item3.gridLocation = new Rect2D(num10, num9, num10, num9);
			...
			foreach (PaperdollLayoutElement item4 in abstractSlots.Where((PaperdollLayoutElement s) => !s.data.bodyPart.Contact && !s.data.bodyPart.Type.Contains("Thrown")))
			{
				for (int k = num4; k <= num6; k++)
				{
					...
					grid[(num11, k)] = item4;
					item4.gridLocation = new Rect2D(num11, k, num11, k);
			...
			{
				if (usedGrid2.x1 < num3)
				{
					num3 = usedGrid2.x1;
				}
				if (usedGrid2.y1 < num4)
				{
					num4 = usedGrid2.y1;
				}
			}
			...
			{
				paperdollElement.gridLocation.y1 += -num4;
				paperdollElement.gridLocation.y2 += -num4;
				if (paperdollElement.gridLocation.Width - 1 > num5 - paperdollElement.gridLocation.x1)
				{
					paperdollElement.gridLocation.x2 = paperdollElement.gridLocation.x1 + (num5 - paperdollElement.gridLocation.x1);
				}
