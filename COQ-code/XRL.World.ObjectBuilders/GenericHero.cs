...
namespace XRL.World.ObjectBuilders
{
	public class GenericHero : IPart
	{
		...
		public override bool HandleEvent(EnteredCellEvent E)
		{
			if (!Created)
			{
				...
				try
				{
					...
					ParentObject.GiveProperName(MakeName(), Force: false, null, SpecialFaildown: false, null, null);
		...
		{
			return NameMaker.MakeName(ParentObject, null, null, null, null, null, null, null, null, null, "Hero", null, null, FailureOkay: false, SpecialFaildown: true, null, null);
		}

		public virtual string MakeTitle()
		{
			return NameMaker.MakeTitle(ParentObject, null, null, null, null, null, null, null, null, null, "Hero", null, SpecialFaildown: true, null, null);
		}
