...
namespace XRL.World.ObjectBuilders
{
	public class GoatfolkHero1 : IObjectBuilder
	{
		...
		public override void Apply(GameObject GO, string Context)
		{
			...
			string text = NameMaker.MakeEpithet(GO, null, null, null, null, null, null, null, null, null, "Hero", dictionary, SpecialFaildown: true, null, null);
			string text2 = NameMaker.MakeTitle(GO, null, null, null, null, null, null, null, null, null, "Hero", dictionary, SpecialFaildown: true, null, null);
