...
namespace XRL.World.ObjectBuilders
{
	public class SnapjawHero0 : IObjectBuilder
	{
		...
		{
			string text = NameMaker.MakeTitle(GO, null, null, null, null, null, null, null, null, null, "Hero", null, SpecialFaildown: true, null, null);
			GO.GiveProperName(null, Force: false, "Hero", SpecialFaildown: true, null, null);
