...
namespace XRL.World.Text.Delegates
{
	...
	public static class VariableReplacers
	{
		...
		public static string SubstantivePossessive(DelegateContext Context)
		{
			...
			if (Context.Capitalize)
			{
				obj = Context.Target?.Theirs ?? Context.Pronouns.CapitalizedPossessiveAdjective;
			}
			else
			{
		...
		public static string Does(DelegateContext Context)
		{
			...
			if (Context.Target != null)
			{
				if (!Context.Capitalize)
				{
					return Context.Target.does(text, int.MaxValue, null, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null);
				}
				return Context.Target.Does(text, int.MaxValue, null, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, WithIndefiniteArticle: false, null, IndicateHidden: false, Pronoun: false, SecondPerson: true, null);
			}
			if (Context.Explicit != null)
		...
		public static string WithDefiniteArticle(DelegateContext Context)
		{
			if (Context.Target != null)
			{
				...
				return Context.Target.GetDisplayName(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: true, ColorOnly: false, Visible: true, WithoutTitles: false, ForSort: false, Short: true, BaseOnly: false, WithIndefiniteArticle: false, WithDefiniteArticle: true, null, IndicateHidden: false, Context.Capitalize, SecondPerson: false, Reflexive: false, null);
			}
			if (Context.Explicit != null)
			{
		...
		public static string WithIndefiniteArticle(DelegateContext Context)
		{
			if (Context.Target != null)
			{
				...
				return Context.Target.GetDisplayName(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: true, ColorOnly: false, Visible: true, WithoutTitles: false, ForSort: false, Short: true, BaseOnly: false, WithIndefiniteArticle: true, WithDefiniteArticle: false, null, IndicateHidden: false, Context.Capitalize, SecondPerson: false, Reflexive: false, null);
			}
			if (Context.Explicit == null)
			{
				return Context.Default;
		...
		public static string TargetName(DelegateContext Context)
		{
			...
			if (Context.Target != null)
			{
				...
				return Context.Target.GetDisplayName(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: true, ColorOnly: false, Visible: true, WithoutTitles: true, ForSort: false, Short: true, BaseOnly: false, WithIndefiniteArticle: false, WithDefiniteArticle: false, null, IndicateHidden: false, Context.Capitalize, SecondPerson: false, Reflexive: false, null);
			}
			if (Context.Explicit != null)
			{
				if (!Context.Capitalize)
		...
		public static string TargetNameSingle(DelegateContext Context)
		{
			if (Context.Target != null)
			{
				...
				return Context.Target.GetDisplayName(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, ColorOnly: false, Visible: true, WithoutTitles: true, ForSort: false, Short: true, BaseOnly: false, WithIndefiniteArticle: false, WithDefiniteArticle: false, null, IndicateHidden: false, Context.Capitalize, SecondPerson: false, Reflexive: false, null);
			}
			if (Context.Explicit != null)
			{
				if (!Context.Capitalize)
			...
			foreach (MethodInfo item in ModManager.GetMethodsWithAttribute(typeof(VariableReplacerAttribute), typeof(HasVariableReplacerAttribute), Cache: false))
			{
				try
				{
					...
					if (item.ReturnType == typeof(void))
					{
						...
						@delegate = delegate(DelegateContext x)
						{
							action(x);
							return (string)null;
						};
					...
					{
						@delegate = (Replacer)item.CreateDelegate(typeof(Replacer));
					}
					list2.Add(new ReplacerEntry(@delegate, customAttribute.Capitalization ? Grammar.InitLower(customAttribute.Default) : customAttribute.Default, customAttribute.Flags));
					if (customAttribute.Capitalization)
					{
						list2.Add(new ReplacerEntry(@delegate, customAttribute.Capitalization ? Grammar.InitCap(customAttribute.Default) : customAttribute.Default, customAttribute.Flags, Capitalize: true));
					}
					int i = 0;
					for (int count = list2.Count; i < count; i++)
					{
						ReplacerEntry value = list2[i];
						bool flag = i % 2 != 0;
						int j = 0;
						for (int count2 = list.Count; j < count2; j++)
						{
							...
							if (customAttribute.Capitalization)
							{
								key = (flag ? Grammar.InitCap(list[j]) : Grammar.InitLower(list[j]));
							}
