...
namespace XRL.World.ZoneBuilders
{
	public class Strata : ZoneBuilderSandbox
	{
		...
		public bool BuildZone(Zone Z)
		{
			...
			double num4 = (double)list[1].Item2 / (double)list[0].Item2 * 0.5;
			num4 += sampleSimplexNoiseRange("secondaryThreshold", gridX, gridY, Z.Z, -0.2f, 0.2f);
			if (num4 > 0.5)
			{
				num4 = 1.0 - num4;
			}
			...
			int num6 = sampleZonescaleSimplexNoiseIntRange("mazePathWidth", gridX, gridY, Z.Z, 0, 4);
			ConnectMaze(Z, num6, num6 + 1);
			return true;
		}
	}
}
