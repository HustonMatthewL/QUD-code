		...
		public void FabricateGraveyard(InfluenceMapRegion region)
		{
			...
			for (int i = 0; i < num2; i++)
			{
				GameObject @object = GameObject.Create("Tombstone", 0, 0, null, delegate(GameObject o)
				{
					...
					{
						Part.name = NameMaker.MakeName(getBaseVillager(), null, null, null, null, null, null, null, null, null, null, null, null, FailureOkay: false, SpecialFaildown: false, null, null);
					}
				});
			...
			for (int i = 0; i < num2; i++)
			{
				GameObject @object = GameObject.Create("Tombstone", 0, 0, null, delegate(GameObject o)
				{
					if (o.TryGetPart<Tombstone>(out var Part))
					{
						...
						Part.name = NameMaker.MakeName(baseVillager, null, null, null, null, null, null, null, null, null, null, null, null, FailureOkay: false, SpecialFaildown: false, null, null);
						baseVillager.Pool();
				...
				ZoneBuilderSandbox.PlaceObjectInRect(zone, r2, @object);
			}
					...
					for (int num = zone.Height - 1; i < num; i++)
					{
						...
						for (int num2 = zone.Width - 1; j < num2; j++)
						{
							...
							Predicate<Cell> obj2 = delegate(Cell AC)
							{
								...
								if (sync)
								{
									AC.ForeachObjectWithPart("Door", delegate(GameObject obj)
									{
