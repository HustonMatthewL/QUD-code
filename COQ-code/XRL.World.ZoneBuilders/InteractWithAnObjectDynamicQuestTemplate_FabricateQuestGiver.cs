	...
	public class InteractWithAnObjectDynamicQuestTemplate_FabricateQuestGiver : ZoneBuilderSandbox
	{
		...
		public void addQuestConversationToGiver(GameObject go, Quest quest, GameObject fetchItem)
		{
			...
			case QuestStoryType_InteractWithAnObject.StrangePlan:
				if (If.CoinFlip())
				{
					quest.Name = Grammar.MakeTitleCase(Grammar.MakePossessive(go.GetDisplayName(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, ColorOnly: false, Visible: true, WithoutTitles: true, ForSort: false, Short: false, BaseOnly: true, WithIndefiniteArticle: false, WithDefiniteArticle: false, null, IndicateHidden: false, Capitalize: false, SecondPerson: false, Reflexive: false, null)) + " Strange " + plan);
				}
			...
			DynamicQuestConversationHelper.fabricateIntroAcceptChoice("Yes. I will " + stringProperty + " " + fetchItem.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: true, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " as you ask.", questIntroNode, quest)["RevealMapNote"] = deliveryTarget.secretId;
			...
			DynamicQuestConversationHelper.appendQuestCompletionSequence(conversationXMLBlueprint, quest, questIntroNode, "I've " + text2 + " " + fetchItem.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: true, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".", "I haven't " + text2 + " " + fetchItem.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: true, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + " yet.", delegate
			{
		...
		public Quest fabricateInteractWithAnObjectQuest(GameObject giver, string objectToFetchCacheID)
		{
			...
			quest.Name = (If.CoinFlip() ? Grammar.MakeTitleCase(stringProperty + " " + gameObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null)) : Grammar.MakeTitleCase(gameObject.T(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: false, WithoutTitles: true, Short: true, BaseOnly: false, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null)));
			...
			questStep.ID = "a_use";
			questStep.Name = Grammar.MakeTitleCase(stringProperty + " " + gameObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: true, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null));
			questStep.Text = "Travel to " + deliveryTarget.displayName + " and " + stringProperty + " " + gameObject.t(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: true, Short: true, BaseOnly: true, null, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) + ".";
			questStep.XP = 100;
