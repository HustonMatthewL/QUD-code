...
namespace XRL.Language
{
	public static class Grammar
	{
		...
		public static string GetProsaicZoneName(Zone Z)
		{
			...
			return Z?.GetTerrainObject()?.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, WithoutTitles: false, Short: true, BaseOnly: false, IndicateHidden: false, SecondPerson: true, Reflexive: false, null) ?? "an unnamed place";
		}
