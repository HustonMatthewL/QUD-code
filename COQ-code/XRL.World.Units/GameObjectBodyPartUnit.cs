...
namespace XRL.World.Units
{
	...
	public class GameObjectBodyPartUnit : GameObjectUnit
	{
		...
		public override void Apply(GameObject Object)
		{
			...
			BodyPart bodyPart2 = ((!(Type == "Random")) ? bodyPart.AddPartAt(Type, Manager: Manager, InsertAfter: InsertAfter, OrInsertBefore: OrInsertBefore, Laterality: Laterality, DefaultBehavior: null, SupportsDependent: null, DependsOn: null, RequiresType: null, Category: (Category == -1) ? bodyPart.Category : Category, RequiresLaterality: null, Mobility: null, Appendage: null, Integral: null, Mortal: null, Abstract: null, Extrinsic: null, Dynamic: null, Plural: null, Mass: null, Contact: null, IgnorePosition: null) : Object.RequirePart<Mutations>().AddChimericBodyPart(Silent: true, Manager));
