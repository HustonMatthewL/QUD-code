	...
	public class CheckpointingSystem : IGameSystem
	{
		...
		public static bool ShowDeathMessage(string message, string deathCategory = null)
		{
			...
			while (true)
			{
				...
				case 2:
				{
					string text = Popup.AskString("If you retire this character, your score will be recorded and your character will be lost. Are you sure you want to RETIRE THIS CHARACTER FOREVER? Type 'RETIRE' to confirm.", "", "Sounds/UI/ui_notification", null, null, 7, 0, ReturnNullForEscape: false, EscapeNonMarkupFormatting: true, null);
