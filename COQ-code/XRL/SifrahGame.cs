...
namespace XRL
{
	...
	public abstract class SifrahGame
	{
		...
		public void ProcessTurn(GameObject ContextObject)
		{
			...
			int m = 0;
			for (int count5 = Tokens.Count; m < count5; m++)
			{
				SifrahToken sifrahToken2 = Tokens[m];
		...
		{
			IncrementGameCount(GameType, null, null, null, null, null);
			IncrementGameCount(GameType, Outcome, null, null, null, null);
			int? slots = Slots;
			int? tokens = Tokens;
			IncrementGameCount(GameType, null, slots, tokens, null, null);
			IncrementGameCount(GameType, Outcome, Slots, Tokens, null, null);
			if (AsMaster.HasValue || Mastered.HasValue)
			{
				...
				asMaster = AsMaster;
				IncrementGameCount(GameType, null, null, null, asMaster, null);
				...
				mastered = AsMaster;
				IncrementGameCount(GameType, outcome3, null, null, mastered, null);
				tokens = Slots;
				slots = Tokens;
				asMaster = AsMaster;
				mastered = Mastered;
				...
				slots = Tokens;
				asMaster = AsMaster;
				IncrementGameCount(GameType, null, tokens, slots, asMaster, null);
				...
				IncrementGameCount(GameType, Outcome, Slots, Tokens, AsMaster, null);
			}
		}
