...
namespace XRL
{
	...
	public class SifrahRenderable : Renderable
	{
		...
		{
			Buffer.Write(this, null, null, GetAltColorString(ColorString), GetAltTileColor(ColorString), null);
		}
		...
		{
			return new Renderable(this, null, null, GetAltColorString(ColorString), GetAltTileColor(ColorString), null);
		}
