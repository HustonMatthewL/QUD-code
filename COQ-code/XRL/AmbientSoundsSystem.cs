	...
	public class AmbientSoundsSystem : IGameSystem
	{
		...
		public static void OnOptionUpdate()
		{
			if (Enabled != Globals.EnableAmbient)
			{
				...
				{
					Timer.Reset();
					PlayAmbientBeds((string)null, (string)null, (string)null, (float?)null);
				}
				else
				{
					Timer.Restart();
					PlayAmbientBeds(The.ActiveZone, null, null, null, null);
				}
		...
		public static bool TestAmbient(string beds)
		{
			...
			PlayAmbientBeds((array.Length >= 1) ? ("Sounds/Ambiences/" + array[0]) : null, (array.Length >= 2) ? ("Sounds/Ambiences/" + array[1]) : null, (array.Length >= 3) ? ("Sounds/Ambiences/" + array[2]) : null, null);
			return true;
		}
		...
		{
			PlayAmbientBeds(The.ActiveZone, null, "Sounds/Ambiences/amb_creature_" + bed, null, null);
			return true;
		}
		...
		public override bool HandleEvent(ZoneActivatedEvent E)
		{
			...
			{
				Timer.Restart();
				PlayAmbientBeds(E.Zone, null, null, null, null);
